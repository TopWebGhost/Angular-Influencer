...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramProfile.api_data_history'
        db.add_column('social_discovery_instagramprofile', 'api_data_history', self.gf('django_pgjson.fields.JsonField')(default=[], null=False), keep_default=False)

        # Adding field 'InstagramProfile.reprocess_tries_count'
        db.add_column('social_discovery_instagramprofile', 'reprocess_tries_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstagramProfile.api_data_history'
        db.delete_column('social_discovery_instagramprofile', 'api_data_history')

        # Deleting field 'InstagramProfile.reprocess_tries_count'
        db.delete_column('social_discovery_instagramprofile', 'reprocess_tries_count')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 25, 3, 52, 33, 872059)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 25, 3, 52, 33, 871985)'}),
        ...
        'social_discovery.instagramprofile': {
            ...
            'api_data_history': ('django_pgjson.fields.JsonField', [], {'default': '[]', 'null': 'False'}),
            ...
            'reprocess_tries_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
        ...
        'social_discovery.platformlatestpostprocessed': {
            'Meta': {'object_name': 'PlatformLatestPostProcessed'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_post_id_processed': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'latest_post'", 'unique': 'True', 'to': "orm['debra.Platform']"})
        },
