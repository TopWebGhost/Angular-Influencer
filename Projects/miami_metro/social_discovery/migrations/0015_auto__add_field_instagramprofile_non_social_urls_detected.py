...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramProfile.non_social_urls_detected'
        db.add_column('social_discovery_instagramprofile', 'non_social_urls_detected', self.gf('django.db.models.fields.TextField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstagramProfile.non_social_urls_detected'
        db.delete_column('social_discovery_instagramprofile', 'non_social_urls_detected')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 9, 20, 27, 40, 302703)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 9, 20, 27, 40, 302543)'}),
