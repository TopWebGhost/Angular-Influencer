...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterProfile.valid_influencer'
        db.add_column('social_discovery_twitterprofile', 'valid_influencer', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterProfile.valid_influencer'
        db.delete_column('social_discovery_twitterprofile', 'valid_influencer')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 24, 14, 6, 26, 588718)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 24, 14, 6, 26, 588539)'}),
