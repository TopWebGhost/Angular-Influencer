...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterProfile.update_pending'
        db.add_column('social_discovery_twitterprofile', 'update_pending', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterProfile.update_pending'
        db.delete_column('social_discovery_twitterprofile', 'update_pending')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 2, 9, 24, 33, 697753)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 2, 9, 24, 33, 697637)'}),
