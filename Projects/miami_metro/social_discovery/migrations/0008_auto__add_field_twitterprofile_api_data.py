...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterProfile.api_data'
        db.add_column('social_discovery_twitterprofile', 'api_data', self.gf('django_pgjson.fields.JsonField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'TwitterProfile.api_data'
        db.delete_column('social_discovery_twitterprofile', 'api_data')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 10, 13, 55, 97746)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 10, 13, 55, 97634)'}),
