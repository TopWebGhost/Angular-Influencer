...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterProfile.platform'
        db.add_column('social_discovery_twitterprofile', 'platform', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'twitter_profile', null=True, to=orm['debra.Platform']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterProfile.platform'
        db.delete_column('social_discovery_twitterprofile', 'platform_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 10, 39, 16, 370536)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 10, 39, 16, 370426)'}),
