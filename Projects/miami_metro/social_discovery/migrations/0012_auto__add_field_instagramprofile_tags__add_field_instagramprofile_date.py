...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramProfile.tags'
        db.add_column('social_discovery_instagramprofile', 'tags', self.gf('django.db.models.fields.TextField')(default=None, null=True), keep_default=False)

        # Adding field 'InstagramProfile.date_created'
        db.add_column('social_discovery_instagramprofile', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstagramProfile.tags'
        db.delete_column('social_discovery_instagramprofile', 'tags')

        # Deleting field 'InstagramProfile.date_created'
        db.delete_column('social_discovery_instagramprofile', 'date_created')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 9, 14, 57, 52, 803935)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 9, 14, 57, 52, 803855)'}),
