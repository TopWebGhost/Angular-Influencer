...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_discovery_instagramprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'instagram_profile', null=True, to=orm['debra.Platform'])),
            ('discovered_influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'instagram_profile', null=True, to=orm['debra.Influencer'])),
            ...
            ('last_post_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('api_data', self.gf('django_pgjson.fields.JsonField')()),
            ('valid_influencer', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, db_index=True, blank=True)),
            ('update_pending', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal('social_discovery', ['InstagramProfile'])


    def backwards(self, orm):
        
        # Deleting model 'InstagramProfile'
        db.delete_table('social_discovery_instagramprofile')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 7, 9, 33, 42, 490157)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 7, 9, 33, 42, 489988)'}),
