...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramProfile.platform_ids_detected'
        db.add_column('social_discovery_instagramprofile', 'platform_ids_detected', self.gf('django.db.models.fields.TextField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstagramProfile.platform_ids_detected'
        db.delete_column('social_discovery_instagramprofile', 'platform_ids_detected')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 14, 52, 29, 539101)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 14, 52, 29, 539024)'}),
