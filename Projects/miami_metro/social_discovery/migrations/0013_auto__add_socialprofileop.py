...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SocialProfileOp'
        db.create_table('social_discovery_socialprofileop', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_discovery.InstagramProfile'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('module_classname', self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, blank=True)),
            ...
            ('data', self.gf('django_pgjson.fields.JsonField')()),
        ))
        db.send_create_signal('social_discovery', ['SocialProfileOp'])


    def backwards(self, orm):
        
        # Deleting model 'SocialProfileOp'
        db.delete_table('social_discovery_socialprofileop')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 24, 16, 37, 49, 89299)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 24, 16, 37, 49, 89146)'}),
