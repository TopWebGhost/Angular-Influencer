...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlatformLatestPostProcessed'
        db.create_table('social_discovery_platformlatestpostprocessed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'latest_post', unique=True, to=orm['debra.Platform'])),
            ('latest_post_id_processed', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('social_discovery', ['PlatformLatestPostProcessed'])


    def backwards(self, orm):
        
        # Deleting model 'PlatformLatestPostProcessed'
        db.delete_table('social_discovery_platformlatestpostprocessed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 9, 7, 11, 25, 902159)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 9, 7, 11, 25, 902085)'}),
