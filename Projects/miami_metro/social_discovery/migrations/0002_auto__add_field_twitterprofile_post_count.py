...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterProfile.post_count'
        db.add_column('social_discovery_twitterprofile', 'post_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterProfile.post_count'
        db.delete_column('social_discovery_twitterprofile', 'post_count')
