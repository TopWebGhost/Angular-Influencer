...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScrapingResultSetEntry.entry_count'
        db.add_column('xps_scrapingresultsetentry', 'entry_count', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScrapingResultSetEntry.entry_count'
        db.delete_column('xps_scrapingresultsetentry', 'entry_count')
    ...
    models = {
        ...
        'xps.scrapingresultsetentry': {
            ...
            'entry_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['debra.ProductModel']", 'null': 'True', 'blank': 'True'}),
