...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScrapingResultSetEntry.product_model'
        db.add_column('xps_scrapingresultsetentry', 'product_model', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductModel'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScrapingResultSetEntry.product_model'
        db.delete_column('xps_scrapingresultsetentry', 'product_model_id')
