...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScrapingResult.value_json'
        db.add_column('xps_scrapingresult', 'value_json', self.gf('django.db.models.fields.CharField')(default=None, max_length=4096, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScrapingResult.value_json'
        db.delete_column('xps_scrapingresult', 'value_json')
