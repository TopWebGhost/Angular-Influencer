...
(function() {
  ...
  angular.module('pdf', ['tsGlobal'])

  .directive('ngPdf', [ '$window', '$timeout', 'tsConfig', function($window, $timeout, tsConfig) {
    var renderTask = null;
    ...
    return {
      ...
      //   return '<div ng-include="pdfCanvastTemplateUrl"></div>';
      // },
      // template: '<div ng-include="pdfCanvastTemplateUrl"></div>',
      templateUrl: tsConfig.wrapTemplate('js/angular/templates/partials/pdf_canvas_partial.html'),
      link: function(scope, element, attrs) {
        ...
        // scope.pdfCanvastTemplateUrl = null;
        // attrs.$observe('templateUrl', function(value) {
        //   scope.pdfCanvastTemplateUrl = value;
        // });
