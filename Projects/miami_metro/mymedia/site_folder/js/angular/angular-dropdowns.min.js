...
(function (window, angular, undefined) {
  ...
  dd.run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('ngDropdowns/templates/dropdownSelectItem.html', [
      '<li bindonce="dropdownSelectItem" bo-class="{divider: (dropdownSelectItem.divider && !dropdownSelectItem[dropdownItemLabel]), \'divider-label\': (dropdownSelectItem.divider && dropdownSelectItem[dropdownItemLabel])}">',
        '<a href="" class="dropdown-item"',
        ' bo-if="!dropdownSelectItem.divider"',
        ' bo-href="dropdownSelectItem.href"',
        ' ng-click="selectItem()" bo-text="dropdownSelectItem[dropdownItemLabel]">',
        '</a>',
        '<span bo-if="dropdownSelectItem.divider" bo-text="dropdownSelectItem[dropdownItemLabel]">',
        '</span>',
      '</li>'
    ].join(''));
        ...
        controller: ['$scope', '$element', function ($scope, $element) {
          ...
          this.select = function (selected) {
            if (!angular.equals(selected, $scope.dropdownModel)) {
                ...
                // update
                if ($scope.dropdownModelObject)
                    $scope.dropdownModelObject.selected = selected;
            }
