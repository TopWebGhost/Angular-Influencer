...
;(function($){
	$.fn.etalage = function(options){
		...
		var o = $.extend({
			...
			thumb_image_width: 310,				// The large thumbnail width (excluding borders / padding) (value in pixels)
			thumb_image_height: 350,			// The large thumbnail height (excluding borders / padding) (value in pixels)
