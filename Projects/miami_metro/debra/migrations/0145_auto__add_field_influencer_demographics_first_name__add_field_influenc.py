...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('debra_influencer', 'demographics_fbid', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_location'
        db.add_column('debra_influencer', 'demographics_location', self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_bloggerage'
        db.add_column('debra_influencer', 'demographics_bloggerage', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        ...
        # Adding field 'Influencer.monetization_percentsponsored'
        db.add_column('debra_influencer', 'monetization_percentsponsored', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.monetization_numadunits'
        db.add_column('debra_influencer', 'monetization_numadunits', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.monetization_revenueestimate'
        db.add_column('debra_influencer', 'monetization_revenueestimate', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.followers_overalldemographics_percentbloggers'
        db.add_column('debra_influencer', 'followers_overalldemographics_percentbloggers', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
        ...
        db.add_column('debra_influencer', 'followers_overalldemographics_averageage', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.followers_overalldemographics_percentmale'
        db.add_column('debra_influencer', 'followers_overalldemographics_percentmale', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_referencescore'
        db.add_column('debra_influencer', 'ranking_referencescore', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_bloggingrate'
        db.add_column('debra_influencer', 'ranking_bloggingrate', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_overallengagement_mediascore'
        db.add_column('debra_influencer', 'ranking_overallengagement_mediascore', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_overallengagement_absolutescore'
        db.add_column('debra_influencer', 'ranking_overallengagement_absolutescore', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_overallengagement_recurringscore'
        db.add_column('debra_influencer', 'ranking_overallengagement_recurringscore', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Influencer.ranking_overallseoscore'
        db.add_column('debra_influencer', 'ranking_overallseoscore', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
        ...
        db.add_column('debra_influencer', 'fbpage_about', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.fbpage_description'
        db.add_column('debra_influencer', 'fbpage_description', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Influencer.demographics_location'
        db.delete_column('debra_influencer', 'demographics_location')

        # Deleting field 'Influencer.demographics_bloggerage'
        db.delete_column('debra_influencer', 'demographics_bloggerage')

        # Deleting field 'Influencer.demographics_fbpic'
        db.delete_column('debra_influencer', 'demographics_fbpic')

        # Deleting field 'Influencer.monetization_percentsponsored'
        db.delete_column('debra_influencer', 'monetization_percentsponsored')

        # Deleting field 'Influencer.monetization_numadunits'
        db.delete_column('debra_influencer', 'monetization_numadunits')

        # Deleting field 'Influencer.monetization_revenueestimate'
        db.delete_column('debra_influencer', 'monetization_revenueestimate')
        ...
        # Deleting field 'Influencer.ranking_referencescore'
        db.delete_column('debra_influencer', 'ranking_referencescore')

        # Deleting field 'Influencer.ranking_bloggingrate'
        db.delete_column('debra_influencer', 'ranking_bloggingrate')
        ...
        # Deleting field 'Influencer.ranking_overallengagement_absolutescore'
        db.delete_column('debra_influencer', 'ranking_overallengagement_absolutescore')
        ...
        # Deleting field 'Influencer.ranking_overallseoscore'
        db.delete_column('debra_influencer', 'ranking_overallseoscore')
    ...
    models = {
        ...
        'debra.followertimeseries': {
            'Meta': {'object_name': 'FollowerTimeSeries'},
            'count': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.influencer': {
            ...
            'demographics_fbid': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'demographics_location': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'fb_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'fbpage_about': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'fbpage_description': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'fbpage_numlikes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'fbpage_numtalkingabout': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instagram_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            ...
            'shelf_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'tumblr_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'twitter_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'usingblogger': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'usingblogspot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'usingtumblr': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'usingtypepad': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'usingwordpress': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'debra.items': {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 29, 41, 122387)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 29, 41, 122411)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 29, 41, 121320)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 29, 41, 127265)'}),
