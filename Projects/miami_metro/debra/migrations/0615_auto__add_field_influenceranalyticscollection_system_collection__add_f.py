...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerAnalyticsCollection.system_collection'
        db.add_column('debra_influenceranalyticscollection', 'system_collection', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)

        # Adding field 'PostAnalyticsCollection.system_collection'
        db.add_column('debra_postanalyticscollection', 'system_collection', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfluencerAnalyticsCollection.system_collection'
        db.delete_column('debra_influenceranalyticscollection', 'system_collection')

        # Deleting field 'PostAnalyticsCollection.system_collection'
        db.delete_column('debra_postanalyticscollection', 'system_collection')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 29, 17, 32, 48, 496339)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 29, 17, 32, 48, 496257)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e5a03698-d6eb-442b-ba11-ab74fb9d5183'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '12574', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 29, 17, 32, 47, 161493)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 29, 17, 32, 47, 161521)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 29, 17, 32, 47, 159711)'}),
