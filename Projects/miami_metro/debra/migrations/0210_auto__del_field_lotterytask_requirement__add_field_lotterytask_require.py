...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LotteryTask.requirement'
        db.delete_column('debra_lotterytask', 'requirement')

        # Adding field 'LotteryTask.requirement_text'
        db.add_column('debra_lotterytask', 'requirement_text', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'LotteryTask.requirement_url'
        db.add_column('debra_lotterytask', 'requirement_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'LotteryTask.requirement'
        db.add_column('debra_lotterytask', 'requirement', self.gf('django.db.models.fields.CharField')(default=None, max_length=300), keep_default=False)

        # Deleting field 'LotteryTask.requirement_text'
        db.delete_column('debra_lotterytask', 'requirement_text')

        # Deleting field 'LotteryTask.requirement_url'
        db.delete_column('debra_lotterytask', 'requirement_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 52, 294053)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 52, 293978)'}),
        ...
        'debra.lottery': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.UserProfile']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 759269)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 759240)'}),
        ...
        'debra.lotterytask': {
            ...
            'task': ('django.db.models.fields.CharField', [], {'default': "{'meta': {'css_class': 'social_twitter', 'type': 'url', 'icon': 'icon-social_twitter'}, 'name': 'twitter_follow', 'value': 'Follow on Twitter'}", 'max_length': '200'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 721815)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 721835)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 720669)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 19, 49, 21, 726874)'}),
