...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contract.post_collection'
        db.delete_column('debra_contract', 'post_collection_id')

        # Adding field 'BrandJobPost.tracking_group'
        db.add_column('debra_brandjobpost', 'tracking_group', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'BrandJobPost.post_collection'
        db.add_column('debra_brandjobpost', 'post_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.PostAnalyticsCollection'], null=True), keep_default=False)

        # Adding field 'PostAnalytics.contract'
        db.add_column('debra_postanalytics', 'contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Contract'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Contract.post_collection'
        db.add_column('debra_contract', 'post_collection', self.gf('django.db.models.fields.related.OneToOneField')(related_name='contract', unique=True, null=True, to=orm['debra.PostAnalyticsCollection']), keep_default=False)

        # Deleting field 'BrandJobPost.tracking_group'
        db.delete_column('debra_brandjobpost', 'tracking_group')

        # Deleting field 'BrandJobPost.post_collection'
        db.delete_column('debra_brandjobpost', 'post_collection_id')

        # Deleting field 'PostAnalytics.contract'
        db.delete_column('debra_postanalytics', 'contract_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 46, 33, 628319)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 46, 33, 628184)'}),
        ...
        'debra.contract': {
            ...
            'blogger_address': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'deliverables': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'envelope': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'extra_details': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'14f0fd9e-fa14-435f-aee0-1e6dbba90c21'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '2170', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 46, 32, 325163)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 46, 32, 325201)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 46, 32, 322918)'}),
