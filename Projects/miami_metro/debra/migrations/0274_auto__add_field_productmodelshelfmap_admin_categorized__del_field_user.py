...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductModelShelfMap.admin_categorized'
        db.add_column('debra_productmodelshelfmap', 'admin_categorized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.categorized'
        db.delete_column('debra_userprofile', 'categorized')

        # Adding field 'UserProfile.admin_categorized'
        db.add_column('debra_userprofile', 'admin_categorized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductModelShelfMap.admin_categorized'
        db.delete_column('debra_productmodelshelfmap', 'admin_categorized')

        # Adding field 'UserProfile.categorized'
        db.add_column('debra_userprofile', 'categorized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.admin_categorized'
        db.delete_column('debra_userprofile', 'admin_categorized')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 17, 30, 16, 729230)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 17, 30, 16, 729161)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 17, 30, 16, 357442)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 17, 30, 16, 357462)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 17, 30, 16, 356304)'}),
        ...
        'debra.userprofile': {
            ...
            'given_auto_categorization_option': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
