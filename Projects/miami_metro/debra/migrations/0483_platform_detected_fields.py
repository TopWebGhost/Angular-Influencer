...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Platform.detected_name'
        db.add_column('debra_platform', 'detected_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.detected_description'
        db.add_column('debra_platform', 'detected_description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.detected_demographics_location'
        db.add_column('debra_platform', 'detected_demographics_location', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.detected_demographics_gender'
        db.add_column('debra_platform', 'detected_demographics_gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Platform.detected_name'
        db.delete_column('debra_platform', 'detected_name')

        # Deleting field 'Platform.detected_description'
        db.delete_column('debra_platform', 'detected_description')

        # Deleting field 'Platform.detected_demographics_location'
        db.delete_column('debra_platform', 'detected_demographics_location')

        # Deleting field 'Platform.detected_demographics_gender'
        db.delete_column('debra_platform', 'detected_demographics_gender')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 29, 10, 1, 32, 84143)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 29, 10, 1, 32, 84041)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3345a4c3-8cf1-4159-9895-d884dbb581e5'", 'max_length': '64'})
        },
        ...
        'debra.platform': {
            ...
            'detected_description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '12801', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 29, 10, 1, 30, 875902)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 29, 10, 1, 30, 875931)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 29, 10, 1, 30, 874024)'}),
