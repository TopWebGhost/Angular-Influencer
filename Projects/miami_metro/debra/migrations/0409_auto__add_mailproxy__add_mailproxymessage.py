...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MailProxy'
        db.create_table('debra_mailproxy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mails', null=True, to=orm['debra.Influencer'])),
            ('influencer_mail', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mails', null=True, to=orm['debra.Brands'])),
            ('brand_mail', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('debra', ['MailProxy'])

        # Adding model 'MailProxyMessage'
        db.create_table('debra_mailproxymessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='threads', to=orm['debra.MailProxy'])),
            ...
            ('mandrill_id', self.gf('django.db.models.fields.CharField')(max_length=45)),
        ))
        db.send_create_signal('debra', ['MailProxyMessage'])


    def backwards(self, orm):
        
        # Deleting model 'MailProxy'
        db.delete_table('debra_mailproxy')

        # Deleting model 'MailProxyMessage'
        db.delete_table('debra_mailproxymessage')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 12, 13, 21, 905476)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 12, 13, 21, 905407)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'eb40cd60-34d6-4bbb-b6a9-2d1f42ba9346'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '3486', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 12, 13, 21, 329295)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 12, 13, 21, 329315)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 12, 13, 21, 327667)'}),
