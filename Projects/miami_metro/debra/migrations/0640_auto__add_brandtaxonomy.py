...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BrandTaxonomy'
        db.create_table('debra_brandtaxonomy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brand_name', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('repr_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('style_tag', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('product_tag', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('price_tag', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('keywords', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('hashtags', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('mentions', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('mention_urls', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
        ))
        db.send_create_signal('debra', ['BrandTaxonomy'])


    def backwards(self, orm):
        
        # Deleting model 'BrandTaxonomy'
        db.delete_table('debra_brandtaxonomy')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 10, 6, 31, 14, 47809)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 10, 6, 31, 14, 47729)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c93b8c94-46e1-4e7c-89d6-23187c4219e5'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '25878', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 6, 31, 13, 53817)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 6, 31, 13, 53836)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 6, 31, 13, 52593)'}),
