...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Shelf', fields ['brand']
        db.delete_unique('debra_shelf', ['brand_id'])

        # Adding field 'Brands.cover_img'
        db.add_column('debra_brands', 'cover_img', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Changing field 'Shelf.brand'
        db.alter_column('debra_shelf', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Brands'], null=True))

        # Changing field 'UserProfile.brand'
        db.alter_column('debra_userprofile', 'brand_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.Brands'], unique=True, null=True))

        # Adding unique constraint on 'UserProfile', fields ['brand']
        db.create_unique('debra_userprofile', ['brand_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserProfile', fields ['brand']
        db.delete_unique('debra_userprofile', ['brand_id'])

        # Deleting field 'Brands.cover_img'
        db.delete_column('debra_brands', 'cover_img')

        # Changing field 'Shelf.brand'
        db.alter_column('debra_shelf', 'brand_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.Brands'], unique=True, null=True))

        # Adding unique constraint on 'Shelf', fields ['brand']
        db.create_unique('debra_shelf', ['brand_id'])

        # Changing field 'UserProfile.brand'
        db.alter_column('debra_userprofile', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Brands'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 30, 48796)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 30, 48705)'}),
        ...
        'debra.brands': {
            ...
            'cover_img': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 29, 432407)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 29, 432449)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 29, 430309)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 14, 15, 11, 29, 441266)'}),
        ...
        'debra.userprofile': {
            ...
            'gravatar_img_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
