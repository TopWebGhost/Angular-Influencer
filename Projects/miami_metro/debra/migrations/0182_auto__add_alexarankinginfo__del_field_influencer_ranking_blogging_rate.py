...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AlexaRankingInfo'
        db.create_table('debra_alexarankinginfo', (
            ...
            ('seo_loadtime', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('links_in_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('sites_linking_in', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('rank', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('rank_by_country', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('rank_by_city', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('reach', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('page_views', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('snapshot_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['AlexaRankingInfo'])

        # Deleting field 'Influencer.ranking_blogging_rate_score'
        db.delete_column('debra_influencer', 'ranking_blogging_rate_score')
        ...
        # Changing field 'Platform.monetization_revenueestimate'
        db.alter_column('debra_platform', 'monetization_revenueestimate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Platform.brandfit_matrix'
        db.alter_column('debra_platform', 'brandfit_matrix', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Platform.posting_rate'
        db.alter_column('debra_platform', 'posting_rate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Platform.reference_score'
        db.alter_column('debra_platform', 'reference_score', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Platform.monetization_percentsponsored'
        db.alter_column('debra_platform', 'monetization_percentsponsored', self.gf('django.db.models.fields.FloatField')(null=True))
        ...
        # Adding field 'Follower.num_interactions'
        db.add_column('debra_follower', 'num_interactions', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Changing field 'Follower.email'
        db.alter_column('debra_follower', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))


    def backwards(self, orm):
        
        # Deleting model 'AlexaRankingInfo'
        db.delete_table('debra_alexarankinginfo')

        # Adding field 'Influencer.ranking_blogging_rate_score'
        db.add_column('debra_influencer', 'ranking_blogging_rate_score', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'Influencer.ranking_posting_rate_score'
        db.delete_column('debra_influencer', 'ranking_posting_rate_score')

        # Changing field 'Platform.monetization_revenueestimate'
        db.alter_column('debra_platform', 'monetization_revenueestimate', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.brandfit_matrix'
        db.alter_column('debra_platform', 'brandfit_matrix', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.posting_rate'
        db.alter_column('debra_platform', 'posting_rate', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.reference_score'
        db.alter_column('debra_platform', 'reference_score', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.monetization_percentsponsored'
        db.alter_column('debra_platform', 'monetization_percentsponsored', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Adding field 'Posts.seo_loadtime'
        db.add_column('debra_posts', 'seo_loadtime', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'Posts.maxmediasize'
        db.delete_column('debra_posts', 'maxmediasize')

        # Deleting field 'Follower.num_interactions'
        db.delete_column('debra_follower', 'num_interactions')

        # Changing field 'Follower.email'
        db.alter_column('debra_follower', 'email', self.gf('django.db.models.fields.EmailField')(default=None, max_length=75))
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 31, 20, 45, 19, 26190)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 31, 20, 45, 19, 26214)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 31, 20, 45, 19, 24120)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 31, 20, 45, 19, 31636)'}),
        ...
        'debra.userprofile': {
            ...
            'cover_img_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
