...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BetaBrandRequests.signup_user'
        db.alter_column('debra_betabrandrequests', 'signup_user', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BetaBrandRequests.signup_user_email'
        db.alter_column('debra_betabrandrequests', 'signup_user_email', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'BetaBrandRequests.signup_user'
        db.alter_column('debra_betabrandrequests', 'signup_user', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))

        # Changing field 'BetaBrandRequests.signup_user_email'
        db.alter_column('debra_betabrandrequests', 'signup_user_email', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
    ...
    models = {
        ...
        'debra.betabrandrequests': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signup_user': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'signup_user_email': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 47, 54, 275521)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 47, 54, 275554)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 47, 54, 273475)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 47, 54, 281271)'}),
