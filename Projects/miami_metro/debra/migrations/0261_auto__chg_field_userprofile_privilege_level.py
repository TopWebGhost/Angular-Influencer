...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'UserProfile.privilege_level'
        db.execute("ALTER TABLE debra_userprofile ALTER COLUMN privilege_level TYPE integer USING privilege_level::integer;")  # noqa

    def backwards(self, orm):
        # Changing field 'UserProfile.privilege_level'
        db.alter_column('debra_userprofile', 'privilege_level', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 20, 23, 16, 779622)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 20, 23, 16, 779553)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 20, 23, 16, 445119)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 20, 23, 16, 445138)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 20, 23, 16, 443849)'}),
