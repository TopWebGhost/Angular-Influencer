...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogPostComment.issue_date'
        db.add_column('debra_blogpostcomment', 'issue_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'BlogPost.bloglovin_blogger'
        db.add_column('debra_blogpost', 'bloglovin_blogger', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.BloggerBloglovinProfiles'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlogPostComment.issue_date'
        db.delete_column('debra_blogpostcomment', 'issue_date')

        # Deleting field 'BlogPost.bloglovin_blogger'
        db.delete_column('debra_blogpost', 'bloglovin_blogger_id')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 28, 16, 56, 41, 172423)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 28, 16, 56, 41, 172449)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 28, 16, 56, 41, 171372)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 28, 16, 56, 41, 177457)'}),
