...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Color'
        db.create_table('debra_color', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True)),
            ('product_img', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True)),
            ('swatch_img', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True)),
        ))
        db.send_create_signal('debra', ['Color'])

        # Adding field 'ColorSizeModel.color_data'
        db.add_column('debra_colorsizemodel', 'color_data', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Color'], null=True), keep_default=False)

        # Adding field 'ColorSizeModel.size_standard'
        db.add_column('debra_colorsizemodel', 'size_standard', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True), keep_default=False)

        # Adding field 'ColorSizeModel.size_sizetype'
        db.add_column('debra_colorsizemodel', 'size_sizetype', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True), keep_default=False)

        # Adding field 'ColorSizeModel.size_inseam'
        db.add_column('debra_colorsizemodel', 'size_inseam', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, null=True), keep_default=False)

        # Adding field 'UserProfile.unclaimed'
        db.add_column('debra_userprofile', 'unclaimed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Color'
        db.delete_table('debra_color')

        # Deleting field 'ColorSizeModel.color_data'
        db.delete_column('debra_colorsizemodel', 'color_data_id')

        # Deleting field 'ColorSizeModel.size_standard'
        db.delete_column('debra_colorsizemodel', 'size_standard')

        # Deleting field 'ColorSizeModel.size_sizetype'
        db.delete_column('debra_colorsizemodel', 'size_sizetype')

        # Deleting field 'ColorSizeModel.size_inseam'
        db.delete_column('debra_colorsizemodel', 'size_inseam')

        # Deleting field 'UserProfile.unclaimed'
        db.delete_column('debra_userprofile', 'unclaimed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 1, 20, 52, 28, 220150)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 1, 20, 52, 28, 220083)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 20, 52, 27, 794013)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 20, 52, 27, 794037)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 20, 52, 27, 792507)'}),
