...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductModelShelfMap'
        db.create_table('debra_productmodelshelfmap', (
            ...
            ('product_model', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductModel'])),
            ...
            ('calculated_price', self.gf('django.db.models.fields.FloatField')(default='-11.0', max_length=10)),
            ('item_out_of_stock', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('savings', self.gf('django.db.models.fields.FloatField')(default='0', max_length=10)),
            ('promo_applied', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Promoinfo'], null=True, blank=True)),
            ('shipping_cost', self.gf('django.db.models.fields.FloatField')(default='-1', max_length=10)),
            ('added_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True)),
            ('imported_from_blog', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('time_price_calculated_last', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('time_notified_last', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('notify_lower_bound', self.gf('django.db.models.fields.FloatField')(default='-1', max_length=10)),
            ('snooze', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('bought', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_on_feed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('avail_sizes', self.gf('django.db.models.fields.CharField')(default='', max_length=2000, null=True, blank=True)),
            ('img_url_shelf_view', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('img_url_panel_view', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('img_url_feed_view', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('img_url_thumbnail_view', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('img_url_original', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('affiliate_prod_link', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True, blank=True)),
            ('affiliate_source_wishlist_id', self.gf('django.db.models.fields.IntegerField')(default='-1', max_length=100)),
            ('current_product_price', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductPrice'], null=True)),
        ))
        db.send_create_signal('debra', ['ProductModelShelfMap'])


    def backwards(self, orm):
        
        # Deleting model 'ProductModelShelfMap'
        db.delete_table('debra_productmodelshelfmap')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 20, 24, 13, 571602)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 20, 24, 13, 571531)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 20, 24, 13, 175619)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 20, 24, 13, 175660)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 20, 24, 13, 173309)'}),
