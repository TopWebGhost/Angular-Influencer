...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShelfBloggerWidgetImages.wishlist_shelf_map'
        db.add_column('debra_shelfbloggerwidgetimages', 'wishlist_shelf_map', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.WishlistItemShelfMap'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShelfBloggerWidgetImages.wishlist_shelf_map'
        db.delete_column('debra_shelfbloggerwidgetimages', 'wishlist_shelf_map_id')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 29, 12, 838339)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 29, 12, 838365)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 29, 12, 837329)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 29, 12, 843779)'}),
