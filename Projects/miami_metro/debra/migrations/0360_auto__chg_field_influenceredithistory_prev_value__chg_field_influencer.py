...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfluencerEditHistory.prev_value'
        db.alter_column('debra_influenceredithistory', 'prev_value', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InfluencerEditHistory.curr_value'
        db.alter_column('debra_influenceredithistory', 'curr_value', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'InfluencerEditHistory.prev_value'
        db.alter_column('debra_influenceredithistory', 'prev_value', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=128))

        # Changing field 'InfluencerEditHistory.curr_value'
        db.alter_column('debra_influenceredithistory', 'curr_value', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=128))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 15, 17, 15, 453419)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 15, 17, 15, 453339)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '31730', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 15, 16, 56, 393919)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 15, 16, 56, 393938)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 15, 16, 56, 392992)'}),
