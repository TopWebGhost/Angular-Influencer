...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.details_collected_status'
        db.add_column('debra_contract', 'details_collected_status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Deleting field 'ROIPredictionReport.campaign'
        db.delete_column('debra_roipredictionreport', 'campaign_id')


    def backwards(self, orm):
        
        # Deleting field 'Contract.details_collected_status'
        db.delete_column('debra_contract', 'details_collected_status')

        # Adding field 'ROIPredictionReport.campaign'
        db.add_column('debra_roipredictionreport', 'campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roi_reports', null=True, to=orm['debra.BrandJobPost']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 4, 23, 20, 50, 202040)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 4, 23, 20, 50, 201960)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0cd0ddcc-34b5-46d9-b255-b24c3ff00d7e'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '1619', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 4, 23, 20, 47, 491308)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 4, 23, 20, 47, 491343)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 4, 23, 20, 47, 490113)'}),
