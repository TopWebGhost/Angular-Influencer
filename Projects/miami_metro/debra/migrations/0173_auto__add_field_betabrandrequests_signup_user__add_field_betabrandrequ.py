...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BetaBrandRequests.signup_user'
        db.add_column('debra_betabrandrequests', 'signup_user', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'BetaBrandRequests.signup_user_email'
        db.add_column('debra_betabrandrequests', 'signup_user_email', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BetaBrandRequests.signup_user'
        db.delete_column('debra_betabrandrequests', 'signup_user')

        # Deleting field 'BetaBrandRequests.signup_user_email'
        db.delete_column('debra_betabrandrequests', 'signup_user_email')
    ...
    models = {
        ...
        'debra.betabrandrequests': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signup_user': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'signup_user_email': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 46, 39, 233462)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 46, 39, 233484)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 46, 39, 232268)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 23, 14, 46, 39, 239569)'}),
