...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WishlistItemShelfMap'
        db.create_table('debra_wishlistitemshelfmap', (
        ...
        db.send_create_signal('debra', ['WishlistItemShelfMap'])

        # Adding model 'Shelf'
        db.create_table('debra_shelf', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='We should have a name', max_length=100)),
            ('brand', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('system_cat', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_created_cat', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('debra', ['Shelf'])


    def backwards(self, orm):
        
        # Deleting model 'WishlistItemShelfMap'
        db.delete_table('debra_wishlistitemshelfmap')

        # Deleting model 'Shelf'
        db.delete_table('debra_shelf')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 28, 18, 32, 33, 769848)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 28, 18, 32, 33, 769890)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 28, 18, 32, 33, 767968)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 28, 18, 32, 33, 779148)'}),
