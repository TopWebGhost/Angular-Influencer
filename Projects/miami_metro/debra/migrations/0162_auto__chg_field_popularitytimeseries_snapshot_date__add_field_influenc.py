...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PopularityTimeSeries.snapshot_date'
        db.alter_column('debra_popularitytimeseries', 'snapshot_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Adding field 'Influencer.demographics_gender'
        db.add_column('debra_influencer', 'demographics_gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Influencer.fb_url'
        db.add_column('debra_influencer', 'fb_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.pin_url'
        db.add_column('debra_influencer', 'pin_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.tw_url'
        db.add_column('debra_influencer', 'tw_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.insta_url'
        db.add_column('debra_influencer', 'insta_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Changing field 'Influencer.monetization_revenueestimate'
        db.alter_column('debra_influencer', 'monetization_revenueestimate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.ranking_referencescore'
        db.alter_column('debra_influencer', 'ranking_referencescore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.ranking_overallengagement_absolutescore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_absolutescore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.ranking_overallseoscore'
        db.alter_column('debra_influencer', 'ranking_overallseoscore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.followers_overalldemographics_percentmale'
        db.alter_column('debra_influencer', 'followers_overalldemographics_percentmale', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.monetization_numadunits'
        db.alter_column('debra_influencer', 'monetization_numadunits', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Influencer.ranking_bloggingrate'
        db.alter_column('debra_influencer', 'ranking_bloggingrate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.bloglovin_followers'
        db.alter_column('debra_influencer', 'bloglovin_followers', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Influencer.ranking_overallengagement_recurringscore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_recurringscore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.ranking_overallengagement_mediascore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_mediascore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.followers_overalldemographics_percentbloggers'
        db.alter_column('debra_influencer', 'followers_overalldemographics_percentbloggers', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.followers_overalldemographics_averageage'
        db.alter_column('debra_influencer', 'followers_overalldemographics_averageage', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Influencer.monetization_percentsponsored'
        db.alter_column('debra_influencer', 'monetization_percentsponsored', self.gf('django.db.models.fields.FloatField')(null=True))

        # Adding field 'PostInteractions.if_commented'
        db.add_column('debra_postinteractions', 'if_commented', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Changing field 'PostInteractions.if_liked'
        db.alter_column('debra_postinteractions', 'if_liked', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'PostInteractions.if_shared'
        db.alter_column('debra_postinteractions', 'if_shared', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Deleting field 'Platform.location'
        db.delete_column('debra_platform', 'location')
        ...
        # Adding field 'Platform.num_followers'
        db.add_column('debra_platform', 'num_followers', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.num_following'
        db.add_column('debra_platform', 'num_following', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
        ...
        # Changing field 'Posts.prize_money'
        db.alter_column('debra_posts', 'prize_money', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.content_numpics'
        db.alter_column('debra_posts', 'content_numpics', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numcomments'
        db.alter_column('debra_posts', 'engagement_media_numcomments', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numretweets'
        db.alter_column('debra_posts', 'engagement_media_numretweets', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numfbshares'
        db.alter_column('debra_posts', 'engagement_media_numfbshares', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numshares'
        db.alter_column('debra_posts', 'engagement_media_numshares', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.num_prizes'
        db.alter_column('debra_posts', 'num_prizes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numrepins'
        db.alter_column('debra_posts', 'engagement_media_numrepins', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.content_numvideos'
        db.alter_column('debra_posts', 'content_numvideos', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.engagement_media_numlikes'
        db.alter_column('debra_posts', 'engagement_media_numlikes', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Posts.is_sponsored'
        db.alter_column('debra_posts', 'is_sponsored', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Posts.seo_loadtime'
        db.alter_column('debra_posts', 'seo_loadtime', self.gf('django.db.models.fields.FloatField')(null=True))

        # Deleting field 'Follower.birthday'
        db.delete_column('debra_follower', 'birthday')

        # Adding field 'Follower.demographics_fbid'
        db.add_column('debra_follower', 'demographics_fbid', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Follower.demographics_age'
        db.add_column('debra_follower', 'demographics_age', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Follower.follower_recurringscore'
        db.add_column('debra_follower', 'follower_recurringscore', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Changing field 'Follower.is_blogger'
        db.alter_column('debra_follower', 'is_blogger', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PopularityTimeSeries.snapshot_date'
        db.alter_column('debra_popularitytimeseries', 'snapshot_date', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Deleting field 'Influencer.demographics_gender'
        db.delete_column('debra_influencer', 'demographics_gender')
        ...
        # Deleting field 'Influencer.fb_url'
        db.delete_column('debra_influencer', 'fb_url')

        # Deleting field 'Influencer.pin_url'
        db.delete_column('debra_influencer', 'pin_url')

        # Deleting field 'Influencer.tw_url'
        db.delete_column('debra_influencer', 'tw_url')

        # Deleting field 'Influencer.insta_url'
        db.delete_column('debra_influencer', 'insta_url')

        # Changing field 'Influencer.monetization_revenueestimate'
        db.alter_column('debra_influencer', 'monetization_revenueestimate', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.ranking_referencescore'
        db.alter_column('debra_influencer', 'ranking_referencescore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.ranking_overallengagement_absolutescore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_absolutescore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.ranking_overallseoscore'
        db.alter_column('debra_influencer', 'ranking_overallseoscore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.followers_overalldemographics_percentmale'
        db.alter_column('debra_influencer', 'followers_overalldemographics_percentmale', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.monetization_numadunits'
        db.alter_column('debra_influencer', 'monetization_numadunits', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Influencer.ranking_bloggingrate'
        db.alter_column('debra_influencer', 'ranking_bloggingrate', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.bloglovin_followers'
        db.alter_column('debra_influencer', 'bloglovin_followers', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Influencer.ranking_overallengagement_recurringscore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_recurringscore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.ranking_overallengagement_mediascore'
        db.alter_column('debra_influencer', 'ranking_overallengagement_mediascore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.followers_overalldemographics_percentbloggers'
        db.alter_column('debra_influencer', 'followers_overalldemographics_percentbloggers', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.followers_overalldemographics_averageage'
        db.alter_column('debra_influencer', 'followers_overalldemographics_averageage', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Influencer.monetization_percentsponsored'
        db.alter_column('debra_influencer', 'monetization_percentsponsored', self.gf('django.db.models.fields.FloatField')())

        # Deleting field 'PostInteractions.if_commented'
        db.delete_column('debra_postinteractions', 'if_commented')

        # Changing field 'PostInteractions.if_liked'
        db.alter_column('debra_postinteractions', 'if_liked', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'PostInteractions.if_shared'
        db.alter_column('debra_postinteractions', 'if_shared', self.gf('django.db.models.fields.BooleanField')())

        # Adding field 'Platform.location'
        db.add_column('debra_platform', 'location', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'Platform.social_handle'
        db.delete_column('debra_platform', 'social_handle')

        # Deleting field 'Platform.num_followers'
        db.delete_column('debra_platform', 'num_followers')

        # Deleting field 'Platform.num_following'
        db.delete_column('debra_platform', 'num_following')
        ...
        # Changing field 'Posts.prize_money'
        db.alter_column('debra_posts', 'prize_money', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.content_numpics'
        db.alter_column('debra_posts', 'content_numpics', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numcomments'
        db.alter_column('debra_posts', 'engagement_media_numcomments', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numretweets'
        db.alter_column('debra_posts', 'engagement_media_numretweets', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numfbshares'
        db.alter_column('debra_posts', 'engagement_media_numfbshares', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numshares'
        db.alter_column('debra_posts', 'engagement_media_numshares', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.num_prizes'
        db.alter_column('debra_posts', 'num_prizes', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numrepins'
        db.alter_column('debra_posts', 'engagement_media_numrepins', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.content_numvideos'
        db.alter_column('debra_posts', 'content_numvideos', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.engagement_media_numlikes'
        db.alter_column('debra_posts', 'engagement_media_numlikes', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Posts.is_sponsored'
        db.alter_column('debra_posts', 'is_sponsored', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Posts.seo_loadtime'
        db.alter_column('debra_posts', 'seo_loadtime', self.gf('django.db.models.fields.FloatField')())

        # Adding field 'Follower.birthday'
        db.add_column('debra_follower', 'birthday', self.gf('django.db.models.fields.DateTimeField')(default=None), keep_default=False)

        # Deleting field 'Follower.demographics_fbid'
        db.delete_column('debra_follower', 'demographics_fbid')

        # Deleting field 'Follower.demographics_age'
        db.delete_column('debra_follower', 'demographics_age')

        # Deleting field 'Follower.follower_recurringscore'
        db.delete_column('debra_follower', 'follower_recurringscore')

        # Changing field 'Follower.is_blogger'
        db.alter_column('debra_follower', 'is_blogger', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'debra.influencer': {
            ...
            'demographics_bloggerage': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            ...
            'monetization_numadunits': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'ranking_bloggingrate': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'ranking_referencescore': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'shelf_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'debra.platform': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'name of entry on this platform'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            ...
            'platform_name': ('django.db.models.fields.CharField', [], {'default': "'Platform name'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.postinteractions': {
            ...
            'comment_made': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.posts': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'Blog Post Title'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 14, 22, 52, 37, 910331)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 14, 22, 52, 37, 910362)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 14, 22, 52, 37, 908708)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 14, 22, 52, 37, 917100)'}),
