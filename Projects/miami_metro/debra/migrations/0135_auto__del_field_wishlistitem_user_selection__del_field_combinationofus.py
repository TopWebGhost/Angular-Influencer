...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CombinationOfUserOps.user_selection'
        db.delete_column('debra_combinationofuserops', 'user_selection_id')


    def backwards(self, orm):
        
        # Adding field 'WishlistItem.user_selection'
        db.add_column('debra_wishlistitem', 'user_selection', self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['debra.UserOperations'], null=True, blank=True), keep_default=False)

        # Adding field 'CombinationOfUserOps.user_selection'
        db.add_column('debra_combinationofuserops', 'user_selection', self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['debra.UserOperations'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 16, 9, 29, 602054)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 16, 9, 29, 602077)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 16, 9, 29, 600989)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 16, 9, 29, 607023)'}),
