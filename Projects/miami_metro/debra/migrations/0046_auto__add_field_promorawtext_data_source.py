...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PromoRawText.data_source'
        db.add_column('debra_promorawtext', 'data_source', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PromoRawText.data_source'
        db.delete_column('debra_promorawtext', 'data_source')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 4, 13, 24, 14, 442560)'}),
