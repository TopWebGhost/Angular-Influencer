...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContentTag.influencer'
        db.add_column('debra_contenttag', 'influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True), keep_default=False)

        # Adding unique constraint on 'ContentTag', fields ['tag', 'influencer']
        db.create_unique('debra_contenttag', ['tag', 'influencer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContentTag', fields ['tag', 'influencer']
        db.delete_unique('debra_contenttag', ['tag', 'influencer_id'])

        # Deleting field 'ContentTag.influencer'
        db.delete_column('debra_contenttag', 'influencer_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 7, 15, 25, 510140)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 7, 15, 25, 510104)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'84f8d539-72ef-4150-8a23-b516d53d6e4a'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '11376', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 7, 15, 25, 75138)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 7, 15, 25, 75151)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 7, 15, 25, 74373)'}),
