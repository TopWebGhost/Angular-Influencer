...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Influencer', fields ['relevant_to_fashion']
        db.create_index('debra_influencer', ['relevant_to_fashion'])

        # Adding index on 'Influencer', fields ['blog_url']
        db.create_index('debra_influencer', ['blog_url'])

        # Adding index on 'Influencer', fields ['name']
        db.create_index('debra_influencer', ['name'])

        # Adding index on 'Platform', fields ['profile_img_url']
        db.create_index('debra_platform', ['profile_img_url'])

        # Adding index on 'Platform', fields ['cover_img_url']
        db.create_index('debra_platform', ['cover_img_url'])


    def backwards(self, orm):
        
        # Removing index on 'Platform', fields ['cover_img_url']
        db.delete_index('debra_platform', ['cover_img_url'])

        # Removing index on 'Platform', fields ['profile_img_url']
        db.delete_index('debra_platform', ['profile_img_url'])

        # Removing index on 'Influencer', fields ['name']
        db.delete_index('debra_influencer', ['name'])

        # Removing index on 'Influencer', fields ['blog_url']
        db.delete_index('debra_influencer', ['blog_url'])

        # Removing index on 'Influencer', fields ['relevant_to_fashion']
        db.delete_index('debra_influencer', ['relevant_to_fashion'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 22, 20, 31, 7, 573963)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 22, 20, 31, 7, 573846)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '52432', 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'192.168.19.5'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 22, 20, 31, 5, 808099)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 22, 20, 31, 5, 808127)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 22, 20, 31, 5, 806499)'}),
