...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LotteryPartner'
        db.create_table('debra_lotterypartner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.UserProfile'])),
            ('lottery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Lottery'])),
        ))
        db.send_create_signal('debra', ['LotteryPartner'])

        # Adding field 'ProductsInPosts.prod'
        #db.add_column('debra_productsinposts', 'prod', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductModel'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LotteryPartner'
        db.delete_table('debra_lotterypartner')

        # Deleting field 'ProductsInPosts.prod'
        db.delete_column('debra_productsinposts', 'prod_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 11, 606495)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 11, 606426)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 10, 987141)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 10, 987166)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 10, 985893)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 18, 27, 10, 992585)'}),
