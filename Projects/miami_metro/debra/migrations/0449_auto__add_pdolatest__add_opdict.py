...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PdoLatest'
        db.create_table('debra_pdolatest', (
            ...
            ('product_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ProductModel'], null=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'], null=True)),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Follower'], null=True)),
            ('post_interaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.PostInteractions'], null=True)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Brands'], null=True)),
            ('operation_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('latest_started', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('debra', ['PdoLatest'])

        # Adding model 'OpDict'
        db.create_table('debra_opdict', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operation', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024)),
        ))
        db.send_create_signal('debra', ['OpDict'])


    def backwards(self, orm):
        
        # Deleting model 'PdoLatest'
        db.delete_table('debra_pdolatest')

        # Deleting model 'OpDict'
        db.delete_table('debra_opdict')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 9, 15, 40, 58619)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 9, 15, 40, 58580)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'12e0c2c9-425c-4fd6-bfac-b145679f7ca9'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostInteractions']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '6182', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 31, 9, 15, 39, 635986)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 31, 9, 15, 39, 636000)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 31, 9, 15, 39, 635278)'}),
