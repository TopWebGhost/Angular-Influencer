...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.logo_blueimg_url'
        db.add_column('debra_brands', 'logo_blueimg_url', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.logo_blueimg_url'
        db.delete_column('debra_brands', 'logo_blueimg_url')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 9, 12, 29, 25, 983467)'}),
