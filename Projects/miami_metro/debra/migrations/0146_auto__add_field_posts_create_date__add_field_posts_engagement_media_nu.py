...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Posts.create_date'
        db.add_column('debra_posts', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Posts.engagement_media_numretweets'
        db.add_column('debra_posts', 'engagement_media_numretweets', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.engagement_media_numfbshares'
        db.add_column('debra_posts', 'engagement_media_numfbshares', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.engagement_media_numlikes'
        db.add_column('debra_posts', 'engagement_media_numlikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.engagement_media_numrepins'
        db.add_column('debra_posts', 'engagement_media_numrepins', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.seo_loadtime'
        db.add_column('debra_posts', 'seo_loadtime', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Posts.create_date'
        db.delete_column('debra_posts', 'create_date')

        # Deleting field 'Posts.engagement_media_numretweets'
        db.delete_column('debra_posts', 'engagement_media_numretweets')

        # Deleting field 'Posts.engagement_media_numfbshares'
        db.delete_column('debra_posts', 'engagement_media_numfbshares')

        # Deleting field 'Posts.engagement_media_numlikes'
        db.delete_column('debra_posts', 'engagement_media_numlikes')

        # Deleting field 'Posts.engagement_media_numrepins'
        db.delete_column('debra_posts', 'engagement_media_numrepins')

        # Deleting field 'Posts.seo_loadtime'
        db.delete_column('debra_posts', 'seo_loadtime')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 31, 34, 21069)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 31, 34, 21093)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 31, 34, 20015)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 31, 34, 26088)'}),
