...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductModelShelfMap.img_url_feed_compressed'
        db.add_column('debra_productmodelshelfmap', 'img_url_feed_compressed', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'WishlistItem.img_url_compressed'
        db.delete_column('debra_wishlistitem', 'img_url_compressed')


    def backwards(self, orm):
        
        # Deleting field 'ProductModelShelfMap.img_url_feed_compressed'
        db.delete_column('debra_productmodelshelfmap', 'img_url_feed_compressed')

        # Adding field 'WishlistItem.img_url_compressed'
        db.add_column('debra_wishlistitem', 'img_url_compressed', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 14, 49, 49, 969343)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 14, 49, 49, 969276)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 14, 49, 49, 582291)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 14, 49, 49, 582329)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 14, 49, 49, 580149)'}),
        ...
        'debra.userprofile': {
            ...
            'categorized': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
