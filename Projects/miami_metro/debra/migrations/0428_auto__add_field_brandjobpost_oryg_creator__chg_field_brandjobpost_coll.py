...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BrandJobPost', fields ['collection']
        db.delete_unique('debra_brandjobpost', ['collection_id'])

        # Adding field 'BrandJobPost.oryg_creator'
        db.add_column('debra_brandjobpost', 'oryg_creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='job_posts_created', null=True, to=orm['debra.Brands']), keep_default=False)

        # Changing field 'BrandJobPost.collection'
        db.alter_column('debra_brandjobpost', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['debra.InfluencersGroup']))


    def backwards(self, orm):
        
        # Deleting field 'BrandJobPost.oryg_creator'
        db.delete_column('debra_brandjobpost', 'oryg_creator_id')

        # Changing field 'BrandJobPost.collection'
        db.alter_column('debra_brandjobpost', 'collection_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['debra.InfluencersGroup']))

        # Adding unique constraint on 'BrandJobPost', fields ['collection']
        db.create_unique('debra_brandjobpost', ['collection_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 12, 18, 25, 776708)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 12, 18, 25, 776638)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5b0a394b-ef04-424b-9c3b-cfae81da2c36'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '19277', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 12, 18, 24, 807176)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 12, 18, 24, 807194)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 12, 18, 24, 806259)'}),
