...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LotteryTask'
        db.create_table('debra_lotterytask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lottery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Lottery'])),
            ('task', self.gf('django.db.models.fields.CharField')(default='twitter_follow', max_length=200)),
            ('point_value', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('requirement', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('mandatory', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('debra', ['LotteryTask'])

        # Adding model 'Lottery'
        db.create_table('debra_lottery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.UserProfile'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 12, 1, 18, 52, 14, 778807))),
            ('end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 12, 1, 18, 52, 14, 778836))),
            ('theme', self.gf('django.db.models.fields.CharField')(default='pink', max_length=20)),
        ))
        db.send_create_signal('debra', ['Lottery'])

        # Adding model 'LotteryPrize'
        db.create_table('debra_lotteryprize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lottery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Lottery'])),
        ...
        db.send_create_signal('debra', ['LotteryPrize'])


    def backwards(self, orm):
        
        # Deleting model 'LotteryTask'
        db.delete_table('debra_lotterytask')

        # Deleting model 'Lottery'
        db.delete_table('debra_lottery')

        # Deleting model 'LotteryPrize'
        db.delete_table('debra_lotteryprize')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 15, 291701)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 15, 291633)'}),
        ...
        'debra.lottery': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 778836)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 778807)'}),
            'theme': ('django.db.models.fields.CharField', [], {'default': "'pink'", 'max_length': '20'})
        },
        'debra.lotteryprize': {
        ...
        'debra.lotterytask': {
            ...
            'requirement': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 739047)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 739096)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 737475)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 1, 18, 52, 14, 745051)'}),
