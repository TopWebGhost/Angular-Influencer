...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'BrandTaxonomy.hashtags'
        db.alter_column('debra_brandtaxonomy', 'hashtags', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'BrandTaxonomy.keywords'
        db.alter_column('debra_brandtaxonomy', 'keywords', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'BrandTaxonomy.mentions'
        db.alter_column('debra_brandtaxonomy', 'mentions', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'BrandTaxonomy.mention_urls'
        db.alter_column('debra_brandtaxonomy', 'mention_urls', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Changing field 'BrandTaxonomy.hashtags'
        db.execute("ALTER TABLE debra_brandtaxonomy ALTER COLUMN hashtags TYPE text[] USING hashtags::text[];")  # noqa

        # Changing field 'BrandTaxonomy.keywords'
        db.execute("ALTER TABLE debra_brandtaxonomy ALTER COLUMN keywords TYPE text[] USING hashtags::text[];")  # noqa

        # Changing field 'BrandTaxonomy.mentions'
        db.execute("ALTER TABLE debra_brandtaxonomy ALTER COLUMN mentions TYPE text[] USING hashtags::text[];")  # noqa

        # Changing field 'BrandTaxonomy.mention_urls'
        db.execute("ALTER TABLE debra_brandtaxonomy ALTER COLUMN mention_urls TYPE text[] USING hashtags::text[];")  # noqa
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 18, 53, 15, 826650)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 18, 53, 15, 826570)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'87af48b9-6d96-455e-9d9a-1c8c3ffe277c'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '10884', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 14, 18, 53, 14, 817782)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 14, 18, 53, 14, 817816)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 14, 18, 53, 14, 815901)'}),
