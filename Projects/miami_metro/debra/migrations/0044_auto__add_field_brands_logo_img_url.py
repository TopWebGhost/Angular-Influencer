...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.logo_img_url'
        db.add_column('debra_brands', 'logo_img_url', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.logo_img_url'
        db.delete_column('debra_brands', 'logo_img_url')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 29, 13, 17, 7, 312626)'}),
