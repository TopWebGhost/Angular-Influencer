...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.product_urls'
        db.add_column('debra_contract', 'product_urls', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True), keep_default=False)

        # Adding field 'BrandJobPost.product_urls'
        db.add_column('debra_brandjobpost', 'product_urls', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Contract.product_urls'
        db.delete_column('debra_contract', 'product_urls')

        # Deleting field 'BrandJobPost.product_urls'
        db.delete_column('debra_brandjobpost', 'product_urls')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 11, 19, 58, 28, 18878)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 11, 19, 58, 28, 18789)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8503e05f-64d4-4839-92e2-e3b56d7af47f'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '22451', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'192.168.0.101'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 11, 19, 58, 26, 780167)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 11, 19, 58, 26, 780203)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 11, 19, 58, 26, 778740)'}),
