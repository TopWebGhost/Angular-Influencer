...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StyleTag'
        db.create_table('debra_styletag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('debra', ['StyleTag'])

        # Adding model 'StyleTagUserMap'
        db.create_table('debra_styletagusermap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('style', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.StyleTag'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.UserProfile'])),
        ))
        db.send_create_signal('debra', ['StyleTagUserMap'])

        # Adding field 'UserProfile.style_bio'
        db.add_column('debra_userprofile', 'style_bio', self.gf('django.db.models.fields.TextField')(default=None, max_length=2000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'StyleTag'
        db.delete_table('debra_styletag')

        # Deleting model 'StyleTagUserMap'
        db.delete_table('debra_styletagusermap')

        # Deleting field 'UserProfile.style_bio'
        db.delete_column('debra_userprofile', 'style_bio')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 13, 22, 14, 35, 172054)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 13, 22, 14, 35, 172076)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 13, 22, 14, 35, 171034)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 13, 22, 14, 35, 177072)'}),
        ...
        'debra.styletagusermap': {
            'Meta': {'object_name': 'StyleTagUserMap'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'style': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.StyleTag']"}),
