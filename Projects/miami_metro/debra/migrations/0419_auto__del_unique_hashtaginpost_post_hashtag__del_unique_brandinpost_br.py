...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'MentionInPost', fields ['mention', 'post']
        db.delete_unique('debra_mentioninpost', ['mention', 'post_id'])

        # Removing unique constraint on 'BrandInPost', fields ['brand', 'post']
        db.delete_unique('debra_brandinpost', ['brand_id', 'post_id'])

        # Removing unique constraint on 'HashtagInPost', fields ['post', 'hashtag']
        db.delete_unique('debra_hashtaginpost', ['post_id', 'hashtag'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'HashtagInPost', fields ['post', 'hashtag']
        db.create_unique('debra_hashtaginpost', ['post_id', 'hashtag'])

        # Adding unique constraint on 'BrandInPost', fields ['brand', 'post']
        db.create_unique('debra_brandinpost', ['brand_id', 'post_id'])

        # Adding unique constraint on 'MentionInPost', fields ['mention', 'post']
        db.create_unique('debra_mentioninpost', ['mention', 'post_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 14, 49, 17, 124874)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 14, 49, 17, 124787)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7c4bd620-6ec1-4077-8703-4f95e2419597'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '37154', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'192.168.1.102'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 14, 49, 16, 206617)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 14, 49, 16, 206641)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 14, 49, 16, 205244)'}),
