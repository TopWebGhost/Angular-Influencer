...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.account_management_notification'
        db.add_column('debra_userprofile', 'account_management_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.opportunity_notification'
        db.add_column('debra_userprofile', 'opportunity_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.price_alerts_notification'
        db.add_column('debra_userprofile', 'price_alerts_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.deal_roundup_notification'
        db.add_column('debra_userprofile', 'deal_roundup_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.social_interaction_notification'
        db.add_column('debra_userprofile', 'social_interaction_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.account_management_notification'
        db.delete_column('debra_userprofile', 'account_management_notification')

        # Deleting field 'UserProfile.opportunity_notification'
        db.delete_column('debra_userprofile', 'opportunity_notification')

        # Deleting field 'UserProfile.price_alerts_notification'
        db.delete_column('debra_userprofile', 'price_alerts_notification')

        # Deleting field 'UserProfile.deal_roundup_notification'
        db.delete_column('debra_userprofile', 'deal_roundup_notification')

        # Deleting field 'UserProfile.social_interaction_notification'
        db.delete_column('debra_userprofile', 'social_interaction_notification')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 1, 30, 44, 765812)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 1, 30, 44, 765836)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 1, 30, 44, 764522)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 1, 30, 44, 770706)'}),
