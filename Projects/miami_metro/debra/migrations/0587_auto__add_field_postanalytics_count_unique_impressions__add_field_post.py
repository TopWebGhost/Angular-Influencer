...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostAnalytics.count_unique_impressions'
        db.add_column('debra_postanalytics', 'count_unique_impressions', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'PostAnalytics.count_unique_clickthroughs'
        db.add_column('debra_postanalytics', 'count_unique_clickthroughs', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostAnalytics.count_unique_impressions'
        db.delete_column('debra_postanalytics', 'count_unique_impressions')

        # Deleting field 'PostAnalytics.count_unique_clickthroughs'
        db.delete_column('debra_postanalytics', 'count_unique_clickthroughs')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 22, 1, 39, 9, 667679)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 22, 1, 39, 9, 667584)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d398f27e-1157-4e3c-aec7-e39b1bfaf4a7'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '4698', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 1, 39, 8, 344225)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 1, 39, 8, 344263)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 22, 1, 39, 8, 341676)'}),
