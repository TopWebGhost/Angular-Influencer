...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('debra_userprofile', 'facebook_open_graph', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'UserProfile.website_url'
        db.alter_column('debra_userprofile', 'website_url', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.access_token'
        db.alter_column('debra_userprofile', 'access_token', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.facebook_name'
        db.alter_column('debra_userprofile', 'facebook_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserProfile.about_me'
        db.alter_column('debra_userprofile', 'about_me', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.raw_data'
        db.alter_column('debra_userprofile', 'raw_data', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.facebook_profile_url'
        db.alter_column('debra_userprofile', 'facebook_profile_url', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'UserProfile.blog_url'
        db.alter_column('debra_userprofile', 'blog_url', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.facebook_open_graph'
        db.delete_column('debra_userprofile', 'facebook_open_graph')

        # Changing field 'UserProfile.website_url'
        db.alter_column('debra_userprofile', 'website_url', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.access_token'
        db.alter_column('debra_userprofile', 'access_token', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.facebook_name'
        db.alter_column('debra_userprofile', 'facebook_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'UserProfile.about_me'
        db.alter_column('debra_userprofile', 'about_me', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.raw_data'
        db.alter_column('debra_userprofile', 'raw_data', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.facebook_profile_url'
        db.alter_column('debra_userprofile', 'facebook_profile_url', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.blog_url'
        db.alter_column('debra_userprofile', 'blog_url', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 18, 49, 26, 312587)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 18, 49, 26, 312629)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 18, 49, 26, 310929)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 18, 49, 26, 322590)'}),
