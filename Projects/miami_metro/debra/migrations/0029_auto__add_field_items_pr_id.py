...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Items.pr_id'
        db.add_column('debra_items', 'pr_id', self.gf('django.db.models.fields.IntegerField')(default=-1, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Items.pr_id'
        db.delete_column('debra_items', 'pr_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 11, 20, 23, 687147)'}),
