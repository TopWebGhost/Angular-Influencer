...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BrandJobPost.influencer_collection'
        db.delete_column('debra_brandjobpost', 'influencer_collection_id')

        # Adding field 'BrandJobPost.report'
        db.add_column('debra_brandjobpost', 'report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ROIPredictionReport'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BrandJobPost.influencer_collection'
        db.add_column('debra_brandjobpost', 'influencer_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencerAnalyticsCollection'], null=True), keep_default=False)

        # Deleting field 'BrandJobPost.report'
        db.delete_column('debra_brandjobpost', 'report_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 11, 49, 5, 704450)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 11, 49, 5, 704309)'}),
        ...
        'debra.contract': {
            ...
            'negotiated_price': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d4a5f765-5481-4a11-82d8-750d6adcfac4'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '12141', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 26, 11, 49, 4, 754784)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 26, 11, 49, 4, 754817)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 26, 11, 49, 4, 752834)'}),
