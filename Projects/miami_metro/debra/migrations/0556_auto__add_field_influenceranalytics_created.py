...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerAnalytics.created'
        db.add_column('debra_influenceranalytics', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfluencerAnalytics.created'
        db.delete_column('debra_influenceranalytics', 'created')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 30, 11, 21, 4, 888378)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 30, 11, 21, 4, 888258)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f462df09-9dee-458e-826c-feb5122b79be'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '5498', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 30, 11, 21, 4, 74068)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 30, 11, 21, 4, 74090)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 30, 11, 21, 4, 72834)'}),
