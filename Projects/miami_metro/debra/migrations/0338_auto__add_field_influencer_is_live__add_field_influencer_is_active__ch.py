...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.is_live'
        db.add_column('debra_influencer', 'is_live', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, db_index=True, blank=True), keep_default=False)

        # Adding field 'Influencer.is_active'
        db.add_column('debra_influencer', 'is_active', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, db_index=True, blank=True), keep_default=False)

        # Changing field 'Influencer.show_on_search'
        db.alter_column('debra_influencer', 'show_on_search', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Adding index on 'Influencer', fields ['show_on_search']
        db.create_index('debra_influencer', ['show_on_search'])


    def backwards(self, orm):
        
        # Removing index on 'Influencer', fields ['show_on_search']
        db.delete_index('debra_influencer', ['show_on_search'])

        # Deleting field 'Influencer.is_live'
        db.delete_column('debra_influencer', 'is_live')

        # Deleting field 'Influencer.is_active'
        db.delete_column('debra_influencer', 'is_active')

        # Changing field 'Influencer.show_on_search'
        db.alter_column('debra_influencer', 'show_on_search', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 12, 7, 18, 258142)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 12, 7, 18, 258047)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '61374', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 12, 7, 17, 563388)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 12, 7, 17, 563410)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 12, 7, 17, 562239)'}),
