...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerGroupMapping'
        db.create_table('debra_influencergroupmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='group_mapping', to=orm['debra.Influencer'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='influencers_mapping', to=orm['debra.InfluencersGroup'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('debra', ['InfluencerGroupMapping'])

        # Adding model 'InfluencersGroup'
        db.create_table('debra_influencersgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('owner_brand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='influencer_groups', to=orm['debra.Brands'])),
            ('influencers_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('debra', ['InfluencersGroup'])


    def backwards(self, orm):
        
        # Deleting model 'InfluencerGroupMapping'
        db.delete_table('debra_influencergroupmapping')

        # Deleting model 'InfluencersGroup'
        db.delete_table('debra_influencersgroup')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 4, 11, 56, 50, 815661)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 4, 11, 56, 50, 815532)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13847', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 4, 11, 56, 50, 84224)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 4, 11, 56, 50, 84253)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 4, 11, 56, 50, 82777)'}),
