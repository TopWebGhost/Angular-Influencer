...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.promo_discovery_support'
        db.add_column('debra_brands', 'promo_discovery_support', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.promo_discovery_support'
        db.delete_column('debra_brands', 'promo_discovery_support')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 24, 15, 57, 28, 311165)'}),
