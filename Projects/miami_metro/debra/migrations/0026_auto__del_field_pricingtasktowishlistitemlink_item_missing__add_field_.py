...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PricingTaskToWishlistItemLink.item_missing'
        db.delete_column('debra_pricingtasktowishlistitemlink', 'item_missing')

        # Adding field 'PricingTaskToWishlistItemLink.item_out_of_stock'
        db.add_column('debra_pricingtasktowishlistitemlink', 'item_out_of_stock', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PricingTaskToWishlistItemLink.how_many_out_of_stock'
        db.add_column('debra_pricingtasktowishlistitemlink', 'how_many_out_of_stock', self.gf('django.db.models.fields.IntegerField')(default='0'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PricingTaskToWishlistItemLink.item_missing'
        db.add_column('debra_pricingtasktowishlistitemlink', 'item_missing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'PricingTaskToWishlistItemLink.item_out_of_stock'
        db.delete_column('debra_pricingtasktowishlistitemlink', 'item_out_of_stock')

        # Deleting field 'PricingTaskToWishlistItemLink.how_many_out_of_stock'
        db.delete_column('debra_pricingtasktowishlistitemlink', 'how_many_out_of_stock')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 13, 16, 4, 20, 49380)'}),
