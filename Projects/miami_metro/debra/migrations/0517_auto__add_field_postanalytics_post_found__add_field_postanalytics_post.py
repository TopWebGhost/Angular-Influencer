...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostAnalytics.post_found'
        db.add_column('debra_postanalytics', 'post_found', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PostAnalytics.post_url'
        db.add_column('debra_postanalytics', 'post_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostAnalytics.post_found'
        db.delete_column('debra_postanalytics', 'post_found')

        # Deleting field 'PostAnalytics.post_url'
        db.delete_column('debra_postanalytics', 'post_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 14, 40, 37, 158058)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 14, 40, 37, 157709)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a62664eb-e774-4e6d-9f0b-814558426109'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '7937', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.postanalytics': {
            ...
            'post': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['debra.Posts']", 'unique': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 8, 14, 40, 35, 488846)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 8, 14, 40, 35, 488867)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 8, 14, 40, 35, 487819)'}),
