...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostContent.content_numpics'
        db.add_column('debra_postcontent', 'content_numpics', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PostContent.content_numvideos'
        db.add_column('debra_postcontent', 'content_numvideos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostContent.content_numpics'
        db.delete_column('debra_postcontent', 'content_numpics')

        # Deleting field 'PostContent.content_numvideos'
        db.delete_column('debra_postcontent', 'content_numvideos')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 33, 22, 832693)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 33, 22, 832718)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 33, 22, 831850)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 33, 22, 837550)'}),
