...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimilarWebVisitsReport'
        db.create_table('debra_similarwebvisitsreport', (
            ...
            ('calls_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('api_calls_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['SimilarWebVisitsReport'])

        # Adding unique constraint on 'SimilarWebVisitsReport', fields ['influencer', 'granularity', 'start', 'end']
        db.create_unique('debra_similarwebvisitsreport', ['influencer_id', 'granularity', 'start', 'end'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SimilarWebVisitsReport', fields ['influencer', 'granularity', 'start', 'end']
        db.delete_unique('debra_similarwebvisitsreport', ['influencer_id', 'granularity', 'start', 'end'])

        # Deleting model 'SimilarWebVisitsReport'
        db.delete_table('debra_similarwebvisitsreport')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 5, 8, 4, 3, 68479)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 5, 8, 4, 3, 68405)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bf05a022-bb3d-4944-beaa-85cf51b404ff'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '7555', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 5, 8, 4, 0, 856209)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 5, 8, 4, 0, 856232)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 5, 8, 4, 0, 854987)'}),
