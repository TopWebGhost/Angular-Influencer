...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Platform.avg_numcomments_overall'
        db.alter_column('debra_platform', 'avg_numcomments_overall', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Platform.avg_numlikes_overall'
        db.alter_column('debra_platform', 'avg_numlikes_overall', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Platform.avg_numshares_overall'
        db.alter_column('debra_platform', 'avg_numshares_overall', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Platform.avg_numcomments_overall'
        db.alter_column('debra_platform', 'avg_numcomments_overall', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.avg_numlikes_overall'
        db.alter_column('debra_platform', 'avg_numlikes_overall', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Platform.avg_numshares_overall'
        db.alter_column('debra_platform', 'avg_numshares_overall', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 3, 16, 40, 28, 336438)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 3, 16, 40, 28, 336340)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'20ed351e-96d9-412a-be7b-510d46a540de'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostInteractions']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '21929', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'104.130.3.236'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 3, 16, 40, 27, 398859)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 3, 16, 40, 27, 398883)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 3, 16, 40, 27, 397163)'}),
