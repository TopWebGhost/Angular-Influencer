...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreCeleryTasks.num_items'
        db.add_column('debra_storecelerytasks', 'num_items', self.gf('django.db.models.fields.IntegerField')(default='1'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreCeleryTasks.num_items'
        db.delete_column('debra_storecelerytasks', 'num_items')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 7, 21, 58, 43, 870087)'}),
