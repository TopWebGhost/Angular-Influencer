...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductModel.c_idx'
        db.add_column('debra_productmodel', 'c_idx', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductModel.c_idx'
        db.delete_column('debra_productmodel', 'c_idx')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 30, 14, 7, 58, 771696)'}),
