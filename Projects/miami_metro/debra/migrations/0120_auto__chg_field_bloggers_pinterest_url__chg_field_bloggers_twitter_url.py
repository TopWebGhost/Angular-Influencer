...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bloggers.pinterest_url'
        db.alter_column('debra_bloggers', 'pinterest_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Bloggers.twitter_url'
        db.alter_column('debra_bloggers', 'twitter_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Bloggers.facebook_url'
        db.alter_column('debra_bloggers', 'facebook_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Bloggers.bloglovin_url'
        db.alter_column('debra_bloggers', 'bloglovin_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Bloggers.pinterest_url'
        db.alter_column('debra_bloggers', 'pinterest_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))

        # Changing field 'Bloggers.twitter_url'
        db.alter_column('debra_bloggers', 'twitter_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))

        # Changing field 'Bloggers.facebook_url'
        db.alter_column('debra_bloggers', 'facebook_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))

        # Changing field 'Bloggers.bloglovin_url'
        db.alter_column('debra_bloggers', 'bloglovin_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))
    ...
    models = {
        ...
        'debra.bloggers': {
            ...
            'blog_name': ('django.db.models.fields.CharField', [], {'default': "'Your blog name'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 13, 37, 835392)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 13, 37, 835413)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 13, 37, 834458)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 26, 1, 13, 37, 840144)'}),
