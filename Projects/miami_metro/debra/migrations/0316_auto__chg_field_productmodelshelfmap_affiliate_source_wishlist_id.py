...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductModelShelfMap.affiliate_source_wishlist_id'
        db.alter_column('debra_productmodelshelfmap', 'affiliate_source_wishlist_id', self.gf('django.db.models.fields.IntegerField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'ProductModelShelfMap.affiliate_source_wishlist_id'
        db.alter_column('debra_productmodelshelfmap', 'affiliate_source_wishlist_id', self.gf('django.db.models.fields.IntegerField')(max_length=100))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 2, 4, 210177)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 2, 4, 210106)'}),
        ...
        'debra.productmodelshelfmap': {
            ...
            'affiliate_source_wishlist_id': ('django.db.models.fields.IntegerField', [], {'default': "'-1'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 2, 3, 508598)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 2, 3, 508619)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 2, 3, 507421)'}),
