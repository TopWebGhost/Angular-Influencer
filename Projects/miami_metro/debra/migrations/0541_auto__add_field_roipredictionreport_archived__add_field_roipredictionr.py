...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ROIPredictionReport.archived'
        db.add_column('debra_roipredictionreport', 'archived', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)

        # Adding field 'ROIPredictionReport.created_date'
        db.add_column('debra_roipredictionreport', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True), keep_default=False)

        # Adding field 'ROIPredictionReport.creator_brand'
        db.add_column('debra_roipredictionreport', 'creator_brand', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_roi_prediction_reports', null=True, to=orm['debra.Brands']), keep_default=False)

        # Adding field 'ROIPredictionReport.user'
        db.add_column('debra_roipredictionreport', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='roi_prediction_reports', null=True, blank=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ROIPredictionReport.archived'
        db.delete_column('debra_roipredictionreport', 'archived')

        # Deleting field 'ROIPredictionReport.created_date'
        db.delete_column('debra_roipredictionreport', 'created_date')

        # Deleting field 'ROIPredictionReport.creator_brand'
        db.delete_column('debra_roipredictionreport', 'creator_brand_id')

        # Deleting field 'ROIPredictionReport.user'
        db.delete_column('debra_roipredictionreport', 'user_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 10, 31, 35, 915252)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 10, 31, 35, 915156)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4fccc174-8ed3-445f-bc62-1b561808d153'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '14521', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 10, 10, 31, 18, 803091)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 10, 10, 31, 18, 803109)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 10, 10, 31, 18, 801784)'}),
