...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EngagementTimeSeries'
        db.create_table('debra_engagementtimeseries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Platform'], null=True)),
            ('avg_likes', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('avg_comments', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('avg_shares', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('likes_data', self.gf('django.db.models.fields.TextField')(null=True)),
            ('comments_data', self.gf('django.db.models.fields.TextField')(null=True)),
            ('shares_data', self.gf('django.db.models.fields.TextField')(null=True)),
            ('date_range_start', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('date_range_end', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('debra', ['EngagementTimeSeries'])


    def backwards(self, orm):
        
        # Deleting model 'EngagementTimeSeries'
        db.delete_table('debra_engagementtimeseries')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 1, 11, 57, 17, 369)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 1, 11, 57, 17, 272)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6ae0a689-c84b-414c-a488-00ba02623a70'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '32597', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 3, 1, 11, 57, 15, 892109)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 3, 1, 11, 57, 15, 892132)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 3, 1, 11, 57, 15, 890744)'}),
