...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductModel.cat10'
        db.delete_column('debra_productmodel', 'cat10')

        # Deleting field 'ProductModel.cat2'
        db.delete_column('debra_productmodel', 'cat2')

        # Deleting field 'ProductModel.cat4'
        db.delete_column('debra_productmodel', 'cat4')

        # Deleting field 'ProductModel.cat5'
        db.delete_column('debra_productmodel', 'cat5')

        # Deleting field 'ProductModel.cat6'
        db.delete_column('debra_productmodel', 'cat6')

        # Deleting field 'ProductModel.cat7'
        db.delete_column('debra_productmodel', 'cat7')

        # Deleting field 'ProductModel.cat8'
        db.delete_column('debra_productmodel', 'cat8')

        # Deleting field 'ProductModel.cat9'
        db.delete_column('debra_productmodel', 'cat9')

        # Deleting field 'ProductModel.cat3'
        db.delete_column('debra_productmodel', 'cat3')

        # Deleting field 'WishlistItem.cat2'
        db.delete_column('debra_wishlistitem', 'cat2')

        # Deleting field 'WishlistItem.cat3'
        db.delete_column('debra_wishlistitem', 'cat3')


    def backwards(self, orm):
        
        # Adding field 'ProductModel.cat10'
        db.add_column('debra_productmodel', 'cat10', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat2'
        db.add_column('debra_productmodel', 'cat2', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat4'
        db.add_column('debra_productmodel', 'cat4', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat5'
        db.add_column('debra_productmodel', 'cat5', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat6'
        db.add_column('debra_productmodel', 'cat6', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat7'
        db.add_column('debra_productmodel', 'cat7', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat8'
        db.add_column('debra_productmodel', 'cat8', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat9'
        db.add_column('debra_productmodel', 'cat9', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'ProductModel.cat3'
        db.add_column('debra_productmodel', 'cat3', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'WishlistItem.cat2'
        db.add_column('debra_wishlistitem', 'cat2', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)

        # Adding field 'WishlistItem.cat3'
        db.add_column('debra_wishlistitem', 'cat3', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 43, 238893)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 43, 238795)'}),
        ...
        'debra.lotterytask': {
            ...
            'task': ('django.db.models.fields.CharField', [], {'default': "{'meta': {'css_class': 'social_twitter', 'prompt': 'Twitter URL', 'instructions': 'to complete this task, click the twitter button below', 'type': 'url', 'icon': 'icon-social_twitter'}, 'name': 'twitter_follow', 'value': 'Follow on Twitter'}", 'max_length': '200'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 42, 706659)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 42, 706681)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 42, 705445)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 8, 23, 32, 42, 712000)'}),
