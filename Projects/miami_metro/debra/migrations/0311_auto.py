...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Platform', fields ['score_engagement_overall']
        db.create_index('debra_platform', ['score_engagement_overall'])

        # Adding index on 'Platform', fields ['score_popularity_overall']
        db.create_index('debra_platform', ['score_popularity_overall'])


    def backwards(self, orm):
        
        # Removing index on 'Platform', fields ['score_popularity_overall']
        db.delete_index('debra_platform', ['score_popularity_overall'])

        # Removing index on 'Platform', fields ['score_engagement_overall']
        db.delete_index('debra_platform', ['score_engagement_overall'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 5, 43, 28, 851070)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 17, 5, 43, 28, 851031)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 17, 5, 43, 28, 635693)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 17, 5, 43, 28, 635705)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 17, 5, 43, 28, 635037)'}),
