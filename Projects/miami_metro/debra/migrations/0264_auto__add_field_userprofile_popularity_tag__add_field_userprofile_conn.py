...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.popularity_tag'
        db.add_column('debra_userprofile', 'popularity_tag', self.gf('django.db.models.fields.CharField')(default='m', max_length=10), keep_default=False)

        # Adding field 'UserProfile.connector_tag'
        db.add_column('debra_userprofile', 'connector_tag', self.gf('django.db.models.fields.CharField')(default='c', max_length=10), keep_default=False)

        # Adding field 'UserProfile.quality_tag'
        db.add_column('debra_userprofile', 'quality_tag', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.popularity_tag'
        db.delete_column('debra_userprofile', 'popularity_tag')

        # Deleting field 'UserProfile.connector_tag'
        db.delete_column('debra_userprofile', 'connector_tag')

        # Deleting field 'UserProfile.quality_tag'
        db.delete_column('debra_userprofile', 'quality_tag')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 20, 16, 29, 371115)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 20, 16, 29, 371046)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 20, 16, 29, 26423)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 20, 16, 29, 26446)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 20, 16, 29, 25165)'}),
