...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlatformApiCalls'
        db.create_table('debra_platformapicalls', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('platform_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('calls_date', self.gf('django.db.models.fields.DateField')()),
            ('calls_hour', self.gf('django.db.models.fields.IntegerField')()),
            ('num_calls', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['PlatformApiCalls'])


    def backwards(self, orm):
        
        # Deleting model 'PlatformApiCalls'
        db.delete_table('debra_platformapicalls')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 19, 13, 29, 1, 156338)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 19, 13, 29, 1, 156302)'}),
        ...
        'debra.platformapicalls': {
            'Meta': {'object_name': 'PlatformApiCalls'},
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 19, 13, 29, 1, 53961)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 19, 13, 29, 1, 53974)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 19, 13, 29, 1, 53182)'}),
