...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('debra_productmodel', 'prod_url', self.gf('django.db.models.fields.URLField')(max_length=2000))

        # Changing field 'ProductModel.img_url'
        db.alter_column('debra_productmodel', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=2000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProductModel.img_url'
        db.alter_column('debra_productmodel', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 40, 13, 429841)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 40, 13, 429883)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 40, 13, 427758)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 40, 13, 439551)'}),
