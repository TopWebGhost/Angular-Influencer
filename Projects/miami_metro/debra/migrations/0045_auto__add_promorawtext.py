...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PromoRawText'
        db.create_table('debra_promorawtext', (
        ...
        db.send_create_signal('debra', ['PromoRawText'])


    def backwards(self, orm):
        
        # Deleting model 'PromoRawText'
        db.delete_table('debra_promorawtext')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 4, 10, 44, 41, 679426)'}),
