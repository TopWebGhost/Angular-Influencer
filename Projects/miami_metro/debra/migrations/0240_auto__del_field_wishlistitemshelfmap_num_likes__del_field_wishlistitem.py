...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WishlistItemShelfMap.num_likes'
        db.delete_column('debra_wishlistitemshelfmap', 'num_likes')

        # Deleting field 'WishlistItemShelfMap.num_dislikes'
        db.delete_column('debra_wishlistitemshelfmap', 'num_dislikes')

        # Deleting field 'Shelf.public_sharing_url'
        db.delete_column('debra_shelf', 'public_sharing_url')

        # Deleting field 'Shelf.is_inspiration'
        db.delete_column('debra_shelf', 'is_inspiration')

        # Deleting field 'Shelf.public_sharing_img_url'
        db.delete_column('debra_shelf', 'public_sharing_img_url')

        # Deleting field 'Shelf.num_views'
        db.delete_column('debra_shelf', 'num_views')

        # Deleting field 'Shelf.num_dislikes'
        db.delete_column('debra_shelf', 'num_dislikes')


    def backwards(self, orm):
        
        # Adding field 'WishlistItemShelfMap.num_likes'
        db.add_column('debra_wishlistitemshelfmap', 'num_likes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'WishlistItemShelfMap.num_dislikes'
        db.add_column('debra_wishlistitemshelfmap', 'num_dislikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        ...
        # Adding field 'Shelf.is_inspiration'
        db.add_column('debra_shelf', 'is_inspiration', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'Shelf.num_views'
        db.add_column('debra_shelf', 'num_views', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Shelf.num_dislikes'
        db.add_column('debra_shelf', 'num_dislikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 3, 1, 43, 691861)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 3, 1, 43, 691739)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 3, 1, 42, 341360)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 3, 1, 42, 341383)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 3, 1, 42, 340147)'}),
