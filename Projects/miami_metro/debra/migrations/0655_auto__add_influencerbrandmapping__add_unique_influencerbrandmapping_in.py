...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerBrandMapping'
        db.create_table('debra_influencerbrandmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True, blank=True)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Brands'], null=True, blank=True)),
            ('cell_phone', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('representation', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('rep_email_address', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('rep_phone', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('zip_code', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('mailing_address', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('categories', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('occupation', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('sex', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('age', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('ethnicity', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
            ('tags', self.gf('djorm_pgarray.fields.TextArrayField')(default='{}', dbtype=u'text', blank=True)),
        ))
        db.send_create_signal('debra', ['InfluencerBrandMapping'])

        # Adding unique constraint on 'InfluencerBrandMapping', fields ['influencer', 'brand']
        db.create_unique('debra_influencerbrandmapping', ['influencer_id', 'brand_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InfluencerBrandMapping', fields ['influencer', 'brand']
        db.delete_unique('debra_influencerbrandmapping', ['influencer_id', 'brand_id'])

        # Deleting model 'InfluencerBrandMapping'
        db.delete_table('debra_influencerbrandmapping')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 9, 22, 39, 33, 88872)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 9, 22, 39, 33, 88785)'}),
        ...
        'debra.influenceranalytics': {
            ...
            'tmp_approve_status': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'null': 'True'})
        },
        ...
        'debra.influencerbrandmapping': {
            ...
            'ethnicity': ('djorm_pgarray.fields.TextArrayField', [], {'default': "'{}'", u'dbtype': "u'text'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c4587aa7-e138-4a4b-b1bf-640fe1aa7724'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '5484', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 9, 22, 39, 31, 985569)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 9, 22, 39, 31, 985588)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 9, 22, 39, 31, 984265)'}),
