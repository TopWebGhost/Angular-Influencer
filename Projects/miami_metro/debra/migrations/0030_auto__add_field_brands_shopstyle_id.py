...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.shopstyle_id'
        db.add_column('debra_brands', 'shopstyle_id', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.shopstyle_id'
        db.delete_column('debra_brands', 'shopstyle_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 12, 4, 13, 159384)'}),
