...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfluencerValidationQueue.user'
        db.delete_column('debra_influencervalidationqueue', 'user_id')

        # Adding field 'InfluencerValidationQueue.uuid'
        db.add_column('debra_influencervalidationqueue', 'uuid', self.gf('django.db.models.fields.CharField')(default='f286f456-7014-4f00-b7cf-91840615e04e', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfluencerValidationQueue.user'
        raise RuntimeError("Cannot reverse this migration. 'InfluencerValidationQueue.user' and its values cannot be restored.")

        # Deleting field 'InfluencerValidationQueue.uuid'
        db.delete_column('debra_influencervalidationqueue', 'uuid')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 9, 26, 55, 120881)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 9, 26, 55, 120761)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fda9b574-38ca-42ba-8f1b-824ec13a469e'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '8854', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 9, 26, 53, 303263)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 9, 26, 53, 303284)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 9, 26, 53, 302196)'}),
