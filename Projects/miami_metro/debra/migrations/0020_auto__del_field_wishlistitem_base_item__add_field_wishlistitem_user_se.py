...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WishlistItem.base_item'
        db.delete_column('debra_wishlistitem', 'base_item_id')

        # Adding field 'WishlistItem.user_selection'
        db.add_column('debra_wishlistitem', 'user_selection', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserOperations'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WishlistItem.base_item'
        db.add_column('debra_wishlistitem', 'base_item', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserOperations'], null=True, blank=True), keep_default=False)

        # Deleting field 'WishlistItem.user_selection'
        db.delete_column('debra_wishlistitem', 'user_selection_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 11, 22, 30, 44, 110475)'}),
        ...
        'debra.wishlistitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user_id': ('django.db.models.fields.related.ForeignKey', [], {'default': "'0'", 'to': "orm['debra.UserIdMap']"}),
            'user_selection': ('django.db.models.fields.related.ForeignKey', [], {'default': "'0'", 'to': "orm['debra.UserOperations']", 'null': 'True', 'blank': 'True'})
        }
    }
