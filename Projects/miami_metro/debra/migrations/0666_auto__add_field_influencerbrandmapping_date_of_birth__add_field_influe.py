...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerBrandMapping.date_of_birth'
        db.add_column('debra_influencerbrandmapping', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.notes'
        db.add_column('debra_influencerbrandmapping', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfluencerBrandMapping.date_of_birth'
        db.delete_column('debra_influencerbrandmapping', 'date_of_birth')

        # Deleting field 'InfluencerBrandMapping.notes'
        db.delete_column('debra_influencerbrandmapping', 'notes')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 36, 35, 398882)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 36, 35, 398795)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'db132283-bea1-416c-bf29-742ca745d166'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '7072', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 36, 33, 863049)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 36, 33, 863100)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 36, 33, 860538)'}),
