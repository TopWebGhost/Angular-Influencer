...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HashtagInPost'
        db.create_table('debra_hashtaginpost', (
        ...
        db.send_create_signal('debra', ['HashtagInPost'])

        # Adding model 'BrandInPost'
        db.create_table('debra_brandinpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Brands'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'])),
        ))
        db.send_create_signal('debra', ['BrandInPost'])

        # Adding model 'MentionInPost'
        db.create_table('debra_mentioninpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mention', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'])),
        ))
        db.send_create_signal('debra', ['MentionInPost'])


    def backwards(self, orm):
        
        # Deleting model 'HashtagInPost'
        db.delete_table('debra_hashtaginpost')

        # Deleting model 'BrandInPost'
        db.delete_table('debra_brandinpost')

        # Deleting model 'MentionInPost'
        db.delete_table('debra_mentioninpost')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 10, 21, 39, 546121)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 10, 21, 39, 546084)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4258dbc1-59b0-48ff-b82a-fcdd3ef8ffbc'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '16621', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 10, 21, 39, 211719)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 10, 21, 39, 211733)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 10, 21, 39, 210936)'}),
