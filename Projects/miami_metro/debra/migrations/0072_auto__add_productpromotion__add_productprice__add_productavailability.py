...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductPromotion'
        db.create_table('debra_productpromotion', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.ProductPrice'], null=True, blank=True)),
            ('savings', self.gf('django.db.models.fields.FloatField')(default='0.0', max_length=10)),
        ))
        db.send_create_signal('debra', ['ProductPromotion'])

        # Adding model 'ProductPrice'
        db.create_table('debra_productprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ColorSizeModel'])),
        ...
        db.send_create_signal('debra', ['ProductPrice'])

        # Adding model 'ProductAvailability'
        db.create_table('debra_productavailability', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ColorSizeModel'])),
            ('finish_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('avail', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('debra', ['ProductAvailability'])


    def backwards(self, orm):
        
        # Deleting model 'ProductPromotion'
        db.delete_table('debra_productpromotion')

        # Deleting model 'ProductPrice'
        db.delete_table('debra_productprice')

        # Deleting model 'ProductAvailability'
        db.delete_table('debra_productavailability')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 29, 17, 40, 20, 388793)'}),
