...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfluencerCheck.platform'
        db.alter_column('debra_influencercheck', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Platform'], null=True))

        # Changing field 'InfluencerCheck.influencer'
        db.alter_column('debra_influencercheck', 'influencer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfluencerCheck.platform'
        raise RuntimeError("Cannot reverse this migration. 'InfluencerCheck.platform' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'InfluencerCheck.influencer'
        raise RuntimeError("Cannot reverse this migration. 'InfluencerCheck.influencer' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 30, 11, 15, 45, 732358)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 30, 11, 15, 45, 732319)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1bf5e0f4-1ad4-4795-9890-b63420503f8f'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '3734', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 30, 11, 15, 9, 658582)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 30, 11, 15, 9, 658597)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 30, 11, 15, 9, 657913)'}),
