...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promoinfo.exclude_category'
        db.add_column('debra_promoinfo', 'exclude_category', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Promoinfo.exclude_category'
        db.delete_column('debra_promoinfo', 'exclude_category')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 23, 14, 33, 27, 693769)'}),
