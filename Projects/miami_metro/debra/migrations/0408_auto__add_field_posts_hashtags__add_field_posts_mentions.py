...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Posts.hashtags'
        db.add_column('debra_posts', 'hashtags', self.gf('django.db.models.fields.CharField')(default=None, max_length=10000, null=True, blank=True), keep_default=False)

        # Adding field 'Posts.mentions'
        db.add_column('debra_posts', 'mentions', self.gf('django.db.models.fields.CharField')(default=None, max_length=10000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Posts.hashtags'
        db.delete_column('debra_posts', 'hashtags')

        # Deleting field 'Posts.mentions'
        db.delete_column('debra_posts', 'mentions')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 7, 44, 41, 855796)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 7, 44, 41, 855758)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5c261b36-e784-4324-8f0b-aee1b81f2a7f'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '21890', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 7, 44, 41, 564477)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 7, 44, 41, 564491)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 18, 7, 44, 41, 562987)'}),
