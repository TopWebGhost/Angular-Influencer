...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItemShelfMap.is_deleted'
        db.add_column('debra_wishlistitemshelfmap', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Shelf.is_deleted'
        db.add_column('debra_shelf', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'WishlistItem.is_deleted'
        db.add_column('debra_wishlistitem', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WishlistItemShelfMap.is_deleted'
        db.delete_column('debra_wishlistitemshelfmap', 'is_deleted')

        # Deleting field 'Shelf.is_deleted'
        db.delete_column('debra_shelf', 'is_deleted')

        # Deleting field 'WishlistItem.is_deleted'
        db.delete_column('debra_wishlistitem', 'is_deleted')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 1, 53, 10, 761601)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 1, 53, 10, 761643)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 1, 53, 10, 759504)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 1, 53, 10, 771275)'}),
