...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerBrandUserMapping'
        db.create_table('debra_influencerbrandusermapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='brand_mappings', null=True, to=orm['debra.Influencer'])),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='influencer_mappings', null=True, to=orm['debra.Brands'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='influencer_mappings', null=True, to=orm['auth.User'])),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['InfluencerBrandUserMapping'])

        # Adding unique constraint on 'InfluencerBrandUserMapping', fields ['influencer', 'brand', 'user']
        db.create_unique('debra_influencerbrandusermapping', ['influencer_id', 'brand_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InfluencerBrandUserMapping', fields ['influencer', 'brand', 'user']
        db.delete_unique('debra_influencerbrandusermapping', ['influencer_id', 'brand_id', 'user_id'])

        # Deleting model 'InfluencerBrandUserMapping'
        db.delete_table('debra_influencerbrandusermapping')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 17, 20, 5, 34, 505715)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 17, 20, 5, 34, 505632)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b9e9b98b-5c74-43bf-8a7f-47f6aabbe992'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '16223', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 17, 20, 5, 33, 254988)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 17, 20, 5, 33, 255021)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 17, 20, 5, 33, 252961)'}),
