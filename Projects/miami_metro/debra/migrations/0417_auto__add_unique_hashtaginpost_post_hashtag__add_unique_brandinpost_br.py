...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 24, 19, 750736)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 24, 19, 750700)'}),
        ...
        'debra.brandinpost': {
            'Meta': {'unique_together': "(('brand', 'post'),)", 'object_name': 'BrandInPost'},
        ...
        'debra.hashtaginpost': {
            'Meta': {'unique_together': "(('hashtag', 'post'),)", 'object_name': 'HashtagInPost'},
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'62701034-0bc8-4833-be92-d533e0473bb9'", 'max_length': '64'})
        },
        ...
        'debra.mentioninpost': {
            'Meta': {'unique_together': "(('mention', 'post'),)", 'object_name': 'MentionInPost'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mention': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']"})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '17947', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 24, 19, 429006)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 24, 19, 429019)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 24, 19, 428196)'}),
