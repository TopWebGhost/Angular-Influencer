...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerValidationQueue'
        db.create_table('debra_influencervalidationqueue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='validation_queue', to=orm['auth.User'])),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='validation_queue', to=orm['debra.Influencer'])),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['InfluencerValidationQueue'])


    def backwards(self, orm):
        
        # Deleting model 'InfluencerValidationQueue'
        db.delete_table('debra_influencervalidationqueue')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 7, 31, 17, 859365)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 18, 7, 31, 17, 859284)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'validation_queue'", 'to': "orm['auth.User']"})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '7100', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 7, 31, 17, 173974)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 7, 31, 17, 174001)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 18, 7, 31, 17, 172584)'}),
