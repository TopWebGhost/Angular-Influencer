...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LotteryTask.custom_options'
        db.delete_column('debra_lotterytask', 'custom_options')

        # Adding field 'LotteryTask.custom_option'
        db.add_column('debra_lotterytask', 'custom_option', self.gf('django.db.models.fields.CharField')(default=('text_field', 'include a text field'), max_length=50), keep_default=False)

        # Adding field 'LotteryEntryCompletedTask.custom_task_response'
        db.add_column('debra_lotteryentrycompletedtask', 'custom_task_response', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'LotteryTask.custom_options'
        db.add_column('debra_lotterytask', 'custom_options', self.gf('django.db.models.fields.CharField')(default='text_field', max_length=50), keep_default=False)

        # Deleting field 'LotteryTask.custom_option'
        db.delete_column('debra_lotterytask', 'custom_option')

        # Deleting field 'LotteryEntryCompletedTask.custom_task_response'
        db.delete_column('debra_lotteryentrycompletedtask', 'custom_task_response')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 38, 21, 603952)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 38, 21, 603881)'}),
        ...
        'debra.lotterytask': {
            ...
            'custom_option': ('django.db.models.fields.CharField', [], {'default': "('text_field', 'include a text field')", 'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lottery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Lottery']"}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 37, 52, 153320)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 37, 52, 153367)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 37, 52, 152183)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 37, 52, 158504)'}),
