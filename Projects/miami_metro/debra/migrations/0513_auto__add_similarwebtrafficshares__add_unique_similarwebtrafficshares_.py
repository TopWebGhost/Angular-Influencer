...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimilarWebTrafficShares'
        db.create_table('debra_similarwebtrafficshares', (
        ...
        db.send_create_signal('debra', ['SimilarWebTrafficShares'])

        # Adding unique constraint on 'SimilarWebTrafficShares', fields ['influencer', 'source_type']
        db.create_unique('debra_similarwebtrafficshares', ['influencer_id', 'source_type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SimilarWebTrafficShares', fields ['influencer', 'source_type']
        db.delete_unique('debra_similarwebtrafficshares', ['influencer_id', 'source_type'])

        # Deleting model 'SimilarWebTrafficShares'
        db.delete_table('debra_similarwebtrafficshares')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 25, 12, 46, 53, 973793)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 25, 12, 46, 53, 973654)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'386b3ad3-0ee4-4169-b04f-25681cce69e9'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '22225', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 25, 12, 46, 52, 833917)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 25, 12, 46, 52, 833939)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 25, 12, 46, 52, 832786)'}),
