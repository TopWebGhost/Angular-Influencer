...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductModel.gender'
        db.alter_column('debra_productmodel', 'gender', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Items.gender'
        db.alter_column('debra_items', 'gender', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SSItemStats.gender'
        db.alter_column('debra_ssitemstats', 'gender', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Adding field 'StoreSpecificItemCategory.gender'
        db.add_column('debra_storespecificitemcategory', 'gender', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'ProductModel.gender'
        db.alter_column('debra_productmodel', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Items.gender'
        db.alter_column('debra_items', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'SSItemStats.gender'
        db.alter_column('debra_ssitemstats', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Deleting field 'StoreSpecificItemCategory.gender'
        db.delete_column('debra_storespecificitemcategory', 'gender')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 13, 19, 14, 36, 183106)'}),
