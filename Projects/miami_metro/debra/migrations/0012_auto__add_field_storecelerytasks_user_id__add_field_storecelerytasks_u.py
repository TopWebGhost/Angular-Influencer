...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreCeleryTasks.user_id'
        db.add_column('debra_storecelerytasks', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='11', to=orm['debra.UserIdMap']), keep_default=False)

        # Adding field 'StoreCeleryTasks.user_notify'
        db.add_column('debra_storecelerytasks', 'user_notify', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreCeleryTasks.user_id'
        db.delete_column('debra_storecelerytasks', 'user_id_id')

        # Deleting field 'StoreCeleryTasks.user_notify'
        db.delete_column('debra_storecelerytasks', 'user_notify')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 8, 17, 31, 39, 40529)'}),
