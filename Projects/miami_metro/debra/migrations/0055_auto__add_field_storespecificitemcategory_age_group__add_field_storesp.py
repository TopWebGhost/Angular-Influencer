...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreSpecificItemCategory.age_group'
        db.add_column('debra_storespecificitemcategory', 'age_group', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=10), keep_default=False)

        # Adding field 'StoreSpecificItemCategory.hash_val'
        db.add_column('debra_storespecificitemcategory', 'hash_val', self.gf('django.db.models.fields.IntegerField')(default='0'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreSpecificItemCategory.age_group'
        db.delete_column('debra_storespecificitemcategory', 'age_group')

        # Deleting field 'StoreSpecificItemCategory.hash_val'
        db.delete_column('debra_storespecificitemcategory', 'hash_val')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 4, 15, 7, 16, 913415)'}),
        ...
        'debra.storespecificitemcategory': {
            ...
            'categoryName': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '100'}),
            'gender': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '10'}),
            'hash_val': ('django.db.models.fields.IntegerField', [], {'default': "'0'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'debra.useridmap': {
