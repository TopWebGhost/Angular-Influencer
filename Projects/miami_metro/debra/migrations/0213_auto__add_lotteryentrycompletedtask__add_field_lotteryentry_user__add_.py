...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LotteryEntryCompletedTask'
        db.create_table('debra_lotteryentrycompletedtask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.LotteryEntry'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.LotteryTask'])),
        ))
        db.send_create_signal('debra', ['LotteryEntryCompletedTask'])

        # Adding field 'LotteryEntry.user'
        db.add_column('debra_lotteryentry', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.UserProfile']), keep_default=False)

        # Adding field 'LotteryEntry.is_winner'
        db.add_column('debra_lotteryentry', 'is_winner', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LotteryEntryCompletedTask'
        db.delete_table('debra_lotteryentrycompletedtask')

        # Deleting field 'LotteryEntry.user'
        db.delete_column('debra_lotteryentry', 'user_id')

        # Deleting field 'LotteryEntry.is_winner'
        db.delete_column('debra_lotteryentry', 'is_winner')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 39, 928932)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 39, 928851)'}),
        ...
        'debra.lottery': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.UserProfile']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 157409)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 157381)'}),
        ...
        'debra.lotterytask': {
            ...
            'task': ('django.db.models.fields.CharField', [], {'default': "{'meta': {'css_class': 'social_twitter', 'prompt': 'Twitter URL', 'type': 'url', 'icon': 'icon-social_twitter'}, 'name': 'twitter_follow', 'value': 'Follow on Twitter'}", 'max_length': '200'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 119162)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 119185)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 118010)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 15, 49, 37, 124409)'}),
