...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShelfBloggerWidgetImages.num_rows'
        db.add_column('debra_shelfbloggerwidgetimages', 'num_rows', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ShelfBloggerWidgetImages.num_elems'
        db.add_column('debra_shelfbloggerwidgetimages', 'num_elems', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShelfBloggerWidgetImages.num_rows'
        db.delete_column('debra_shelfbloggerwidgetimages', 'num_rows')

        # Deleting field 'ShelfBloggerWidgetImages.num_elems'
        db.delete_column('debra_shelfbloggerwidgetimages', 'num_elems')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 56, 39, 159914)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 56, 39, 159949)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 56, 39, 158766)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 5, 21, 56, 39, 164887)'}),
