...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_influencer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Blogger name', max_length=100, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('shelf_user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('fb_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ...
            ('instagram_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('tumblr_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
        ...
        db.send_create_signal('debra', ['Influencer'])

        # Adding model 'PostInteractions'
        db.create_table('debra_postinteractions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'])),
            ...
            ('comment_made', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('if_liked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('if_shared', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('debra', ['PostInteractions'])

        # Adding model 'Posts'
        db.create_table('debra_posts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'])),
            ('platform_name', self.gf('django.db.models.fields.CharField')(default='Platform name', max_length=100, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='Blog Post Title', max_length=100, null=True, blank=True)),
            ...
            ('num_prizes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('prize_money', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['Posts'])
        ...
        db.create_table('debra_follower', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firstname', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('lastname', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('shelf_user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('birthday', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('debra', ['Follower'])

        # Changing field 'WishlistItem.product_model'
        db.alter_column('debra_wishlistitem', 'product_model_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductModel']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('debra_influencer')

        # Deleting model 'PostInteractions'
        db.delete_table('debra_postinteractions')

        # Deleting model 'Posts'
        db.delete_table('debra_posts')

        # Deleting model 'FollowerTimeSeries'
        db.delete_table('debra_followertimeseries')

        # Deleting model 'Follower'
        db.delete_table('debra_follower')

        # Changing field 'WishlistItem.product_model'
        db.alter_column('debra_wishlistitem', 'product_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ProductModel'], null=True))
    ...
    models = {
        ...
        'debra.posts': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'Blog Post Title'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 13, 8, 10, 240154)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 13, 8, 10, 240179)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 13, 8, 10, 239053)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 13, 8, 10, 245101)'}),
