...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductModel.track_last_start_time'
        db.delete_column('debra_productmodel', 'track_last_start_time')

        # Deleting field 'ProductModel.err_text'
        db.delete_column('debra_productmodel', 'err_text')

        # Deleting field 'ProductModel.incomplete_flag'
        db.delete_column('debra_productmodel', 'incomplete_flag')

        # Deleting field 'ProductModel.idx'
        db.delete_column('debra_productmodel', 'idx')

        # Deleting field 'ProductModel.gender'
        db.delete_column('debra_productmodel', 'gender')

        # Deleting field 'ProductModel.track_last_finish_time'
        db.delete_column('debra_productmodel', 'track_last_finish_time')


    def backwards(self, orm):
        
        # Adding field 'ProductModel.track_last_start_time'
        db.add_column('debra_productmodel', 'track_last_start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'ProductModel.err_text'
        db.add_column('debra_productmodel', 'err_text', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)

        # Adding field 'ProductModel.incomplete_flag'
        db.add_column('debra_productmodel', 'incomplete_flag', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ProductModel.idx'
        db.add_column('debra_productmodel', 'idx', self.gf('django.db.models.fields.IntegerField')(default='-11', max_length=10), keep_default=False)

        # Adding field 'ProductModel.gender'
        db.add_column('debra_productmodel', 'gender', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=10), keep_default=False)

        # Adding field 'ProductModel.track_last_finish_time'
        db.add_column('debra_productmodel', 'track_last_finish_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 2, 7, 11, 215267)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 2, 7, 11, 215158)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 2, 7, 10, 877205)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 2, 7, 10, 877231)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 2, 7, 10, 875996)'}),
