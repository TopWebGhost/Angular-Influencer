...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.email_for_advertising_or_collaborations'
        db.add_column('debra_influencer', 'email_for_advertising_or_collaborations', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.email_all_other'
        db.add_column('debra_influencer', 'email_all_other', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.contact_form_if_no_email'
        db.add_column('debra_influencer', 'contact_form_if_no_email', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.email_for_advertising_or_collaborations'
        db.delete_column('debra_influencer', 'email_for_advertising_or_collaborations')

        # Deleting field 'Influencer.email_all_other'
        db.delete_column('debra_influencer', 'email_all_other')

        # Deleting field 'Influencer.contact_form_if_no_email'
        db.delete_column('debra_influencer', 'contact_form_if_no_email')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 13, 20, 58, 38, 518635)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 13, 20, 58, 38, 518523)'}),
        ...
        'debra.influencer': {
            ...
            'qa': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            ...
            'validated_on': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'268afc50-fee6-4c0e-b902-36abb329450b'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '6343', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 13, 20, 58, 37, 422451)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 13, 20, 58, 37, 422479)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 13, 20, 58, 37, 421037)'}),
