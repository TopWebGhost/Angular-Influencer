...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_lotteryentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lottery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Lottery'])),
        ))
        db.send_create_signal('debra', ['LotteryEntry'])

        # Adding field 'Embeddable.lottery'
        db.add_column('debra_embeddable', 'lottery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Lottery'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LotteryEntry'
        db.delete_table('debra_lotteryentry')

        # Deleting field 'Embeddable.lottery'
        db.delete_column('debra_embeddable', 'lottery_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 30, 218945)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 30, 218872)'}),
        ...
        'debra.lottery': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.UserProfile']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 759378)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 759331)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 719139)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 719162)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 717978)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 3, 19, 29, 724325)'}),
