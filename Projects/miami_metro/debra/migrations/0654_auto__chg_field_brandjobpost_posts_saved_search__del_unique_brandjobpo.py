...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BrandJobPost', fields ['posts_saved_search']
        db.delete_unique('debra_brandjobpost', ['posts_saved_search_id'])

        # Changing field 'BrandJobPost.posts_saved_search'
        db.alter_column('debra_brandjobpost', 'posts_saved_search_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.SearchQueryArchive'], null=True))


    def backwards(self, orm):
        
        # Changing field 'BrandJobPost.posts_saved_search'
        db.alter_column('debra_brandjobpost', 'posts_saved_search_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.SearchQueryArchive'], unique=True, null=True))

        # Adding unique constraint on 'BrandJobPost', fields ['posts_saved_search']
        db.create_unique('debra_brandjobpost', ['posts_saved_search_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 3, 13, 23, 12, 478894)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 3, 13, 23, 12, 478767)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'818d8f7e-5958-447b-88d0-af03906aba3e'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '15845', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 3, 13, 23, 11, 345672)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 3, 13, 23, 11, 345703)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 3, 13, 23, 11, 343943)'}),
