...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PromotionApplied.combination_id'
        db.add_column('debra_promotionapplied', 'combination_id', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PromotionApplied.combination_id'
        db.delete_column('debra_promotionapplied', 'combination_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 7, 17, 49, 39, 87633)'}),
