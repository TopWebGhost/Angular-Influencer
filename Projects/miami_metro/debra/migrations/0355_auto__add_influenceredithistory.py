...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerEditHistory'
        db.create_table('debra_influenceredithistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edit_history', to=orm['debra.Influencer'])),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('prev_value', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('curr_value', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('debra', ['InfluencerEditHistory'])


    def backwards(self, orm):
        
        # Deleting model 'InfluencerEditHistory'
        db.delete_table('debra_influenceredithistory')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 10, 21, 13, 998193)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 10, 21, 13, 998125)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '18114', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 10, 21, 13, 452532)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 10, 21, 13, 452552)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 10, 21, 13, 451454)'}),
