...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('debra_useroperations', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserIdMap']), keep_default=False)

        # Adding field 'PricingTasks.user_id'
        db.add_column('debra_pricingtasks', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserIdMap']), keep_default=False)

        # Adding field 'CombinationOfUserOps.user_id'
        db.add_column('debra_combinationofuserops', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserIdMap']), keep_default=False)

        # Adding field 'WishlistItem.user_id'
        db.add_column('debra_wishlistitem', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserIdMap']), keep_default=False)
    ...
    models = {
        ...
        'debra.combinationofuserops': {
            ...
            'userid_new': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.items': {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 24, 15, 6, 50, 429302)'}),
