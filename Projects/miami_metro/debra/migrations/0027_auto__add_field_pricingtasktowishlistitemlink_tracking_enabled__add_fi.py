...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PricingTaskToWishlistItemLink.tracking_enabled'
        db.add_column('debra_pricingtasktowishlistitemlink', 'tracking_enabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'StoreItemCombinationResults.completion_time'
        db.add_column('debra_storeitemcombinationresults', 'completion_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 14, 16, 15, 5, 166332)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PricingTaskToWishlistItemLink.tracking_enabled'
        db.delete_column('debra_pricingtasktowishlistitemlink', 'tracking_enabled')

        # Deleting field 'StoreItemCombinationResults.completion_time'
        db.delete_column('debra_storeitemcombinationresults', 'completion_time')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 14, 16, 15, 5, 157534)'}),
        ...
        'debra.storeitemcombinationresults': {
            ...
            'combination_id': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '200'}),
            'completion_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 16, 15, 5, 166332)'}),
