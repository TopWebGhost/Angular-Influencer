...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostAnalyticsCollection.creator_brand'
        db.add_column('debra_postanalyticscollection', 'creator_brand', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_post_analytics_collections', null=True, to=orm['debra.Brands']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostAnalyticsCollection.creator_brand'
        db.delete_column('debra_postanalyticscollection', 'creator_brand_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 13, 9, 25, 599160)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 11, 13, 9, 25, 599081)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e493c38a-8e1a-4694-a6d4-e02ae91cc5e0'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '24068', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 8, 11, 13, 9, 24, 580039)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 8, 11, 13, 9, 24, 580061)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 8, 11, 13, 9, 24, 578823)'}),
