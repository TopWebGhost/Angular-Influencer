...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contract.mapping'
        db.delete_column('debra_contract', 'mapping_id')

        # Adding field 'InfluencerJobMapping.contract'
        db.add_column('debra_influencerjobmapping', 'contract', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.Contract'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Contract.mapping'
        db.add_column('debra_contract', 'mapping', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.InfluencerJobMapping'], unique=True, null=True), keep_default=False)

        # Deleting field 'InfluencerJobMapping.contract'
        db.delete_column('debra_influencerjobmapping', 'contract_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 48, 26, 149921)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 48, 26, 149845)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'63fff7e9-928f-48bb-82f9-d71306697103'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13987', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 48, 25, 257656)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 48, 25, 257679)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 48, 25, 256517)'}),
