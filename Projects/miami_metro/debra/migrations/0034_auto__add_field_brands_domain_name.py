...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.domain_name'
        db.add_column('debra_brands', 'domain_name', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.domain_name'
        db.delete_column('debra_brands', 'domain_name')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 20, 14, 5, 7, 325218)'}),
