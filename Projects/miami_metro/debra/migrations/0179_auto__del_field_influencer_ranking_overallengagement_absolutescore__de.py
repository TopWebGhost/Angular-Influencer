...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Platform.posting_rate'
        db.add_column('debra_platform', 'posting_rate', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
        ...
        db.add_column('debra_platform', 'brandfit_matrix', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.total_numlikes'
        db.add_column('debra_platform', 'total_numlikes', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.total_numcomments'
        db.add_column('debra_platform', 'total_numcomments', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.total_numshares'
        db.add_column('debra_platform', 'total_numshares', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('debra_influencer', 'ranking_overallengagement_absolutescore', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.ranking_overallseoscore'
        db.add_column('debra_influencer', 'ranking_overallseoscore', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'Platform.posting_rate'
        db.delete_column('debra_platform', 'posting_rate')
        ...
        # Deleting field 'Platform.total_numlikes'
        db.delete_column('debra_platform', 'total_numlikes')

        # Deleting field 'Platform.total_numcomments'
        db.delete_column('debra_platform', 'total_numcomments')

        # Deleting field 'Platform.total_numshares'
        db.delete_column('debra_platform', 'total_numshares')
    ...
    models = {
        ...
        'debra.influencer': {
            ...
            'ranking_blogging_rate_score': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.platform': {
            ...
            'brandfit_matrix': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'posting_rate': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 28, 14, 9, 17, 477233)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 28, 14, 9, 17, 477255)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 28, 14, 9, 17, 476067)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 28, 14, 9, 17, 482814)'}),
