...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('debra_contract', 'post_collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contracts', null=True, to=orm['debra.PostAnalyticsCollection']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('debra_brandjobpost', 'post_collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='campaigns', null=True, to=orm['debra.PostAnalyticsCollection']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 17, 19, 24, 23, 355513)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 17, 19, 24, 23, 355412)'}),
        ...
        'debra.contract': {
            ...
            'post_collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contracts'", 'null': 'True', 'to': "orm['debra.PostAnalyticsCollection']"}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4108cd4b-4a29-45cc-b35d-03fed40e4f05'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '17552', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 19, 24, 22, 460019)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 19, 24, 22, 460049)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 19, 24, 22, 458449)'}),
