...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.blogger_address'
        db.add_column('debra_contract', 'blogger_address', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Deleting field 'Influencer.address'
        db.delete_column('debra_influencer', 'address')


    def backwards(self, orm):
        
        # Deleting field 'Contract.blogger_address'
        db.delete_column('debra_contract', 'blogger_address')

        # Adding field 'Influencer.address'
        db.add_column('debra_influencer', 'address', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 9, 1, 11, 20, 113180)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 9, 1, 11, 20, 113097)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'db325983-7061-45ae-bbc0-35f892cd5950'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '6670', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 9, 1, 11, 18, 989312)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 9, 1, 11, 18, 989332)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 9, 1, 11, 18, 988194)'}),
