...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.admin_classification_tags'
        db.add_column('debra_userprofile', 'admin_classification_tags', self.gf('django.db.models.fields.CharField')(default='Quality,Just Fasion,Fashion +', max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.admin_classification_tags'
        db.delete_column('debra_userprofile', 'admin_classification_tags')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 21, 14, 5, 811643)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 21, 14, 5, 811552)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 21, 14, 5, 246375)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 21, 14, 5, 246396)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 21, 14, 5, 245044)'}),
        ...
        'debra.userprofile': {
            ...
            'admin_categorized': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'admin_classification_tags': ('django.db.models.fields.CharField', [], {'default': "'Quality,Just Fasion,Fashion +'", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
