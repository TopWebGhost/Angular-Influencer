...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BrandTaxonomy.influencers_count'
        db.add_column('debra_brandtaxonomy', 'influencers_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'BrandTaxonomy.posts_count'
        db.add_column('debra_brandtaxonomy', 'posts_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'BrandTaxonomy.instagrams_count'
        db.add_column('debra_brandtaxonomy', 'instagrams_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'BrandTaxonomy.blog_posts_count'
        db.add_column('debra_brandtaxonomy', 'blog_posts_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BrandTaxonomy.influencers_count'
        db.delete_column('debra_brandtaxonomy', 'influencers_count')

        # Deleting field 'BrandTaxonomy.posts_count'
        db.delete_column('debra_brandtaxonomy', 'posts_count')

        # Deleting field 'BrandTaxonomy.instagrams_count'
        db.delete_column('debra_brandtaxonomy', 'instagrams_count')

        # Deleting field 'BrandTaxonomy.blog_posts_count'
        db.delete_column('debra_brandtaxonomy', 'blog_posts_count')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 10, 16, 8, 25, 996807)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 10, 16, 8, 25, 996722)'}),
        ...
        'debra.brandtaxonomy': {
            ...
            'hashtags': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'keywords': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'mention_urls': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'mentions': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'284b8595-cac6-472d-8194-487f0c9de6d6'", 'max_length': '64'})
        },
        ...
        'debra.platform': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '15262', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'192.168.0.100'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 16, 8, 25, 56336)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 16, 8, 25, 56360)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 10, 16, 8, 25, 54922)'}),
