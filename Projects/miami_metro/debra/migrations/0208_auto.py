...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Brands', fields ['domain_name']
        db.create_index('debra_brands', ['domain_name'])

        # Adding index on 'ProductModel', fields ['prod_url']
        db.create_index('debra_productmodel', ['prod_url'])


    def backwards(self, orm):
        
        # Removing index on 'ProductModel', fields ['prod_url']
        db.delete_index('debra_productmodel', ['prod_url'])

        # Removing index on 'Brands', fields ['domain_name']
        db.delete_index('debra_brands', ['domain_name'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 728792)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 728746)'}),
        ...
        'debra.lottery': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 476788)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 476771)'}),
        ...
        'debra.lotterytask': {
            ...
            'task': ('django.db.models.fields.CharField', [], {'default': "{'meta': {'css_class': 'social_twitter', 'icon': 'icon-social_twitter'}, 'name': 'twitter_follow', 'value': 'Follow on Twitter'}", 'max_length': '200'})
        },
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 453154)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 453166)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 452447)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 3, 9, 36, 10, 456442)'}),
