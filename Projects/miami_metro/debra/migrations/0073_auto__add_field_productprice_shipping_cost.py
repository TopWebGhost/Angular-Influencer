...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductPrice.shipping_cost'
        db.add_column('debra_productprice', 'shipping_cost', self.gf('django.db.models.fields.FloatField')(default='-1.0', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductPrice.shipping_cost'
        db.delete_column('debra_productprice', 'shipping_cost')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 14, 10, 52, 49, 752249)'}),
