...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinkFromPost'
        db.create_table('debra_linkfrompost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sourcelink_set', to=orm['debra.Posts'])),
            ('dest_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='destlink_set', to=orm['debra.Posts'])),
        ))
        db.send_create_signal('debra', ['LinkFromPost'])


    def backwards(self, orm):
        
        # Deleting model 'LinkFromPost'
        db.delete_table('debra_linkfrompost')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 4, 6, 27, 20, 275971)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 4, 6, 27, 20, 275934)'}),
        ...
        'debra.brandjobpost': {
            ...
            'collection': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'job_post'", 'unique': 'True', 'null': 'True', 'to': "orm['debra.InfluencersGroup']"}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cf53730e-1d39-4cd2-98d9-49d3ab61a925'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '9260', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 4, 6, 27, 19, 953400)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 4, 6, 27, 19, 953414)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 4, 6, 27, 19, 952628)'}),
