...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreCeleryTasks.enqueue_time'
        db.add_column('debra_storecelerytasks', 'enqueue_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'StoreCeleryTasks.start_time'
        db.add_column('debra_storecelerytasks', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'StoreCeleryTasks.finish_time'
        db.add_column('debra_storecelerytasks', 'finish_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreCeleryTasks.enqueue_time'
        db.delete_column('debra_storecelerytasks', 'enqueue_time')

        # Deleting field 'StoreCeleryTasks.start_time'
        db.delete_column('debra_storecelerytasks', 'start_time')

        # Deleting field 'StoreCeleryTasks.finish_time'
        db.delete_column('debra_storecelerytasks', 'finish_time')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 7, 17, 4, 22, 392191)'}),
