...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OperationStatus'
        db.create_table('debra_operationstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_type', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('object_spec', self.gf('django.db.models.fields.CharField')(max_length=10000, db_index=True)),
            ('op', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('op_status', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True)),
            ('op_msg', self.gf('django.db.models.fields.CharField')(max_length=50000, null=True)),
            ('op_date', self.gf('django.db.models.fields.DateField')()),
            ('op_hour', self.gf('django.db.models.fields.IntegerField')()),
            ('op_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['OperationStatus'])

        # Adding unique constraint on 'OperationStatus', fields ['object_type', 'object_spec', 'op', 'op_status', 'op_msg', 'op_date', 'op_hour']
        db.create_unique('debra_operationstatus', ['object_type', 'object_spec', 'op', 'op_status', 'op_msg', 'op_date', 'op_hour'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OperationStatus', fields ['object_type', 'object_spec', 'op', 'op_status', 'op_msg', 'op_date', 'op_hour']
        db.delete_unique('debra_operationstatus', ['object_type', 'object_spec', 'op', 'op_status', 'op_msg', 'op_date', 'op_hour'])

        # Deleting model 'OperationStatus'
        db.delete_table('debra_operationstatus')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 7, 20, 32, 543037)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 7, 20, 32, 542996)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 7, 20, 32, 366176)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 7, 20, 32, 366187)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 7, 20, 32, 365542)'}),
