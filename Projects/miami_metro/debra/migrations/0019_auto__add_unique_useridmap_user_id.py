...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserIdMap', fields ['user_id']
        db.create_unique('debra_useridmap', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserIdMap', fields ['user_id']
        db.delete_unique('debra_useridmap', ['user_id'])
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 11, 22, 7, 52, 847532)'}),
