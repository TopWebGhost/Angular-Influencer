...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LinkFromPlatform'
        db.create_table('debra_linkfromplatform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_platform', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sourcelink_set', to=orm['debra.Platform'])),
            ('dest_platform', self.gf('django.db.models.fields.related.ForeignKey')(related_name='destlink_set', null=True, to=orm['debra.Platform'])),
            ('dest_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
        ))
        db.send_create_signal('debra', ['LinkFromPlatform'])


    def backwards(self, orm):
        
        # Deleting model 'LinkFromPlatform'
        db.delete_table('debra_linkfromplatform')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 8, 43, 4, 347945)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 8, 43, 4, 347907)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 8, 43, 4, 157381)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 8, 43, 4, 157393)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 26, 8, 43, 4, 156657)'}),
