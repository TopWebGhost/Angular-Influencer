...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Promoinfo', fields ['sex_category', 'd', 'promo_type', 'promo_disc_amount', 'promo_disc_lower_bound', 'promo_disc_perc', 'store', 'item_category']
        db.delete_unique('debra_promoinfo', ['sex_category', 'd', 'promo_type', 'promo_disc_amount', 'promo_disc_lower_bound', 'promo_disc_perc', 'store_id', 'item_category'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Promoinfo', fields ['sex_category', 'd', 'promo_type', 'promo_disc_amount', 'promo_disc_lower_bound', 'promo_disc_perc', 'store', 'item_category']
        db.create_unique('debra_promoinfo', ['sex_category', 'd', 'promo_type', 'promo_disc_amount', 'promo_disc_lower_bound', 'promo_disc_perc', 'store_id', 'item_category'])
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 19, 22, 43, 24, 750156)'}),
