...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserOperations.time'
        db.delete_column('debra_useroperations', 'time')

        # Adding field 'UserOperations.datetime'
        db.add_column('debra_useroperations', 'datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserOperations.time'
        db.add_column('debra_useroperations', 'time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Deleting field 'UserOperations.datetime'
        db.delete_column('debra_useroperations', 'datetime')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 11, 21, 31, 39, 323021)'}),
