...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostShelfMap.user_prof'
        db.alter_column('debra_postshelfmap', 'user_prof_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.UserProfile']))

        # Changing field 'PostShelfMap.shelf'
        db.alter_column('debra_postshelfmap', 'shelf_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Shelf']))

        # Changing field 'PostShelfMap.post'
        db.alter_column('debra_postshelfmap', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Posts']))


    def backwards(self, orm):
        
        # Changing field 'PostShelfMap.user_prof'
        db.alter_column('debra_postshelfmap', 'user_prof_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.UserProfile'], null=True))

        # Changing field 'PostShelfMap.shelf'
        db.alter_column('debra_postshelfmap', 'shelf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Shelf'], null=True))

        # Changing field 'PostShelfMap.post'
        db.alter_column('debra_postshelfmap', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 59, 576177)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 59, 576107)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 46, 135662)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 46, 135686)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 46, 134055)'}),
