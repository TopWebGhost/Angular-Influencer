...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.post_collection'
        db.alter_column('debra_contract', 'post_collection_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['debra.PostAnalyticsCollection']))

        # Adding unique constraint on 'Contract', fields ['post_collection']
        db.create_unique('debra_contract', ['post_collection_id'])

        # Adding field 'PostAnalytics.post_date'
        db.add_column('debra_postanalytics', 'post_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'PostAnalytics.post_title'
        db.add_column('debra_postanalytics', 'post_title', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'PostAnalytics.post_type'
        db.add_column('debra_postanalytics', 'post_type', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Contract', fields ['post_collection']
        db.delete_unique('debra_contract', ['post_collection_id'])

        # Changing field 'Contract.post_collection'
        db.alter_column('debra_contract', 'post_collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['debra.PostAnalyticsCollection']))

        # Deleting field 'PostAnalytics.post_date'
        db.delete_column('debra_postanalytics', 'post_date')

        # Deleting field 'PostAnalytics.post_title'
        db.delete_column('debra_postanalytics', 'post_title')

        # Deleting field 'PostAnalytics.post_type'
        db.delete_column('debra_postanalytics', 'post_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 17, 22, 17, 34, 111136)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 17, 22, 17, 34, 110981)'}),
        ...
        'debra.contract': {
            ...
            'post_collection': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'contract'", 'unique': 'True', 'null': 'True', 'to': "orm['debra.PostAnalyticsCollection']"}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb64f2ae-40cf-42dd-865a-16b9706a78d4'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '25672', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 22, 17, 32, 872036)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 22, 17, 32, 872121)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 17, 22, 17, 32, 869789)'}),
