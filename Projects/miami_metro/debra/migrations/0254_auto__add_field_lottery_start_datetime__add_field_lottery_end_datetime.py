...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lottery.start_datetime'
        db.add_column('debra_lottery', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Lottery.end_datetime'
        db.add_column('debra_lottery', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 24, 1, 54, 25, 499247)), keep_default=False)

        # Adding field 'Lottery.timezone'
        db.add_column('debra_lottery', 'timezone', self.gf('django.db.models.fields.CharField')(default=(-5, 'America/New_York'), max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lottery.start_datetime'
        db.delete_column('debra_lottery', 'start_datetime')

        # Deleting field 'Lottery.end_datetime'
        db.delete_column('debra_lottery', 'end_datetime')

        # Deleting field 'Lottery.timezone'
        db.delete_column('debra_lottery', 'timezone')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 24, 1, 54, 25, 549215)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 24, 1, 54, 25, 549144)'}),
        ...
        'debra.lottery': {
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': "(-5, 'America/New_York')", 'max_length': '100'})
        },
        'debra.lotteryentry': {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 24, 1, 54, 19, 767077)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 24, 1, 54, 19, 767102)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 24, 1, 54, 19, 765720)'}),
