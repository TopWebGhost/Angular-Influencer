...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PopularityTimeSeries.num_comments'
        db.add_column('debra_popularitytimeseries', 'num_comments', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Posts.denorm_num_comments'
        db.add_column('debra_posts', 'denorm_num_comments', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PopularityTimeSeries.num_comments'
        db.delete_column('debra_popularitytimeseries', 'num_comments')

        # Deleting field 'Posts.denorm_num_comments'
        db.delete_column('debra_posts', 'denorm_num_comments')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 14, 13, 14, 74748)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 14, 13, 14, 74615)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'934a8753-784f-4fd0-8081-f97476b77526'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '948', 'null': 'True'}),
        ...
        'debra.posts': {
            ...
            'denorm_num_comments': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 14, 13, 13, 243803)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 14, 13, 13, 243831)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 14, 13, 13, 242352)'}),
