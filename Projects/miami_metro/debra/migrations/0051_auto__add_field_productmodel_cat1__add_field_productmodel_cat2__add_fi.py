...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductModel.cat1'
        db.add_column('debra_productmodel', 'cat1', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductModel.cat1'
        db.delete_column('debra_productmodel', 'cat1')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 12, 17, 50, 12, 488053)'}),
