...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BrandTags'
        db.create_table('debra_brandtags', (
            ...
            ('tag', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('age_group_lower', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('age_group_high', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['BrandTags'])


    def backwards(self, orm):
        
        # Deleting model 'BrandTags'
        db.delete_table('debra_brandtags')
    ...
    models = {
        ...
        'debra.brandtags': {
            'Meta': {'object_name': 'BrandTags'},
            'age_group_high': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'age_group_lower': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['debra.Brands']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'debra.categories': {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 22, 4, 2, 46, 61763)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 22, 4, 2, 46, 61785)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 22, 4, 2, 46, 60786)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 22, 4, 2, 46, 66907)'}),
