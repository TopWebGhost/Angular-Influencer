...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SponsorshipInfo'
        db.create_table('debra_sponsorshipinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'])),
            ('widget_type', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('content', self.gf('django.db.models.fields.CharField')(default=None, max_length=10000, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('total_entries', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('max_entry_value', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('is_running', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['SponsorshipInfo'])


    def backwards(self, orm):
        
        # Deleting model 'SponsorshipInfo'
        db.delete_table('debra_sponsorshipinfo')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 28, 8, 10, 39, 126862)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 28, 8, 10, 39, 126824)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 28, 8, 10, 38, 928836)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 28, 8, 10, 38, 928849)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 28, 8, 10, 38, 928089)'}),
