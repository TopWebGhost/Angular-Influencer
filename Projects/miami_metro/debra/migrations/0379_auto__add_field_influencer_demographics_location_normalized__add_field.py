...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.demographics_location_normalized'
        db.add_column('debra_influencer', 'demographics_location_normalized', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_location_lat'
        db.add_column('debra_influencer', 'demographics_location_lat', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_location_lon'
        db.add_column('debra_influencer', 'demographics_location_lon', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.demographics_location_normalized'
        db.delete_column('debra_influencer', 'demographics_location_normalized')

        # Deleting field 'Influencer.demographics_location_lat'
        db.delete_column('debra_influencer', 'demographics_location_lat')

        # Deleting field 'Influencer.demographics_location_lon'
        db.delete_column('debra_influencer', 'demographics_location_lon')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 21, 12, 2, 16, 925288)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 21, 12, 2, 16, 925252)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'54398c6b-fea4-4fbf-9d98-0f1e3b2d0051'", 'max_length': '64'})
        },
        ...
        'debra.platform': {
            'Meta': {'unique_together': "(('platform_name', 'validated_handle'),)", 'object_name': 'Platform'},
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '18611', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 21, 12, 2, 16, 646368)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 21, 12, 2, 16, 646381)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 21, 12, 2, 16, 644794)'}),
