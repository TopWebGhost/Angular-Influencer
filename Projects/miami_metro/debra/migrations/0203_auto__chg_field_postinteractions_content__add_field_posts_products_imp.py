...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostInteractions.content'
        db.alter_column('debra_postinteractions', 'content', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Adding field 'Posts.products_import_completed'
        db.add_column('debra_posts', 'products_import_completed', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'PostInteractions.content'
        db.alter_column('debra_postinteractions', 'content', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Deleting field 'Posts.products_import_completed'
        db.delete_column('debra_posts', 'products_import_completed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 13, 112949)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 13, 112859)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 12, 604394)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 12, 604417)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 12, 602053)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 21, 49, 12, 609909)'}),
