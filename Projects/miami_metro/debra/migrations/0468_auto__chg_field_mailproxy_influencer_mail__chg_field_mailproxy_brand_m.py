...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailProxy.influencer_mail'
        db.alter_column('debra_mailproxy', 'influencer_mail', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'MailProxy.brand_mail'
        db.alter_column('debra_mailproxy', 'brand_mail', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):

        # Changing field 'MailProxy.influencer_mail'
        db.alter_column('debra_mailproxy', 'influencer_mail', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'MailProxy.brand_mail'
        db.alter_column('debra_mailproxy', 'brand_mail', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 28, 21, 11, 2, 488792)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 28, 21, 11, 2, 488703)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1f679b73-e613-4adf-8a88-f8114e3c8285'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostInteractions']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '3890', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'10.176.196.130'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 28, 21, 11, 1, 393372)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 28, 21, 11, 1, 393404)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 28, 21, 11, 1, 391561)'}),
