...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.num_shelves'
        db.add_column('debra_userprofile', 'num_shelves', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.num_items_in_shelves'
        db.add_column('debra_userprofile', 'num_items_in_shelves', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.default_shelves_created'
        db.add_column('debra_userprofile', 'default_shelves_created', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.num_shelves'
        db.delete_column('debra_userprofile', 'num_shelves')

        # Deleting field 'UserProfile.num_items_in_shelves'
        db.delete_column('debra_userprofile', 'num_items_in_shelves')

        # Deleting field 'UserProfile.default_shelves_created'
        db.delete_column('debra_userprofile', 'default_shelves_created')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 13, 17, 587856)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 13, 17, 587898)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 13, 17, 585770)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 6, 1, 13, 17, 597569)'}),
