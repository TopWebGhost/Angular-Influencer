...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.qa_user_profile'
        db.add_column('debra_influencer', 'qa_user_profile', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='checked_influencers', null=True, blank=True, to=orm['debra.UserProfile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.qa_user_profile'
        db.delete_column('debra_influencer', 'qa_user_profile_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 24, 9, 48, 16, 339470)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 24, 9, 48, 16, 339381)'}),
        ...
        'debra.influencer': {
            ...
            'qa_user_profile': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'checked_influencers'", 'null': 'True', 'blank': 'True', 'to': "orm['debra.UserProfile']"}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'79316e45-3b3d-413d-bbf3-b1304b28090a'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '32418', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 24, 9, 48, 15, 39506)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 24, 9, 48, 15, 39536)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 24, 9, 48, 15, 38356)'}),
