...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerJobMapping.influencer_analytics'
        db.add_column('debra_influencerjobmapping', 'influencer_analytics', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.InfluencerAnalytics'], unique=True, null=True), keep_default=False)

        # Adding field 'InfluencerJobMapping.moved_manually'
        db.add_column('debra_influencerjobmapping', 'moved_manually', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerJobMapping.campaign_stage'
        db.add_column('debra_influencerjobmapping', 'campaign_stage', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Deleting field 'InfluencerAnalytics.contract'
        db.delete_column('debra_influenceranalytics', 'contract_id')


    def backwards(self, orm):
        
        # Deleting field 'InfluencerJobMapping.influencer_analytics'
        db.delete_column('debra_influencerjobmapping', 'influencer_analytics_id')

        # Deleting field 'InfluencerJobMapping.moved_manually'
        db.delete_column('debra_influencerjobmapping', 'moved_manually')

        # Deleting field 'InfluencerJobMapping.campaign_stage'
        db.delete_column('debra_influencerjobmapping', 'campaign_stage')

        # Adding field 'InfluencerAnalytics.contract'
        db.add_column('debra_influenceranalytics', 'contract', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.Contract'], unique=True, null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 31, 8, 2, 11, 8680)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 31, 8, 2, 11, 8599)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'eaa6a71a-9e5c-4902-bf54-bb98e29fdf76'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '18555', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 31, 8, 2, 8, 771388)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 31, 8, 2, 8, 771414)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 31, 8, 2, 8, 770088)'}),
        ...
        'debra.roipredictionreport': {
            ...
            'archived': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'roi_reports'", 'null': 'True', 'to': "orm['debra.BrandJobPost']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
