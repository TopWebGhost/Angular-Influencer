...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductModel.prod_url'
        db.alter_column('debra_productmodel', 'prod_url', self.gf('django.db.models.fields.URLField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'ProductModel.prod_url'
        db.alter_column('debra_productmodel', 'prod_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 21, 23, 42, 58, 519946)'}),
