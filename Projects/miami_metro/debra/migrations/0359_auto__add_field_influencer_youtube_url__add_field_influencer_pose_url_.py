...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.youtube_url'
        db.add_column('debra_influencer', 'youtube_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.pose_url'
        db.add_column('debra_influencer', 'pose_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.lb_url'
        db.add_column('debra_influencer', 'lb_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.youtube_url'
        db.delete_column('debra_influencer', 'youtube_url')

        # Deleting field 'Influencer.pose_url'
        db.delete_column('debra_influencer', 'pose_url')

        # Deleting field 'Influencer.lb_url'
        db.delete_column('debra_influencer', 'lb_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 20, 47, 750238)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 20, 47, 750164)'}),
        ...
        'debra.influenceredithistory': {
            ...
            'curr_value': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            ...
            'prev_value': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13984', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 20, 42, 178735)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 20, 42, 178752)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 20, 42, 177853)'}),
