...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskDailyStats.time_taken_for_tasks'
        db.add_column('debra_taskdailystats', 'time_taken_for_tasks', self.gf('django.db.models.fields.IntegerField')(default='0', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskDailyStats.time_taken_for_tasks'
        db.delete_column('debra_taskdailystats', 'time_taken_for_tasks')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 2, 2, 21, 38, 795209)'}),
