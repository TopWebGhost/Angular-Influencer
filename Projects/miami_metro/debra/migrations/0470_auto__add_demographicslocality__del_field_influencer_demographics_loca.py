...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DemographicsLocality'
        db.create_table('debra_demographicslocality', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['DemographicsLocality'])

        # Deleting field 'Influencer.demographics_location_country'
        db.delete_column('debra_influencer', 'demographics_location_country')

        # Deleting field 'Influencer.demographics_location_state'
        db.delete_column('debra_influencer', 'demographics_location_state')

        # Deleting field 'Influencer.demographics_location_city'
        db.delete_column('debra_influencer', 'demographics_location_city')

        # Adding field 'Influencer.demographics_locality'
        db.add_column('debra_influencer', 'demographics_locality', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='influencers', null=True, to=orm['debra.DemographicsLocality']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'DemographicsLocality'
        db.delete_table('debra_demographicslocality')

        # Adding field 'Influencer.demographics_location_country'
        db.add_column('debra_influencer', 'demographics_location_country', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_location_state'
        db.add_column('debra_influencer', 'demographics_location_state', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.demographics_location_city'
        db.add_column('debra_influencer', 'demographics_location_city', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True), keep_default=False)

        # Deleting field 'Influencer.demographics_locality'
        db.delete_column('debra_influencer', 'demographics_locality_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 13, 42, 14, 583847)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 13, 42, 14, 583778)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'39a72239-9d2b-41bd-8d36-3ae595656f7f'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostInteractions']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '26024', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 30, 13, 42, 13, 343195)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 30, 13, 42, 13, 343229)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 30, 13, 42, 13, 341309)'}),
