...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_contract', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mapping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencerJobMapping'], null=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('starting_price', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('negotiated_price', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('deliverables', self.gf('django.db.models.fields.TextField')(null=True)),
            ('extra_details', self.gf('django.db.models.fields.TextField')(null=True)),
            ('latest_date', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('debra', ['Contract'])


    def backwards(self, orm):
        
        # Deleting model 'Contract'
        db.delete_table('debra_contract')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 41, 31, 196391)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 41, 31, 196313)'}),
        ...
        'debra.contract': {
            ...
            'mapping': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.InfluencerJobMapping']", 'null': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fad0e9d2-dbd0-41a2-a6c7-33610154a05a'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13582', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 41, 30, 264965)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 41, 30, 265017)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 41, 30, 263827)'}),
