...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.shipping_cost'
        db.add_column('debra_wishlistitem', 'shipping_cost', self.gf('django.db.models.fields.FloatField')(default='-1', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WishlistItem.shipping_cost'
        db.delete_column('debra_wishlistitem', 'shipping_cost')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 20, 22, 53, 55, 898017)'}),
