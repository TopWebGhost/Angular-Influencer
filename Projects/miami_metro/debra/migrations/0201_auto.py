...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Platform', fields ['url']
        db.create_index('debra_platform', ['url'])

        # Adding index on 'WishlistItem', fields ['added_datetime']
        db.create_index('debra_wishlistitem', ['added_datetime'])


    def backwards(self, orm):
        
        # Removing index on 'WishlistItem', fields ['added_datetime']
        db.delete_index('debra_wishlistitem', ['added_datetime'])

        # Removing index on 'Platform', fields ['url']
        db.delete_index('debra_platform', ['url'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 267130)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 267088)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 12161)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 12174)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 11454)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 27, 8, 17, 3, 15440)'}),
