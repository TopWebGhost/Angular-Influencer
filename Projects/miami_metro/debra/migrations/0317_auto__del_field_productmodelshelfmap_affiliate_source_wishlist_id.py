...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductModelShelfMap.affiliate_source_wishlist_id'
        db.delete_column('debra_productmodelshelfmap', 'affiliate_source_wishlist_id')


    def backwards(self, orm):
        
        # Adding field 'ProductModelShelfMap.affiliate_source_wishlist_id'
        db.add_column('debra_productmodelshelfmap', 'affiliate_source_wishlist_id', self.gf('django.db.models.fields.IntegerField')(default='-1', max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 10, 3, 322724)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 10, 3, 322650)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 10, 2, 794179)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 10, 2, 794202)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 21, 10, 2, 792980)'}),
