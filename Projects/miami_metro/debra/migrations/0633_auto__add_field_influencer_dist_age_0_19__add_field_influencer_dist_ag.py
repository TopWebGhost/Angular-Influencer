...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.dist_age_0_19'
        db.add_column('debra_influencer', 'dist_age_0_19', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_age_20_24'
        db.add_column('debra_influencer', 'dist_age_20_24', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_age_25_29'
        db.add_column('debra_influencer', 'dist_age_25_29', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_age_30_34'
        db.add_column('debra_influencer', 'dist_age_30_34', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_age_35_39'
        db.add_column('debra_influencer', 'dist_age_35_39', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_age_40'
        db.add_column('debra_influencer', 'dist_age_40', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_gender_female'
        db.add_column('debra_influencer', 'dist_gender_female', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.dist_gender_male'
        db.add_column('debra_influencer', 'dist_gender_male', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.dist_age_0_19'
        db.delete_column('debra_influencer', 'dist_age_0_19')

        # Deleting field 'Influencer.dist_age_20_24'
        db.delete_column('debra_influencer', 'dist_age_20_24')

        # Deleting field 'Influencer.dist_age_25_29'
        db.delete_column('debra_influencer', 'dist_age_25_29')

        # Deleting field 'Influencer.dist_age_30_34'
        db.delete_column('debra_influencer', 'dist_age_30_34')

        # Deleting field 'Influencer.dist_age_35_39'
        db.delete_column('debra_influencer', 'dist_age_35_39')

        # Deleting field 'Influencer.dist_age_40'
        db.delete_column('debra_influencer', 'dist_age_40')

        # Deleting field 'Influencer.dist_gender_female'
        db.delete_column('debra_influencer', 'dist_gender_female')

        # Deleting field 'Influencer.dist_gender_male'
        db.delete_column('debra_influencer', 'dist_gender_male')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 14, 11, 31, 57, 999837)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 14, 11, 31, 57, 999758)'}),
        ...
        'debra.brandjobpost': {
            ...
            'periodic_tracking': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'17dfff44-b0cd-4a3b-b387-81fc59487e86'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '1570', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'192.168.1.105'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 14, 11, 31, 56, 984717)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 14, 11, 31, 56, 984740)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 4, 14, 11, 31, 56, 983515)'}),
