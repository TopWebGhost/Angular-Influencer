...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductModel.c_idx'
        db.alter_column('debra_productmodel', 'c_idx', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'ProductModel.c_idx'
        db.alter_column('debra_productmodel', 'c_idx', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 19, 19, 32, 44, 652652)'}),
