...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PromoDashboardUnit'
        db.create_table('debra_promodashboardunit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('promo_info', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Promoinfo'], null=True, blank=True)),
            ('promo_raw', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.PromoRawText'], null=True, blank=True)),
            ('promo_updated_text', self.gf('django.db.models.fields.TextField')()),
            ...
            ('create_time', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 10, 16, 15, 10, 32, 447383))),
            ('updated_time', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 10, 16, 15, 10, 32, 447426))),
        ))
        db.send_create_signal('debra', ['PromoDashboardUnit'])

        # Adding field 'PromoRawText.initial_type'
        db.add_column('debra_promorawtext', 'initial_type', self.gf('django.db.models.fields.CharField')(default='storewide', max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'PromoRawText.processed'
        db.add_column('debra_promorawtext', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PromoDashboardUnit'
        db.delete_table('debra_promodashboardunit')

        # Deleting field 'PromoRawText.initial_type'
        db.delete_column('debra_promorawtext', 'initial_type')

        # Deleting field 'PromoRawText.processed'
        db.delete_column('debra_promorawtext', 'processed')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 10, 32, 447383)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 10, 32, 447426)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 10, 32, 445619)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 15, 10, 32, 457224)'}),
