...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('debra_postcontent')

        # Deleting model 'FollowerTimeSeries'
        db.delete_table('debra_followertimeseries')

        # Adding model 'PopularityTimeSeries'
        db.create_table('debra_popularitytimeseries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'])),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Platform'])),
            ('snapshot_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('num_followers', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1000, null=True, blank=True)),
            ('num_following', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['PopularityTimeSeries'])

        # Adding model 'Platform'
        db.create_table('debra_platform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='Platform name', max_length=1000, null=True, blank=True)),
            ...
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True)),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['Platform'])

        # Deleting field 'Influencer.usingblogger'
        db.delete_column('debra_influencer', 'usingblogger')

        # Deleting field 'Influencer.fbpage_about'
        db.delete_column('debra_influencer', 'fbpage_about')

        # Deleting field 'Influencer.fbpage_numtalkingabout'
        db.delete_column('debra_influencer', 'fbpage_numtalkingabout')

        # Deleting field 'Influencer.instagram_url'
        db.delete_column('debra_influencer', 'instagram_url')

        # Deleting field 'Influencer.pinterest_url'
        db.delete_column('debra_influencer', 'pinterest_url')

        # Deleting field 'Influencer.fb_url'
        db.delete_column('debra_influencer', 'fb_url')

        # Deleting field 'Influencer.create_date'
        db.delete_column('debra_influencer', 'create_date')

        # Deleting field 'Influencer.usingtumblr'
        db.delete_column('debra_influencer', 'usingtumblr')

        # Deleting field 'Influencer.fbpage_description'
        db.delete_column('debra_influencer', 'fbpage_description')

        # Deleting field 'Influencer.tumblr_url'
        db.delete_column('debra_influencer', 'tumblr_url')

        # Deleting field 'Influencer.usingtypepad'
        db.delete_column('debra_influencer', 'usingtypepad')

        # Deleting field 'Influencer.usingwordpress'
        db.delete_column('debra_influencer', 'usingwordpress')

        # Deleting field 'Influencer.twitter_url'
        db.delete_column('debra_influencer', 'twitter_url')

        # Deleting field 'Influencer.fbpage_numlikes'
        db.delete_column('debra_influencer', 'fbpage_numlikes')

        # Deleting field 'Influencer.blog_name'
        db.delete_column('debra_influencer', 'blog_name')

        # Deleting field 'Influencer.usingblogspot'
        db.delete_column('debra_influencer', 'usingblogspot')

        # Deleting field 'Influencer.blog_url'
        db.delete_column('debra_influencer', 'blog_url')

        # Adding field 'Posts.location'
        db.add_column('debra_posts', 'location', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Posts.content_numpics'
        db.add_column('debra_posts', 'content_numpics', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.content_numvideos'
        db.add_column('debra_posts', 'content_numvideos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Posts.engagement_media_numshares'
        db.add_column('debra_posts', 'engagement_media_numshares', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'PostContent'
        db.create_table('debra_postcontent', (
            ('content_numpics', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('content_numvideos', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('debra', ['PostContent'])

        # Adding model 'FollowerTimeSeries'
        db.create_table('debra_followertimeseries', (
            ('count', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=1000, null=True, blank=True)),
            ('snapshot_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('platform_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Follower'])),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('debra', ['FollowerTimeSeries'])

        # Deleting model 'PopularityTimeSeries'
        db.delete_table('debra_popularitytimeseries')

        # Deleting model 'Platform'
        db.delete_table('debra_platform')

        # Adding field 'Influencer.usingblogger'
        db.add_column('debra_influencer', 'usingblogger', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.fbpage_about'
        db.add_column('debra_influencer', 'fbpage_about', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.fbpage_numtalkingabout'
        db.add_column('debra_influencer', 'fbpage_numtalkingabout', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.instagram_url'
        db.add_column('debra_influencer', 'instagram_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.pinterest_url'
        db.add_column('debra_influencer', 'pinterest_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.fb_url'
        db.add_column('debra_influencer', 'fb_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.create_date'
        db.add_column('debra_influencer', 'create_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.usingtumblr'
        db.add_column('debra_influencer', 'usingtumblr', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.fbpage_description'
        db.add_column('debra_influencer', 'fbpage_description', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.tumblr_url'
        db.add_column('debra_influencer', 'tumblr_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.usingtypepad'
        db.add_column('debra_influencer', 'usingtypepad', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.usingwordpress'
        db.add_column('debra_influencer', 'usingwordpress', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.twitter_url'
        db.add_column('debra_influencer', 'twitter_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.fbpage_numlikes'
        db.add_column('debra_influencer', 'fbpage_numlikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.blog_name'
        db.add_column('debra_influencer', 'blog_name', self.gf('django.db.models.fields.CharField')(default='Blog name', max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.usingblogspot'
        db.add_column('debra_influencer', 'usingblogspot', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.blog_url'
        db.add_column('debra_influencer', 'blog_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'Posts.location'
        db.delete_column('debra_posts', 'location')
        ...
        # Deleting field 'Posts.engagement_media_numshares'
        db.delete_column('debra_posts', 'engagement_media_numshares')
    ...
    models = {
        ...
        'debra.follower': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_blogger': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'debra.influencer': {
            ...
            'bloglovin_followers': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'bloglovin_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'demographics_bloggerage': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'email': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'followers_overalldemographics_averageage': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'followers_overalldemographics_percentbloggers': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'followers_overalldemographics_percentmale': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'monetization_numadunits': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'monetization_percentsponsored': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'monetization_revenueestimate': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Blogger name'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'ranking_bloggingrate': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ranking_overallengagement_absolutescore': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ranking_overallengagement_mediascore': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ranking_overallengagement_recurringscore': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ranking_overallseoscore': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ranking_referencescore': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'shelf_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.items': {
        ...
        'debra.platform': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Platform name'", 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'})
        },
        'debra.popularitytimeseries': {
            ...
            'snapshot_date': ('django.db.models.fields.DateTimeField', [], {})
        },
        'debra.postinteractions': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'if_liked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'if_shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'debra.posts': {
            ...
            'content_numpics': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'content_numvideos': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'engagement_media_numcomments': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'engagement_media_numfbshares': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'engagement_media_numlikes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'engagement_media_numrepins': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'engagement_media_numretweets': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'engagement_media_numshares': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']"}),
            'is_sponsored': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'location': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'num_prizes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'platform_name': ('django.db.models.fields.CharField', [], {'default': "'Platform name'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'prize_money': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'product_urls': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'seo_loadtime': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 4, 33, 300012)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 4, 33, 300032)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 4, 33, 299233)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 4, 33, 304774)'}),
