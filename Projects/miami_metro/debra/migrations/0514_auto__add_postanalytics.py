...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostAnalytics'
        db.create_table('debra_postanalytics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'], unique=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('count_fb_shares', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_fb_likes', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_fb_comments', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_tweets', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_pins', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_stumbleupons', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_gplus_plusone', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_linkedin_shares', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_impressions', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('count_clickthroughs', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('inner_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
        ))
        db.send_create_signal('debra', ['PostAnalytics'])


    def backwards(self, orm):
        
        # Deleting model 'PostAnalytics'
        db.delete_table('debra_postanalytics')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 13, 44, 33, 519224)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 13, 44, 33, 519143)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e282263d-f0aa-4d4b-8638-db9dbeb69bfe'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '6931', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.postanalytics': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'unique': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 5, 13, 44, 32, 361879)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 5, 13, 44, 32, 361914)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 5, 13, 44, 32, 359959)'}),
