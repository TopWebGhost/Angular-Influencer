...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'MentionInPost', fields ['platform_name']
        db.delete_index('debra_mentioninpost', ['platform_name'])

        # Removing index on 'MentionInPost', fields ['influencer']
        db.delete_index('debra_mentioninpost', ['influencer_id'])


    def backwards(self, orm):
        
        # Adding index on 'MentionInPost', fields ['influencer']
        db.create_index('debra_mentioninpost', ['influencer_id'])

        # Adding index on 'MentionInPost', fields ['platform_name']
        db.create_index('debra_mentioninpost', ['platform_name'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 5, 56, 42, 147997)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 5, 56, 42, 147817)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ed7b1621-cd08-479c-9613-78e7b943793c'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '3028', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 30, 5, 56, 40, 522849)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 30, 5, 56, 40, 522879)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 30, 5, 56, 40, 521312)'}),
