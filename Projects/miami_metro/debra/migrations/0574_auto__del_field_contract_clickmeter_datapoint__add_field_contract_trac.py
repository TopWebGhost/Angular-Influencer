...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contract.clickmeter_datapoint'
        db.delete_column('debra_contract', 'clickmeter_datapoint')

        # Adding field 'Contract.tracking_link'
        db.add_column('debra_contract', 'tracking_link', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'Contract.tracking_pixel'
        db.add_column('debra_contract', 'tracking_pixel', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Contract.clickmeter_datapoint'
        db.add_column('debra_contract', 'clickmeter_datapoint', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Deleting field 'Contract.tracking_link'
        db.delete_column('debra_contract', 'tracking_link')

        # Deleting field 'Contract.tracking_pixel'
        db.delete_column('debra_contract', 'tracking_pixel')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 11, 14, 29, 24, 270768)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 11, 14, 29, 24, 270681)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f9d949bf-e937-43c8-947f-f554642e4283'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '11514', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 11, 14, 29, 23, 373015)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 11, 14, 29, 23, 373048)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 11, 14, 29, 23, 371249)'}),
