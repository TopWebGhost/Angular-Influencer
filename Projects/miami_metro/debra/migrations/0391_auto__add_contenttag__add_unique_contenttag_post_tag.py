...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_contenttag', (
        ...
        db.send_create_signal('debra', ['ContentTag'])

        # Adding unique constraint on 'ContentTag', fields ['post', 'tag']
        db.create_unique('debra_contenttag', ['post_id', 'tag'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContentTag', fields ['post', 'tag']
        db.delete_unique('debra_contenttag', ['post_id', 'tag'])

        # Deleting model 'ContentTag'
        db.delete_table('debra_contenttag')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 7, 7, 28, 50, 270361)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 7, 7, 28, 50, 270325)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'22fdb1d6-229f-490d-8632-ca1fbc7f1747'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '9843', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 7, 28, 49, 996378)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 7, 28, 49, 996390)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 7, 28, 49, 995710)'}),
