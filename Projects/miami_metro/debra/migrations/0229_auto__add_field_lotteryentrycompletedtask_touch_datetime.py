...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LotteryEntryCompletedTask.touch_datetime'
        db.add_column('debra_lotteryentrycompletedtask', 'touch_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 13, 16, 12, 32, 890678)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LotteryEntryCompletedTask.touch_datetime'
        db.delete_column('debra_lotteryentrycompletedtask', 'touch_datetime')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 33, 357287)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 33, 357220)'}),
        ...
        'debra.lotteryentrycompletedtask': {
            ...
            'touch_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 32, 890678)'})
        },
        'debra.lotteryprize': {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 32, 849163)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 32, 849186)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 32, 847998)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 13, 16, 12, 32, 854917)'}),
