...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductModel.num_fb_likes'
        db.add_column('debra_productmodel', 'num_fb_likes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ProductModel.num_twitter_mentions'
        db.add_column('debra_productmodel', 'num_twitter_mentions', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ProductModel.num_pins'
        db.add_column('debra_productmodel', 'num_pins', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductModel.num_fb_likes'
        db.delete_column('debra_productmodel', 'num_fb_likes')

        # Deleting field 'ProductModel.num_twitter_mentions'
        db.delete_column('debra_productmodel', 'num_twitter_mentions')

        # Deleting field 'ProductModel.num_pins'
        db.delete_column('debra_productmodel', 'num_pins')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 9, 1, 48, 18, 239600)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 9, 1, 48, 18, 239642)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 9, 1, 48, 18, 237862)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 9, 1, 48, 18, 249194)'}),
