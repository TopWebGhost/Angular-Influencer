...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Influencer.insta_url'
        db.alter_column('debra_influencer', 'insta_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Influencer.tw_url'
        db.alter_column('debra_influencer', 'tw_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Influencer.pin_url'
        db.alter_column('debra_influencer', 'pin_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Influencer.fb_url'
        db.alter_column('debra_influencer', 'fb_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Influencer.insta_url'
        db.alter_column('debra_influencer', 'insta_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Influencer.tw_url'
        db.alter_column('debra_influencer', 'tw_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Influencer.pin_url'
        db.alter_column('debra_influencer', 'pin_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Influencer.fb_url'
        db.alter_column('debra_influencer', 'fb_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 8, 9, 11, 58, 807994)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 8, 9, 11, 58, 807900)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '28936', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 8, 9, 11, 57, 925525)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 8, 9, 11, 57, 925561)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 8, 9, 11, 57, 924261)'}),
