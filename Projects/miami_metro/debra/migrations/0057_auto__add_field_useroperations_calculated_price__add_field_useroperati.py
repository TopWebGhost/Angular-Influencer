...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserOperations.calculated_price'
        db.add_column('debra_useroperations', 'calculated_price', self.gf('django.db.models.fields.FloatField')(default='-11.0', max_length=10), keep_default=False)

        # Adding field 'UserOperations.item_out_of_stock'
        db.add_column('debra_useroperations', 'item_out_of_stock', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserOperations.how_many_out_of_stock'
        db.add_column('debra_useroperations', 'how_many_out_of_stock', self.gf('django.db.models.fields.IntegerField')(default='0'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserOperations.calculated_price'
        db.delete_column('debra_useroperations', 'calculated_price')

        # Deleting field 'UserOperations.item_out_of_stock'
        db.delete_column('debra_useroperations', 'item_out_of_stock')

        # Deleting field 'UserOperations.how_many_out_of_stock'
        db.delete_column('debra_useroperations', 'how_many_out_of_stock')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 6, 23, 45, 6, 923645)'}),
