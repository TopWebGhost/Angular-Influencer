...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerBrandMapping.name'
        db.add_column('debra_influencerbrandmapping', 'name', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.blogname'
        db.add_column('debra_influencerbrandmapping', 'blogname', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.blog_url'
        db.add_column('debra_influencerbrandmapping', 'blog_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.insta_url'
        db.add_column('debra_influencerbrandmapping', 'insta_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.youtube_url'
        db.add_column('debra_influencerbrandmapping', 'youtube_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.snapchat_username'
        db.add_column('debra_influencerbrandmapping', 'snapchat_username', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.tw_url'
        db.add_column('debra_influencerbrandmapping', 'tw_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.fb_url'
        db.add_column('debra_influencerbrandmapping', 'fb_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.pin_url'
        db.add_column('debra_influencerbrandmapping', 'pin_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerBrandMapping.email'
        db.add_column('debra_influencerbrandmapping', 'email', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfluencerBrandMapping.name'
        db.delete_column('debra_influencerbrandmapping', 'name')

        # Deleting field 'InfluencerBrandMapping.blogname'
        db.delete_column('debra_influencerbrandmapping', 'blogname')

        # Deleting field 'InfluencerBrandMapping.blog_url'
        db.delete_column('debra_influencerbrandmapping', 'blog_url')

        # Deleting field 'InfluencerBrandMapping.insta_url'
        db.delete_column('debra_influencerbrandmapping', 'insta_url')

        # Deleting field 'InfluencerBrandMapping.youtube_url'
        db.delete_column('debra_influencerbrandmapping', 'youtube_url')

        # Deleting field 'InfluencerBrandMapping.snapchat_username'
        db.delete_column('debra_influencerbrandmapping', 'snapchat_username')

        # Deleting field 'InfluencerBrandMapping.tw_url'
        db.delete_column('debra_influencerbrandmapping', 'tw_url')

        # Deleting field 'InfluencerBrandMapping.fb_url'
        db.delete_column('debra_influencerbrandmapping', 'fb_url')

        # Deleting field 'InfluencerBrandMapping.pin_url'
        db.delete_column('debra_influencerbrandmapping', 'pin_url')

        # Deleting field 'InfluencerBrandMapping.email'
        db.delete_column('debra_influencerbrandmapping', 'email')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 6, 42, 486189)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 6, 42, 486109)'}),
        ...
        'debra.brandjobpost': {
            ...
            'attachment_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'bloggers_post_collection': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'bloggers_campaign'", 'unique': 'True', 'null': 'True', 'to': "orm['debra.PostAnalyticsCollection']"}),
            'client_name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'client_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            ...
            'creator_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_posts_created'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'hashtags_required': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'mentions_required': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            ...
            'outreach_template': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'periodic_tracking': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'post_collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostAnalyticsCollection']", 'null': 'True'}),
            'posts_added_info': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'posts_saved_search': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.SearchQueryArchive']", 'null': 'True'}),
            'product_urls': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'profile_img_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ROIPredictionReport']", 'null': 'True'}),
            'tags': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'tracking_group': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'utm_campaign': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'utm_medium': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'utm_source': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
        ...
        'debra.brandtaxonomy': {
            'Meta': {'object_name': 'BrandTaxonomy'},
            'blog_posts_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'brand_name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'hashtags': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencers_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'instagrams_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'keywords': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'mention_urls': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'mentions': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'posts_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'price_tag': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'product_tag': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'repr_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'style_tag': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'})
        },
        'debra.category': {
            'Meta': {'object_name': 'Category'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('djorm_pgarray.fields.TextArrayField', [], {'default': 'None', u'dbtype': "u'text'"}),
            'match_threshold': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {})
        },
        'debra.cloudfrontdistribution': {
            'Meta': {'object_name': 'CloudFrontDistribution'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'value': ('django.db.models.fields.URLField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'})
        },
        'debra.color': {
        ...
        'debra.contract': {
            ...
            'blogger_address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000', 'null': 'True'}),
            'campaign_product_tracking_links': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'campaign_stage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'date_requirements': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'deliverables': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'details_collected_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'envelope': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'extra_details': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'followup_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'google_doc_id': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'google_doc_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer_notes': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'latest_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'moved_manually': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'negotiated_price': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'payment_complete': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'paypal_info_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'posts_adding_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'product_tracking_links': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'product_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'product_urls': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'review': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'ship_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'shipment_received_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'shipment_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'shipment_tracking_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000', 'null': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'starting_price': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
            'suggested_price': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'tracking_brand_link': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'tracking_link': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'tracking_pixel': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'tracking_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
        ...
        'debra.engagementtimeseries': {
            'Meta': {'object_name': 'EngagementTimeSeries'},
            'avg_comments': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'avg_likes': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'avg_shares': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'comments_data': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'date_range_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'date_range_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True'}),
            'likes_data': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']", 'null': 'True'}),
            'shares_data': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        'debra.feedcheck': {
            'Meta': {'object_name': 'FeedCheck'},
            ...
            'full_posts': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invalid_feed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'link_to_post': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'no_entries': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']"}),
            'summaries': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'summary_details': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        'debra.influenceranalytics': {
            'Meta': {'object_name': 'InfluencerAnalytics'},
            'approve_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'archived': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'client_notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True'}),
            'influencer_analytics_collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.InfluencerAnalyticsCollection']", 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'tmp_approve_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
        'debra.influenceranalyticscollection': {
            'Meta': {'object_name': 'InfluencerAnalyticsCollection'},
            'approval_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.InfluencersGroup']", 'null': 'True'})
        },
        'debra.influencerbrandmapping': {
            'Meta': {'unique_together': "(('influencer', 'brand'),)", 'object_name': 'InfluencerBrandMapping'},
            'age': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'blog_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'blogname': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Brands']", 'null': 'True', 'blank': 'True'}),
            'categories': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'cell_phone': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'ethnicity': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'fb_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True', 'blank': 'True'}),
            'insta_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'mailing_address': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'occupation': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'pin_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'rep_email_address': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'rep_phone': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'representation': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'sex': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'snapchat_username': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'tags': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'tw_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'youtube_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'zip_code': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'})
        },
        'debra.influencerbrandusermapping': {
            'Meta': {'unique_together': "(('influencer', 'brand', 'user'),)", 'object_name': 'InfluencerBrandUserMapping'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'influencer_mappings'", 'null': 'True', 'to': "orm['debra.Brands']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'brand_mappings'", 'null': 'True', 'to': "orm['debra.Influencer']"}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'influencer_mappings'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'debra.influencercheck': {
            'Meta': {'object_name': 'InfluencerCheck'},
            ...
            'filename_function': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']", 'null': 'True'}),
            'qa': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'debra.influencercustomercomment': {
            'Meta': {'object_name': 'InfluencerCustomerComment'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'influencer_customer_comments'", 'null': 'True', 'to': "orm['debra.Brands']"}),
            'comment': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'influencer_customer_comments'", 'null': 'True', 'to': "orm['debra.Influencer']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'influencer_customer_comments'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'debra.influencergroupmapping': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'influencers_mapping'", 'null': 'True', 'to': "orm['debra.InfluencersGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'debra.influencerjobmapping': {
            ...
            'archived': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'campaign_stage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'campaign_stage_prev': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'contract': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['debra.Contract']", 'unique': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer_analytics': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['debra.InfluencerAnalytics']", 'unique': 'True', 'null': 'True'}),
            ...
            'mapping': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'jobs'", 'null': 'True', 'to': "orm['debra.InfluencerGroupMapping']"}),
            'moved_manually': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'debra.influencersgroup': {
            ...
            'creator_userprofile': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_collections'", 'null': 'True', 'to': "orm['debra.UserProfile']"}),
            ...
            'system_collection': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'top_influencers': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'}),
            'top_influencers_profile_pics': ('djorm_pgarray.fields.TextArrayField', [], {'default': '[]', u'dbtype': "u'text'", 'blank': 'True'})
        },
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7fe88713-0fa5-4fb7-8133-07ed476a1cb5'", 'max_length': '64'})
        },
        ...
        'debra.mailproxy': {
            ...
            'brand_mail': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'campaign_stage': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
            'has_been_read_by_brand': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mails'", 'null': 'True', 'to': "orm['debra.Influencer']"}),
            'influencer_mail': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'info': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'initiator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mails'", 'null': 'True', 'to': "orm['auth.User']"}),
            'stage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
        ...
        'debra.mandrillbatch': {
            'Meta': {'object_name': 'MandrillBatch'},
            'data': ('django_pgjson.fields.JsonField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        'debra.mandrillevent': {
            'Meta': {'object_name': 'MandrillEvent'},
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.MandrillBatch']", 'null': 'True'}),
            'data': ('django_pgjson.fields.JsonField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
        ...
        'debra.mentioninpost': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True', 'db_index': 'False'}),
            'influencer_imported': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
        ...
        'debra.opdict': {
            'Meta': {'object_name': 'OpDict'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'operation': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1024'})
        },
        ...
        'debra.pdolatest': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']", 'null': 'True'}),
            'latest_started': ('django.db.models.fields.DateTimeField', [], {}),
            'operation_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']", 'null': 'True'}),
        ...
        'debra.platformdataop': {
            ...
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Brands']", 'null': 'True'}),
            'data_json': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'error_msg': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '5884', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'127.0.1.1'", 'max_length': '128'}),
        ...
        'debra.postanalytics': {
            'Meta': {'object_name': 'PostAnalytics'},
            'approve_status': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
            'brands': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['debra.Brands']", 'symmetrical': 'False'}),
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostAnalyticsCollection']", 'null': 'True'}),
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Contract']", 'null': 'True'}),
            'count_clickthroughs': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_fb_comments': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_fb_likes': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_fb_shares': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_gplus_plusone': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_impressions': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_linkedin_shares': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_pins': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_stumbleupons': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_tweets': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_unique_clickthroughs': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'count_unique_impressions': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'inner_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_comments': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'post_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'post_found': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'post_title': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'post_type': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'post_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'tracking_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'})
        },
        'debra.postanalyticscollection': {
            'Meta': {'object_name': 'PostAnalyticsCollection'},
            'archived': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator_brand': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_post_analytics_collections'", 'null': 'True', 'to': "orm['debra.Brands']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_updating': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'items_number': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'last_report_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'system_collection': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'post_analytics_collections'", 'null': 'True', 'to': "orm['debra.InfluencersGroup']"}),
            'top_post_images': ('djorm_pgarray.fields.TextArrayField', [], {'default': "'{}'", u'dbtype': "u'text'", 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'post_analytics_collections'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"})
        },
        'debra.postanalyticscollectiontimeseries': {
            'Meta': {'object_name': 'PostAnalyticsCollectionTimeSeries'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'time_series'", 'null': 'True', 'to': "orm['debra.PostAnalyticsCollection']"}),
            'count_clicks': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count_unique_clicks': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count_unique_views': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count_views': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'snapshot_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        'debra.postcategory': {
            'Meta': {'object_name': 'PostCategory'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Category']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match_data': ('django_pgjson.fields.JsonField', [], {}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']"})
        },
        'debra.postinteractions': {
            ...
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']", 'null': 'True', 'blank': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']"})
        },
        'debra.postlengthcheck': {
            'Meta': {'object_name': 'PostLengthCheck'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']"}),
            'max_post_length': ('django.db.models.fields.IntegerField', [], {}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']"})
        },
        'debra.posts': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'categories+'", 'symmetrical': 'False', 'through': "orm['debra.PostCategory']", 'to': "orm['debra.Category']"}),
            'categorization_complete': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'fetch_manually_completed': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impressions': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']"}),
            ...
            'post_image': ('django.db.models.fields.URLField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'post_image_height': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'post_image_width': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'show_on_search': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.productmodel': {
            ...
            'insert_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 6, 41, 403414)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 6, 41, 403446)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 8, 19, 17, 6, 41, 401735)'}),
        ...
        'debra.roipredictionreport': {
            'Meta': {'object_name': 'ROIPredictionReport'},
            'archived': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator_brand': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_roi_prediction_reports'", 'null': 'True', 'to': "orm['debra.Brands']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer_analytics_collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.InfluencerAnalyticsCollection']", 'null': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'main_campaign': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'roi_reports'", 'null': 'True', 'to': "orm['debra.BrandJobPost']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'post_collection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'prediction_reports'", 'null': 'True', 'to': "orm['debra.PostAnalyticsCollection']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'roi_prediction_reports'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"})
        },
        'debra.searchqueryarchive': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'saved_queries'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'debra.shelf': {
        ...
        'debra.similarwebtrafficshares': {
            'Meta': {'unique_together': "(['influencer', 'source_type'],)", 'object_name': 'SimilarWebTrafficShares'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'influencer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Influencer']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'debra.similarwebvisits': {
            'Meta': {'unique_together': "(['influencer', 'granularity', 'begins'],)", 'object_name': 'SimilarWebVisits'},
        ...
        'debra.similarwebvisitsreport': {
            'Meta': {'unique_together': "(['influencer', 'granularity', 'start', 'end'],)", 'object_name': 'SimilarWebVisitsReport'},
            'api_calls_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'calls_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'debra.siteconfiguration': {
            'Meta': {'object_name': 'SiteConfiguration'},
            'blogger_custom_data': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'docusign_documents': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stripe_plans': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        'debra.sponsorshipinfo': {
            'Meta': {'object_name': 'SponsorshipInfo'},
            'added_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'base_xpath': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10000', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']"}),
            'sidebar': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'widget_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.testmodel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'tags': ('djorm_pgarray.fields.TextArrayField', [], {'default': 'None', u'dbtype': "u'text'", 'blank': 'True'})
        },
        'debra.testmodel2': {
            'Meta': {'object_name': 'TestModel2'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'test_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.TestModel']", 'null': 'True'})
        },
        'debra.userfollowmap': {
