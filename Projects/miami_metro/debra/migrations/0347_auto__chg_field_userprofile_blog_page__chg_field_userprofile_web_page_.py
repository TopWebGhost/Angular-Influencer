...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.blog_page'
        db.alter_column('debra_userprofile', 'blog_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.web_page'
        db.alter_column('debra_userprofile', 'web_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.instagram_page'
        db.alter_column('debra_userprofile', 'instagram_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.facebook_page'
        db.alter_column('debra_userprofile', 'facebook_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.pinterest_page'
        db.alter_column('debra_userprofile', 'pinterest_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.youtube_page'
        db.alter_column('debra_userprofile', 'youtube_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.bloglovin_page'
        db.alter_column('debra_userprofile', 'bloglovin_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.etsy_page'
        db.alter_column('debra_userprofile', 'etsy_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.twitter_page'
        db.alter_column('debra_userprofile', 'twitter_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'UserProfile.store_page'
        db.alter_column('debra_userprofile', 'store_page', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.blog_page'
        db.alter_column('debra_userprofile', 'blog_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.web_page'
        db.alter_column('debra_userprofile', 'web_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.instagram_page'
        db.alter_column('debra_userprofile', 'instagram_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.facebook_page'
        db.alter_column('debra_userprofile', 'facebook_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.pinterest_page'
        db.alter_column('debra_userprofile', 'pinterest_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.youtube_page'
        db.alter_column('debra_userprofile', 'youtube_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.bloglovin_page'
        db.alter_column('debra_userprofile', 'bloglovin_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.etsy_page'
        db.alter_column('debra_userprofile', 'etsy_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.twitter_page'
        db.alter_column('debra_userprofile', 'twitter_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.store_page'
        db.alter_column('debra_userprofile', 'store_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 6, 29, 33, 39197)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 6, 29, 33, 39157)'}),
        ...
        'debra.influencer': {
            ...
            'posts_count': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '17092', 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'127.0.0.1'", 'max_length': '128'}),
        ...
        'debra.posts': {
            ...
            'eligible_images_count': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 27, 6, 29, 32, 811375)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 27, 6, 29, 32, 811387)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 27, 6, 29, 32, 810739)'}),
