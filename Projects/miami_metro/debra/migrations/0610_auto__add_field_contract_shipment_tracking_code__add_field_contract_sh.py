...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.shipment_tracking_code'
        db.add_column('debra_contract', 'shipment_tracking_code', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True), keep_default=False)

        # Adding field 'Contract.ship_date'
        db.add_column('debra_contract', 'ship_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Contract.shipment_status'
        db.add_column('debra_contract', 'shipment_status', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contract.shipment_tracking_code'
        db.delete_column('debra_contract', 'shipment_tracking_code')

        # Deleting field 'Contract.ship_date'
        db.delete_column('debra_contract', 'ship_date')

        # Deleting field 'Contract.shipment_status'
        db.delete_column('debra_contract', 'shipment_status')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 16, 11, 53, 1, 712240)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 16, 11, 53, 1, 712161)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e2b543bb-54a2-4042-b1e5-417c514cc6cf'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '6332', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 16, 11, 53, 0, 701317)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 16, 11, 53, 0, 701360)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 16, 11, 53, 0, 699029)'}),
