...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductModelShelfMap.user_id'
        db.delete_column('debra_productmodelshelfmap', 'user_id_id')

        # Adding field 'ProductModelShelfMap.user_prof'
        db.add_column('debra_productmodelshelfmap', 'user_prof', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.UserProfile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProductModelShelfMap.user_id'
        db.add_column('debra_productmodelshelfmap', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Deleting field 'ProductModelShelfMap.user_prof'
        db.delete_column('debra_productmodelshelfmap', 'user_prof_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 19, 38, 17, 834238)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 19, 38, 17, 834151)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 19, 38, 17, 473745)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 19, 38, 17, 473766)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 16, 19, 38, 17, 472471)'}),
