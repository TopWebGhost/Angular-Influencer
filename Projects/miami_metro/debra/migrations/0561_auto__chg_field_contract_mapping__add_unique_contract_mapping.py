...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.mapping'
        db.alter_column('debra_contract', 'mapping_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.InfluencerJobMapping'], unique=True, null=True))

        # Adding unique constraint on 'Contract', fields ['mapping']
        db.create_unique('debra_contract', ['mapping_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Contract', fields ['mapping']
        db.delete_unique('debra_contract', ['mapping_id'])

        # Changing field 'Contract.mapping'
        db.alter_column('debra_contract', 'mapping_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencerJobMapping'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 43, 38, 553293)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 43, 38, 553211)'}),
        ...
        'debra.contract': {
            ...
            'mapping': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['debra.InfluencerJobMapping']", 'unique': 'True', 'null': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'611f4baf-1802-407b-bebd-b858685e1527'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13724', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 43, 37, 728036)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 43, 37, 728057)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 2, 14, 43, 37, 726906)'}),
