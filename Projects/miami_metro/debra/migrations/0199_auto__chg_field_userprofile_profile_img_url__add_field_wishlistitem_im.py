...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.profile_img_url'
        db.alter_column('debra_userprofile', 'profile_img_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Adding field 'WishlistItem.imported_from_blog'
        db.add_column('debra_wishlistitem', 'imported_from_blog', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'UserProfile.profile_img_url'
        db.alter_column('debra_userprofile', 'profile_img_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Deleting field 'WishlistItem.imported_from_blog'
        db.delete_column('debra_wishlistitem', 'imported_from_blog')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 5, 610031)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 5, 609936)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 4, 990274)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 4, 990305)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 4, 989079)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 1, 22, 4, 997113)'}),
