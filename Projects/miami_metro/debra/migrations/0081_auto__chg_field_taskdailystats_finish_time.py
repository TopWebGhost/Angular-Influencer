...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskDailyStats.finish_time'
        db.alter_column('debra_taskdailystats', 'finish_time', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'TaskDailyStats.finish_time'
        db.alter_column('debra_taskdailystats', 'finish_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 22, 18, 50, 55, 377754)'}),
