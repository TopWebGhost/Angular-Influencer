...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HealthReport'
        db.create_table('debra_healthreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog_urls', self.gf('django.db.models.fields.IntegerField')()),
            ('urls_analyzed', self.gf('django.db.models.fields.IntegerField')()),
            ('live', self.gf('django.db.models.fields.IntegerField')()),
            ('fashion', self.gf('django.db.models.fields.IntegerField')()),
            ('active', self.gf('django.db.models.fields.IntegerField')()),
            ('with_social', self.gf('django.db.models.fields.IntegerField')()),
            ('with_comments', self.gf('django.db.models.fields.IntegerField')()),
            ('with_items', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('debra', ['HealthReport'])


    def backwards(self, orm):
        # Deleting model 'HealthReport'
        db.delete_table('debra_healthreport')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 13, 17, 15, 74754)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 13, 17, 15, 74680)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '20886', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 13, 17, 14, 691848)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 13, 17, 14, 691867)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 13, 17, 14, 690896)'}),
