...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_emailfromteaserpage', (
            ...
            ('time_registered', self.gf('django.db.models.fields.DateTimeField')()),
    ...
    models = {
        ...
        'debra.emailfromteaserpage': {
            ...
            'time_registered': ('django.db.models.fields.DateTimeField', [], {})
        },
        'debra.items': {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 27, 15, 41, 22, 692215)'}),
