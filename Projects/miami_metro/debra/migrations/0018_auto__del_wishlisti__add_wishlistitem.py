...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_wishlistitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserIdMap'])),
            ('base_item', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['debra.UserOperations'], null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['WishlistItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('debra_wishlistitem')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 11, 21, 34, 33, 972398)'}),
