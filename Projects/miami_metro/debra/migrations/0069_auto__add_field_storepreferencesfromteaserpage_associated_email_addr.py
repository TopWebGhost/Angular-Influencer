...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StorePreferencesFromTeaserPage.associated_email_addr'
        db.add_column('debra_storepreferencesfromteaserpage', 'associated_email_addr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.EmailFromTeaserPage'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StorePreferencesFromTeaserPage.associated_email_addr'
        db.delete_column('debra_storepreferencesfromteaserpage', 'associated_email_addr_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 31, 19, 6, 5, 667425)'}),
