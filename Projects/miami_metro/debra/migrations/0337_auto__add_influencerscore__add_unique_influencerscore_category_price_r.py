...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerScore'
        db.create_table('debra_influencerscore', (
            ...
            ('price_range', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('debra', ['InfluencerScore'])

        # Adding unique constraint on 'InfluencerScore', fields ['category', 'price_range', 'influencer']
        db.create_unique('debra_influencerscore', ['category', 'price_range', 'influencer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InfluencerScore', fields ['category', 'price_range', 'influencer']
        db.delete_unique('debra_influencerscore', ['category', 'price_range', 'influencer_id'])

        # Deleting model 'InfluencerScore'
        db.delete_table('debra_influencerscore')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 8, 25, 48, 914355)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 8, 25, 48, 914288)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '17532', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 8, 25, 48, 477468)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 8, 25, 48, 477485)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 8, 25, 48, 476458)'}),
