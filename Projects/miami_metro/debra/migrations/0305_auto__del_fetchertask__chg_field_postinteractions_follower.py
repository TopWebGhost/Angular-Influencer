...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'FetcherTask'
        db.delete_table('debra_fetchertask')

        # Changing field 'PostInteractions.follower'
        db.alter_column('debra_postinteractions', 'follower_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Follower'], null=True))


    def backwards(self, orm):
        
        # Adding model 'FetcherTask'
        db.create_table('debra_fetchertask', (
            ('posts_saved', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('started', self.gf('django.db.models.fields.DateField')()),
            ('policy_name', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('duration', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pis_skipped', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('pis_saved', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('posts_skipped', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Platform'])),
            ('server_ip', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('process_pid', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('debra', ['FetcherTask'])

        # Changing field 'PostInteractions.follower'
        db.alter_column('debra_postinteractions', 'follower_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Follower']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 28, 55, 94137)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 28, 55, 94061)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 28, 47, 666489)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 28, 47, 666528)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 28, 47, 663994)'}),
