...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PlatformApiCalls', fields ['platform_name', 'calls_date', 'calls_hour']
        db.delete_unique('debra_platformapicalls', ['platform_name', 'calls_date', 'calls_hour'])

        # Adding field 'PlatformApiCalls.status_code'
        db.add_column('debra_platformapicalls', 'status_code', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'PlatformApiCalls.status_msg'
        db.add_column('debra_platformapicalls', 'status_msg', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'PlatformApiCalls', fields ['platform_name', 'calls_date', 'calls_hour', 'status_msg', 'status_code']
        db.create_unique('debra_platformapicalls', ['platform_name', 'calls_date', 'calls_hour', 'status_msg', 'status_code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PlatformApiCalls', fields ['platform_name', 'calls_date', 'calls_hour', 'status_msg', 'status_code']
        db.delete_unique('debra_platformapicalls', ['platform_name', 'calls_date', 'calls_hour', 'status_msg', 'status_code'])

        # Deleting field 'PlatformApiCalls.status_code'
        db.delete_column('debra_platformapicalls', 'status_code')

        # Deleting field 'PlatformApiCalls.status_msg'
        db.delete_column('debra_platformapicalls', 'status_msg')

        # Adding unique constraint on 'PlatformApiCalls', fields ['platform_name', 'calls_date', 'calls_hour']
        db.create_unique('debra_platformapicalls', ['platform_name', 'calls_date', 'calls_hour'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 8, 9, 58, 51218)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 8, 9, 58, 51180)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 8, 9, 57, 866232)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 8, 9, 57, 866244)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 20, 8, 9, 57, 865604)'}),
