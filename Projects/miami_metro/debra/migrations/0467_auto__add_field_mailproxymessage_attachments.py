...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailProxyMessage.attachments'
        db.add_column('debra_mailproxymessage', 'attachments', self.gf('jsonfield.fields.JSONField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailProxyMessage.attachments'
        db.delete_column('debra_mailproxymessage', 'attachments')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 6, 8, 22, 4, 981240)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 6, 8, 22, 4, 981164)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fe42d6c5-8f20-49c4-a273-3201e0698276'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Posts']", 'null': 'True'}),
            'post_interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostInteractions']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '14587', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 6, 8, 22, 4, 225103)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 6, 8, 22, 4, 225153)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 6, 8, 22, 4, 222401)'}),
