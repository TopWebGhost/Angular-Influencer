...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.bloglovin_followers'
        db.add_column('debra_influencer', 'bloglovin_followers', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Influencer.fbpage_about'
        db.alter_column('debra_influencer', 'fbpage_about', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Influencer.fbpage_description'
        db.alter_column('debra_influencer', 'fbpage_description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Influencer.demographics_fbid'
        db.alter_column('debra_influencer', 'demographics_fbid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Influencer.demographics_location'
        db.alter_column('debra_influencer', 'demographics_location', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Adding field 'Posts.engagement_media_numcomments'
        db.add_column('debra_posts', 'engagement_media_numcomments', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.bloglovin_followers'
        db.delete_column('debra_influencer', 'bloglovin_followers')

        # Changing field 'Influencer.fbpage_about'
        db.alter_column('debra_influencer', 'fbpage_about', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Influencer.fbpage_description'
        db.alter_column('debra_influencer', 'fbpage_description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Influencer.demographics_fbid'
        db.alter_column('debra_influencer', 'demographics_fbid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Influencer.demographics_location'
        db.alter_column('debra_influencer', 'demographics_location', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Deleting field 'Posts.engagement_media_numcomments'
        db.delete_column('debra_posts', 'engagement_media_numcomments')
    ...
    models = {
        ...
        'debra.influencer': {
            ...
            'fbpage_about': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'fbpage_description': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 18, 22, 52, 930674)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 18, 22, 52, 930695)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 18, 22, 52, 929852)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 9, 18, 22, 52, 935453)'}),
