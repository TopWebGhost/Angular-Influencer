...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ColorSizeModel.color'
        db.alter_column('debra_colorsizemodel', 'color', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'ColorSizeModel.size'
        db.alter_column('debra_colorsizemodel', 'size', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'ColorSizeModel.color'
        db.alter_column('debra_colorsizemodel', 'color', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'ColorSizeModel.size'
        db.alter_column('debra_colorsizemodel', 'size', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 20, 19, 23, 29, 859337)'}),
