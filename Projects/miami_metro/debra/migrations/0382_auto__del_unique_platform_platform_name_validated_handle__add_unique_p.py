...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Platform', fields ['platform_name', 'validated_handle']
        db.delete_unique('debra_platform', ['platform_name', 'validated_handle'])

        # Adding unique constraint on 'Platform', fields ['platform_name', 'influencer', 'validated_handle']
        db.create_unique('debra_platform', ['platform_name', 'influencer_id', 'validated_handle'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Platform', fields ['platform_name', 'influencer', 'validated_handle']
        db.delete_unique('debra_platform', ['platform_name', 'influencer_id', 'validated_handle'])

        # Adding unique constraint on 'Platform', fields ['platform_name', 'validated_handle']
        db.create_unique('debra_platform', ['platform_name', 'validated_handle'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 25, 11, 29, 8, 554083)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 25, 11, 29, 8, 554044)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'da7c9230-3803-44be-b7b8-101064c8868c'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '15794', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 25, 11, 29, 8, 273799)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 25, 11, 29, 8, 273812)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 25, 11, 29, 8, 273024)'}),
