...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.stripe_access_token'
        db.add_column('debra_userprofile', 'stripe_access_token', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'UserProfile.stripe_refresh_token'
        db.add_column('debra_userprofile', 'stripe_refresh_token', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'UserProfile.stripe_publishable_key'
        db.add_column('debra_userprofile', 'stripe_publishable_key', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)

        # Adding field 'UserProfile.stripe_user_id'
        db.add_column('debra_userprofile', 'stripe_user_id', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.stripe_access_token'
        db.delete_column('debra_userprofile', 'stripe_access_token')

        # Deleting field 'UserProfile.stripe_refresh_token'
        db.delete_column('debra_userprofile', 'stripe_refresh_token')

        # Deleting field 'UserProfile.stripe_publishable_key'
        db.delete_column('debra_userprofile', 'stripe_publishable_key')

        # Deleting field 'UserProfile.stripe_user_id'
        db.delete_column('debra_userprofile', 'stripe_user_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 24, 17, 27, 39, 805340)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 24, 17, 27, 39, 805186)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3f7d947e-a62c-4707-a10f-4e0202b69c2d'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '16809', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 24, 17, 27, 38, 548690)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 24, 17, 27, 38, 548858)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 24, 17, 27, 38, 542436)'}),
        ...
        'debra.userprofile': {
            ...
            'stripe_access_token': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'stripe_publishable_key': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'stripe_refresh_token': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
            'stripe_user_id': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True'}),
