...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Posts.platform'
        db.add_column('debra_posts', 'platform', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Platform'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Posts.platform_name'
        db.add_column('debra_posts', 'platform_name', self.gf('django.db.models.fields.CharField')(default='Platform name', max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Posts.platform'
        db.delete_column('debra_posts', 'platform_id')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 1, 43, 40, 548465)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 1, 43, 40, 548485)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 1, 43, 40, 547694)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 11, 1, 43, 40, 553091)'}),
