...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostAnalyticsCollectionTimeSeries'
        db.create_table('debra_postanalyticscollectiontimeseries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time_series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.PostAnalyticsCollection'], null=True)),
            ('snapshot_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('count_views', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_unique_views', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_clicks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_unique_clicks', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('debra', ['PostAnalyticsCollectionTimeSeries'])


    def backwards(self, orm):
        
        # Deleting model 'PostAnalyticsCollectionTimeSeries'
        db.delete_table('debra_postanalyticscollectiontimeseries')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 21, 17, 48, 45, 289924)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 21, 17, 48, 45, 289849)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6713e608-876e-4fe4-9a21-c6cf13832ded'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '8614', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.postanalyticscollectiontimeseries': {
            ...
            'time_series': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.PostAnalyticsCollection']", 'null': 'True'})
        },
        'debra.postcategory': {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 17, 48, 42, 171299)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 17, 48, 42, 171323)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 17, 48, 42, 169852)'}),
