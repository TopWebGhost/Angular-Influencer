...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Influencer', fields ['source']
        db.create_index('debra_influencer', ['source'])

        # Adding index on 'Platform', fields ['platform_name']
        db.create_index('debra_platform', ['platform_name'])


    def backwards(self, orm):
        
        # Removing index on 'Platform', fields ['platform_name']
        db.delete_index('debra_platform', ['platform_name'])

        # Removing index on 'Influencer', fields ['source']
        db.delete_index('debra_influencer', ['source'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 15, 5, 54, 44, 543485)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 15, 5, 54, 44, 543445)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 15, 5, 54, 44, 336833)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 15, 5, 54, 44, 336845)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 15, 5, 54, 44, 336172)'}),
