...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.product_model'
        db.add_column('debra_wishlistitem', 'product_model', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.ProductModel'], null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.color'
        db.add_column('debra_wishlistitem', 'color', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.size'
        db.add_column('debra_wishlistitem', 'size', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WishlistItem.product_model'
        db.delete_column('debra_wishlistitem', 'product_model_id')

        # Deleting field 'WishlistItem.color'
        db.delete_column('debra_wishlistitem', 'color')

        # Deleting field 'WishlistItem.size'
        db.delete_column('debra_wishlistitem', 'size')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 19, 58, 31, 286468)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 19, 58, 31, 286489)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 19, 58, 31, 285616)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 30, 19, 58, 31, 291213)'}),
