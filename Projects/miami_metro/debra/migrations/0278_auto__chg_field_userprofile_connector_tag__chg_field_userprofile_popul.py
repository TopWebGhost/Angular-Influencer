...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.connector_tag'
        db.alter_column('debra_userprofile', 'connector_tag', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'UserProfile.popularity_tag'
        db.alter_column('debra_userprofile', 'popularity_tag', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.connector_tag'
        db.alter_column('debra_userprofile', 'connector_tag', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'UserProfile.popularity_tag'
        db.alter_column('debra_userprofile', 'popularity_tag', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 1, 15, 36, 692214)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 1, 15, 36, 692146)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 1, 15, 36, 350681)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 1, 15, 36, 350709)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 1, 15, 36, 349347)'}),
        ...
        'debra.userprofile': {
            ...
            'popularity_tag': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
