...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.snooze'
        db.add_column('debra_wishlistitem', 'snooze', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WishlistItem.snooze'
        db.delete_column('debra_wishlistitem', 'snooze')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 16, 13, 6, 34, 386200)'}),
