...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContentTagCount'
        db.create_table('debra_contenttagcount', (
        ...
        db.send_create_signal('debra', ['ContentTagCount'])

        # Adding unique constraint on 'ContentTagCount', fields ['platform', 'tag']
        db.create_unique('debra_contenttagcount', ['platform_id', 'tag'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContentTagCount', fields ['platform', 'tag']
        db.delete_unique('debra_contenttagcount', ['platform_id', 'tag'])

        # Deleting model 'ContentTagCount'
        db.delete_table('debra_contenttagcount')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 7, 13, 26, 49, 10575)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 7, 13, 26, 49, 10541)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c27d6bd7-9edc-4ca0-a7ea-e5b28c1311c8'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '18194', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 13, 26, 48, 734851)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 13, 26, 48, 734862)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 7, 13, 26, 48, 734082)'}),
