...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PostAnalyticsCollectionTimeSeries.time_series'
        db.delete_column('debra_postanalyticscollectiontimeseries', 'time_series_id')

        # Adding field 'PostAnalyticsCollectionTimeSeries.collection'
        db.add_column('debra_postanalyticscollectiontimeseries', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='time_series', null=True, to=orm['debra.PostAnalyticsCollection']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PostAnalyticsCollectionTimeSeries.time_series'
        db.add_column('debra_postanalyticscollectiontimeseries', 'time_series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.PostAnalyticsCollection'], null=True), keep_default=False)

        # Deleting field 'PostAnalyticsCollectionTimeSeries.collection'
        db.delete_column('debra_postanalyticscollectiontimeseries', 'collection_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 21, 19, 18, 11, 821734)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 21, 19, 18, 11, 821652)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'014f5766-efdc-4bac-bb88-917e73e55798'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13225', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 19, 18, 10, 852116)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 19, 18, 10, 852139)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 21, 19, 18, 10, 850789)'}),
