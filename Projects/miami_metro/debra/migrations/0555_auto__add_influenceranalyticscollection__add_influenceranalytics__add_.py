...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerAnalyticsCollection'
        db.create_table('debra_influenceranalyticscollection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencersGroup'], null=True)),
        ))
        db.send_create_signal('debra', ['InfluencerAnalyticsCollection'])

        # Adding model 'InfluencerAnalytics'
        db.create_table('debra_influenceranalytics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True)),
            ('influencer_analytics_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencerAnalyticsCollection'], null=True)),
            ('approve_status', self.gf('django.db.models.fields.IntegerField')(default=1, null=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('debra', ['InfluencerAnalytics'])

        # Adding field 'ROIPredictionReport.influencer_analytics_collection'
        db.add_column('debra_roipredictionreport', 'influencer_analytics_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.InfluencerAnalyticsCollection'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'InfluencerAnalyticsCollection'
        db.delete_table('debra_influenceranalyticscollection')

        # Deleting model 'InfluencerAnalytics'
        db.delete_table('debra_influenceranalytics')

        # Deleting field 'ROIPredictionReport.influencer_analytics_collection'
        db.delete_column('debra_roipredictionreport', 'influencer_analytics_collection_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 28, 16, 48, 22, 508282)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 28, 16, 48, 22, 508139)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'68808522-a8c6-43c3-852f-40030465b917'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '15564', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 28, 16, 48, 19, 160840)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 28, 16, 48, 19, 160875)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 28, 16, 48, 19, 158818)'}),
