...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.image1'
        db.add_column('debra_userprofile', 'image1', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image2'
        db.add_column('debra_userprofile', 'image2', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image3'
        db.add_column('debra_userprofile', 'image3', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image4'
        db.add_column('debra_userprofile', 'image4', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image5'
        db.add_column('debra_userprofile', 'image5', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image6'
        db.add_column('debra_userprofile', 'image6', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image7'
        db.add_column('debra_userprofile', 'image7', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image8'
        db.add_column('debra_userprofile', 'image8', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image9'
        db.add_column('debra_userprofile', 'image9', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.image10'
        db.add_column('debra_userprofile', 'image10', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.image1'
        db.delete_column('debra_userprofile', 'image1')

        # Deleting field 'UserProfile.image2'
        db.delete_column('debra_userprofile', 'image2')

        # Deleting field 'UserProfile.image3'
        db.delete_column('debra_userprofile', 'image3')

        # Deleting field 'UserProfile.image4'
        db.delete_column('debra_userprofile', 'image4')

        # Deleting field 'UserProfile.image5'
        db.delete_column('debra_userprofile', 'image5')

        # Deleting field 'UserProfile.image6'
        db.delete_column('debra_userprofile', 'image6')

        # Deleting field 'UserProfile.image7'
        db.delete_column('debra_userprofile', 'image7')

        # Deleting field 'UserProfile.image8'
        db.delete_column('debra_userprofile', 'image8')

        # Deleting field 'UserProfile.image9'
        db.delete_column('debra_userprofile', 'image9')

        # Deleting field 'UserProfile.image10'
        db.delete_column('debra_userprofile', 'image10')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 37, 44, 570414)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 37, 44, 570465)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 37, 44, 568341)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 37, 44, 580379)'}),
