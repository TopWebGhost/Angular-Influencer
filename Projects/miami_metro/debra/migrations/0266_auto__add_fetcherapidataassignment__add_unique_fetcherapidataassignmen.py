...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FetcherApiDataAssignment'
        db.create_table('debra_fetcherapidataassignment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.FetcherApiDataSpec'])),
            ('value_m', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.FetcherApiDataValue'])),
            ('server_ip', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
        ))
        db.send_create_signal('debra', ['FetcherApiDataAssignment'])

        # Adding unique constraint on 'FetcherApiDataAssignment', fields ['spec', 'server_ip']
        db.create_unique('debra_fetcherapidataassignment', ['spec_id', 'server_ip'])

        # Adding model 'FetcherApiDataValue'
        db.create_table('debra_fetcherapidatavalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.FetcherApiDataSpec'])),
            ('value_index', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=10000)),
            ('last_usage', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['FetcherApiDataValue'])

        # Adding model 'FetcherApiDataSpec'
        db.create_table('debra_fetcherapidataspec', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('policy_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('platform_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('debra', ['FetcherApiDataSpec'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FetcherApiDataAssignment', fields ['spec', 'server_ip']
        db.delete_unique('debra_fetcherapidataassignment', ['spec_id', 'server_ip'])

        # Deleting model 'FetcherApiDataAssignment'
        db.delete_table('debra_fetcherapidataassignment')

        # Deleting model 'FetcherApiDataValue'
        db.delete_table('debra_fetcherapidatavalue')

        # Deleting model 'FetcherApiDataSpec'
        db.delete_table('debra_fetcherapidataspec')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 10, 32, 44, 549999)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 10, 32, 44, 549958)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 17, 10, 32, 44, 381929)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 17, 10, 32, 44, 381941)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 17, 10, 32, 44, 381179)'}),
        ...
        'debra.userprofile': {
            ...
            'connector_tag': ('django.db.models.fields.CharField', [], {'default': "'c'", 'max_length': '10'}),
            'cover_img_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            ...
            'popularity_tag': ('django.db.models.fields.CharField', [], {'default': "'m'", 'max_length': '10'}),
            ...
            'profile_img_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'quality_tag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
