...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostAnalyticsCollection'
        db.create_table('debra_postanalyticscollection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('archived', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('debra', ['PostAnalyticsCollection'])

        # Adding field 'PostAnalytics.collection'
        db.add_column('debra_postanalytics', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.PostAnalyticsCollection'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PostAnalyticsCollection'
        db.delete_table('debra_postanalyticscollection')

        # Deleting field 'PostAnalytics.collection'
        db.delete_column('debra_postanalytics', 'collection_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 10, 11, 41, 1, 994566)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 10, 11, 41, 1, 994483)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'728f2197-3cd0-44d8-a31d-7b5a483c5d07'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '14161', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 7, 10, 11, 41, 0, 671755)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 7, 10, 11, 41, 0, 671777)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 7, 10, 11, 41, 0, 670446)'}),
