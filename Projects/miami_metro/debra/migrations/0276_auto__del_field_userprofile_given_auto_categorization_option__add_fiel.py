...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.given_auto_categorization_option'
        db.delete_column('debra_userprofile', 'given_auto_categorization_option')

        # Adding field 'UserProfile.show_autocategorized'
        db.add_column('debra_userprofile', 'show_autocategorized', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.given_auto_categorization_option'
        db.add_column('debra_userprofile', 'given_auto_categorization_option', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.show_autocategorized'
        db.delete_column('debra_userprofile', 'show_autocategorized')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 19, 40, 53, 870048)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 21, 19, 40, 53, 869978)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 19, 40, 53, 499252)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 19, 40, 53, 499279)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 21, 19, 40, 53, 497883)'}),
