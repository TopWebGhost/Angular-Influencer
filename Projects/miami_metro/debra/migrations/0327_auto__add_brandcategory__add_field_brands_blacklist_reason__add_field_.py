...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_brandcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('debra', ['BrandCategory'])

        # Adding field 'Brands.blacklist_reason'
        db.add_column('debra_brands', 'blacklist_reason', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Brands.description'
        db.add_column('debra_brands', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Brands.date_edited'
        db.add_column('debra_brands', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field similar_brands on 'Brands'
        db.create_table('debra_brands_similar_brands', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_brands', models.ForeignKey(orm['debra.brands'], null=False)),
            ('to_brands', models.ForeignKey(orm['debra.brands'], null=False))
        ))
        db.create_unique('debra_brands_similar_brands', ['from_brands_id', 'to_brands_id'])

        # Adding M2M table for field categories on 'Brands'
        db.create_table('debra_brands_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('brands', models.ForeignKey(orm['debra.brands'], null=False)),
            ('brandcategory', models.ForeignKey(orm['debra.brandcategory'], null=False))
        ))
        db.create_unique('debra_brands_categories', ['brands_id', 'brandcategory_id'])


    def backwards(self, orm):
        
        # Deleting model 'BrandCategory'
        db.delete_table('debra_brandcategory')

        # Deleting field 'Brands.blacklist_reason'
        db.delete_column('debra_brands', 'blacklist_reason')

        # Deleting field 'Brands.description'
        db.delete_column('debra_brands', 'description')

        # Deleting field 'Brands.date_edited'
        db.delete_column('debra_brands', 'date_edited')

        # Removing M2M table for field similar_brands on 'Brands'
        db.delete_table('debra_brands_similar_brands')

        # Removing M2M table for field categories on 'Brands'
        db.delete_table('debra_brands_categories')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 11, 20, 19, 884483)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 11, 20, 19, 884410)'}),
        ...
        'debra.platformdataop': {
            ...
            'operation': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.Platform']", 'null': 'True'}),
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '9282', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 17, 11, 20, 19, 456301)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 17, 11, 20, 19, 456321)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 17, 11, 20, 19, 455324)'}),
