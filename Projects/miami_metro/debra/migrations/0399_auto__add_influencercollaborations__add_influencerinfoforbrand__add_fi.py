...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerCollaborations'
        db.create_table('debra_influencercollaborations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brand_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('brand_url', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('post_url', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collaborations', to=orm['debra.Influencer'])),
        ))
        db.send_create_signal('debra', ['InfluencerCollaborations'])

        # Adding model 'InfluencerInfoForBrand'
        db.create_table('debra_influencerinfoforbrand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('info_type', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ...
            ('details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('influencer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='infos_for_brands', to=orm['debra.Influencer'])),
        ))
        db.send_create_signal('debra', ['InfluencerInfoForBrand'])

        # Adding field 'Influencer.collaboration_types'
        db.add_column('debra_influencer', 'collaboration_types', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.how_you_work'
        db.add_column('debra_influencer', 'how_you_work', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'InfluencerCollaborations'
        db.delete_table('debra_influencercollaborations')

        # Deleting model 'InfluencerInfoForBrand'
        db.delete_table('debra_influencerinfoforbrand')

        # Deleting field 'Influencer.collaboration_types'
        db.delete_column('debra_influencer', 'collaboration_types')

        # Deleting field 'Influencer.how_you_work'
        db.delete_column('debra_influencer', 'how_you_work')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 12, 29, 5, 787532)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 12, 29, 5, 787463)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'45edec22-ead7-4c66-ac21-e60e7e4553b5'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '10670', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 12, 29, 5, 184478)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 12, 29, 5, 184504)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 29, 12, 29, 5, 183034)'}),
