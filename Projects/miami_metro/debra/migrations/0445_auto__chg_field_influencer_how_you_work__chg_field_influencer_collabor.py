...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Influencer.how_you_work'
        db.alter_column('debra_influencer', 'how_you_work', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Influencer.collaboration_types'
        db.alter_column('debra_influencer', 'collaboration_types', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Influencer.how_you_work'
        db.alter_column('debra_influencer', 'how_you_work', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Influencer.collaboration_types'
        db.alter_column('debra_influencer', 'collaboration_types', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 12, 55, 46, 554138)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 12, 55, 46, 554074)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9299abb2-96e1-4f92-9e23-2a4b9c42bf5c'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '1462', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 12, 55, 45, 971622)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 12, 55, 45, 971645)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 25, 12, 55, 45, 970722)'}),
