...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.start_url'
        db.add_column('debra_brands', 'start_url', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.start_url'
        db.delete_column('debra_brands', 'start_url')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 7, 18, 34, 8, 134462)'}),
