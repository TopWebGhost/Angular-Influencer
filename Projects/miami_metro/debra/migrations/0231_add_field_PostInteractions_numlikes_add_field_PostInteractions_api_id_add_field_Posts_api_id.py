...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostInteractions.numlikes'
        db.add_column('debra_postinteractions', 'numlikes', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'PostInteractions.api_id'
        db.add_column('debra_postinteractions', 'api_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Posts.api_id'
        db.add_column('debra_posts', 'api_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostInteractions.numlikes'
        db.delete_column('debra_postinteractions', 'numlikes')

        # Deleting field 'PostInteractions.api_id'
        db.delete_column('debra_postinteractions', 'api_id')

        # Deleting field 'Posts.api_id'
        db.delete_column('debra_posts', 'api_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 545909)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 545874)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 418328)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 418341)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 417537)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 14, 11, 8, 6, 421363)'}),
