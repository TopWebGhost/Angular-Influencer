...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PostAnalytics', fields ['post']
        db.delete_unique('debra_postanalytics', ['post_id'])

        # Changing field 'PostAnalytics.post'
        db.alter_column('debra_postanalytics', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Posts'], null=True))


    def backwards(self, orm):
        
        # Changing field 'PostAnalytics.post'
        db.alter_column('debra_postanalytics', 'post_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.Posts'], unique=True, null=True))

        # Adding unique constraint on 'PostAnalytics', fields ['post']
        db.create_unique('debra_postanalytics', ['post_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 1, 19, 8, 55, 306335)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 1, 19, 8, 55, 306244)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ceca372a-dc6c-42eb-a17c-52d0f8a19bf6'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '23214', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.postanalytics': {
            'Meta': {'unique_together': "(['post', 'source'],)", 'object_name': 'PostAnalytics'},
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 1, 19, 8, 54, 501419)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 1, 19, 8, 54, 501440)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 1, 19, 8, 54, 499808)'}),
