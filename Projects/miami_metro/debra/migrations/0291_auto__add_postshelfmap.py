...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostShelfMap'
        db.create_table('debra_postshelfmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_prof', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.UserProfile'], null=True, blank=True)),
            ('shelf', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Shelf'], null=True, blank=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Posts'], null=True, blank=True)),
        ))
        db.send_create_signal('debra', ['PostShelfMap'])


    def backwards(self, orm):
        
        # Deleting model 'PostShelfMap'
        db.delete_table('debra_postshelfmap')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 9, 209208)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 9, 209136)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 8, 748327)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 8, 748353)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 4, 18, 0, 8, 746835)'}),
