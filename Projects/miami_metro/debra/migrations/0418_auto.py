...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'HashtagInPost', fields ['hashtag']
        db.create_index('debra_hashtaginpost', ['hashtag'])

        # Adding index on 'MentionInPost', fields ['mention']
        db.create_index('debra_mentioninpost', ['mention'])


    def backwards(self, orm):
        
        # Removing index on 'MentionInPost', fields ['mention']
        db.delete_index('debra_mentioninpost', ['mention'])

        # Removing index on 'HashtagInPost', fields ['hashtag']
        db.delete_index('debra_hashtaginpost', ['hashtag'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 33, 45, 463449)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 33, 45, 463413)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1db67843-ae71-4976-9113-136a1f44e857'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '18226', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 33, 45, 144112)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 33, 45, 144125)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 24, 11, 33, 45, 143364)'}),
