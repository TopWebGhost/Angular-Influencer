...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.crawler_name'
        db.add_column('debra_brands', 'crawler_name', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.crawler_name'
        db.delete_column('debra_brands', 'crawler_name')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 7, 17, 56, 47, 927460)'}),
