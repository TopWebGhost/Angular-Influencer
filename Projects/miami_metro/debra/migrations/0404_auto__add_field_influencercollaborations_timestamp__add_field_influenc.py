...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfluencerCollaborations.timestamp'
        db.add_column('debra_influencercollaborations', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfluencerCollaborations.collaboration_type'
        db.add_column('debra_influencercollaborations', 'collaboration_type', self.gf('django.db.models.fields.CharField')(default='other', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfluencerCollaborations.timestamp'
        db.delete_column('debra_influencercollaborations', 'timestamp')

        # Deleting field 'InfluencerCollaborations.collaboration_type'
        db.delete_column('debra_influencercollaborations', 'collaboration_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 8, 38, 58, 136617)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 8, 38, 58, 136521)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d2f612ac-a687-4748-9df0-96274ded3cc1'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '12634', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 10, 8, 38, 53, 515347)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 10, 8, 38, 53, 515378)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 10, 8, 38, 53, 513688)'}),
