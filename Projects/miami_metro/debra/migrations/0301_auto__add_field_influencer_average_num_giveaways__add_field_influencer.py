...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.average_num_giveaways'
        db.add_column('debra_influencer', 'average_num_giveaways', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.average_num_posts'
        db.add_column('debra_influencer', 'average_num_posts', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.average_num_comments_per_giveaway'
        db.add_column('debra_influencer', 'average_num_comments_per_giveaway', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.average_num_comments_per_post'
        db.add_column('debra_influencer', 'average_num_comments_per_post', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Influencer.average_num_comments_per_sponsored_post'
        db.add_column('debra_influencer', 'average_num_comments_per_sponsored_post', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Influencer.average_num_giveaways'
        db.delete_column('debra_influencer', 'average_num_giveaways')

        # Deleting field 'Influencer.average_num_posts'
        db.delete_column('debra_influencer', 'average_num_posts')

        # Deleting field 'Influencer.average_num_comments_per_giveaway'
        db.delete_column('debra_influencer', 'average_num_comments_per_giveaway')

        # Deleting field 'Influencer.average_num_comments_per_post'
        db.delete_column('debra_influencer', 'average_num_comments_per_post')

        # Deleting field 'Influencer.average_num_comments_per_sponsored_post'
        db.delete_column('debra_influencer', 'average_num_comments_per_sponsored_post')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 39, 10, 376310)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 39, 10, 376185)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 39, 9, 989712)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 39, 9, 989733)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 39, 9, 988614)'}),
