...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfluencerJobMapping'
        db.create_table('debra_influencerjobmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mapping', self.gf('django.db.models.fields.related.ForeignKey')(related_name='jobs', to=orm['debra.InfluencerGroupMapping'])),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(related_name='candidates', to=orm['debra.BrandJobPost'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('mailbox', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='candidate_mapping', null=True, to=orm['debra.MailProxy'])),
        ))
        db.send_create_signal('debra', ['InfluencerJobMapping'])


    def backwards(self, orm):
        
        # Deleting model 'InfluencerJobMapping'
        db.delete_table('debra_influencerjobmapping')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 13, 38, 12, 681111)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 13, 38, 12, 681042)'}),
        ...
        'debra.contenttag': {
            'Meta': {'unique_together': "(('post', 'tag'),)", 'object_name': 'ContentTag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e00cfb1c-7a34-4897-9876-7434fa41023c'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '27365', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 13, 38, 12, 160522)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 13, 38, 12, 160543)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 7, 13, 38, 12, 159522)'}),
