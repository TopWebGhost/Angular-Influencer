...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promoinfo.free_shipping_lower_bound'
        db.alter_column('debra_promoinfo', 'free_shipping_lower_bound', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Promoinfo.promo_disc_amount'
        db.alter_column('debra_promoinfo', 'promo_disc_amount', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Promoinfo.promo_disc_lower_bound'
        db.alter_column('debra_promoinfo', 'promo_disc_lower_bound', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Promoinfo.promo_disc_perc'
        db.alter_column('debra_promoinfo', 'promo_disc_perc', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Promoinfo.item_category'
        db.alter_column('debra_promoinfo', 'item_category', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Promoinfo.free_shipping_lower_bound'
        db.alter_column('debra_promoinfo', 'free_shipping_lower_bound', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Promoinfo.promo_disc_amount'
        db.alter_column('debra_promoinfo', 'promo_disc_amount', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Promoinfo.promo_disc_lower_bound'
        db.alter_column('debra_promoinfo', 'promo_disc_lower_bound', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Promoinfo.promo_disc_perc'
        db.alter_column('debra_promoinfo', 'promo_disc_perc', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Promoinfo.item_category'
        db.alter_column('debra_promoinfo', 'item_category', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 16, 13, 48, 47, 283186)'}),
