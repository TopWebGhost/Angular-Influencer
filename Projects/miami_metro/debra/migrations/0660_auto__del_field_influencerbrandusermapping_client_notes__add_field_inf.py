...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfluencerBrandUserMapping.client_notes'
        db.delete_column('debra_influencerbrandusermapping', 'client_notes')

        # Adding field 'InfluencerJobMapping.client_notes'
        db.add_column('debra_influencerjobmapping', 'client_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'InfluencerBrandUserMapping.client_notes'
        db.add_column('debra_influencerbrandusermapping', 'client_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'InfluencerJobMapping.client_notes'
        db.delete_column('debra_influencerjobmapping', 'client_notes')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 26, 16, 16, 35, 267305)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 26, 16, 16, 35, 267179)'}),
        ...
        'debra.brandjobpost': {
            ...
            'posts_saved_search': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['debra.SearchQueryArchive']", 'unique': 'True', 'null': 'True'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'86c6a695-46b2-4d66-8761-bb6782537498'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '19397', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 7, 26, 16, 16, 34, 237489)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 7, 26, 16, 16, 34, 237525)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 7, 26, 16, 16, 34, 235674)'}),
