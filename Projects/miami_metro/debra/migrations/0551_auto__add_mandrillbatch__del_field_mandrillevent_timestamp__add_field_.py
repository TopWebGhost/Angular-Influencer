...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MandrillBatch'
        db.create_table('debra_mandrillbatch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('debra', ['MandrillBatch'])

        # Deleting field 'MandrillEvent.timestamp'
        db.delete_column('debra_mandrillevent', 'timestamp')

        # Adding field 'MandrillEvent.type'
        db.add_column('debra_mandrillevent', 'type', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'MandrillEvent.batch'
        db.add_column('debra_mandrillevent', 'batch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.MandrillBatch'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MandrillBatch'
        db.delete_table('debra_mandrillbatch')

        # Adding field 'MandrillEvent.timestamp'
        db.add_column('debra_mandrillevent', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True), keep_default=False)

        # Deleting field 'MandrillEvent.type'
        db.delete_column('debra_mandrillevent', 'type')

        # Deleting field 'MandrillEvent.batch'
        db.delete_column('debra_mandrillevent', 'batch_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 8, 12, 33, 19, 713312)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 8, 12, 33, 19, 713235)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ca2f563b-843d-48ae-ba66-10b4ff418b88'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '26639', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
        ...
        'debra.postanalyticscollection': {
            ...
            'items_number': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 8, 12, 33, 13, 198311)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 8, 12, 33, 13, 198330)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 11, 8, 12, 33, 13, 197068)'}),
