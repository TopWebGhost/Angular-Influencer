...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Follower', fields ['firstname']
        db.create_index('debra_follower', ['firstname'])

        # Adding index on 'Follower', fields ['url']
        db.create_index('debra_follower', ['url'])

        # Adding index on 'Follower', fields ['lastname']
        db.create_index('debra_follower', ['lastname'])

        # Adding index on 'Follower', fields ['email']
        db.create_index('debra_follower', ['email'])


    def backwards(self, orm):
        
        # Removing index on 'Follower', fields ['email']
        db.delete_index('debra_follower', ['email'])

        # Removing index on 'Follower', fields ['lastname']
        db.delete_index('debra_follower', ['lastname'])

        # Removing index on 'Follower', fields ['url']
        db.delete_index('debra_follower', ['url'])

        # Removing index on 'Follower', fields ['firstname']
        db.delete_index('debra_follower', ['firstname'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 5, 15, 41, 491577)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 5, 15, 41, 491537)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 13, 5, 15, 41, 294770)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 13, 5, 15, 41, 294782)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 13, 5, 15, 41, 294112)'}),
