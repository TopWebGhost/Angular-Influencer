...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('debra_userprofile', 'location', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.aboutme'
        db.add_column('debra_userprofile', 'aboutme', self.gf('django.db.models.fields.TextField')(default=None, max_length=2000, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.notification'
        db.add_column('debra_userprofile', 'notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.profile_img_url'
        db.add_column('debra_userprofile', 'profile_img_url', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.can_set_affiliate_links'
        db.add_column('debra_userprofile', 'can_set_affiliate_links', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.facebook_page'
        db.add_column('debra_userprofile', 'facebook_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.pinterest_page'
        db.add_column('debra_userprofile', 'pinterest_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.bloglovin_page'
        db.add_column('debra_userprofile', 'bloglovin_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.twitter_page'
        db.add_column('debra_userprofile', 'twitter_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.instagram_page'
        db.add_column('debra_userprofile', 'instagram_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.blog_page'
        db.add_column('debra_userprofile', 'blog_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.etsy_page'
        db.add_column('debra_userprofile', 'etsy_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.web_page'
        db.add_column('debra_userprofile', 'web_page', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('debra_userprofile', 'location')

        # Deleting field 'UserProfile.aboutme'
        db.delete_column('debra_userprofile', 'aboutme')

        # Deleting field 'UserProfile.notification'
        db.delete_column('debra_userprofile', 'notification')

        # Deleting field 'UserProfile.profile_img_url'
        db.delete_column('debra_userprofile', 'profile_img_url')

        # Deleting field 'UserProfile.can_set_affiliate_links'
        db.delete_column('debra_userprofile', 'can_set_affiliate_links')

        # Deleting field 'UserProfile.facebook_page'
        db.delete_column('debra_userprofile', 'facebook_page')

        # Deleting field 'UserProfile.pinterest_page'
        db.delete_column('debra_userprofile', 'pinterest_page')

        # Deleting field 'UserProfile.bloglovin_page'
        db.delete_column('debra_userprofile', 'bloglovin_page')

        # Deleting field 'UserProfile.twitter_page'
        db.delete_column('debra_userprofile', 'twitter_page')

        # Deleting field 'UserProfile.instagram_page'
        db.delete_column('debra_userprofile', 'instagram_page')

        # Deleting field 'UserProfile.blog_page'
        db.delete_column('debra_userprofile', 'blog_page')

        # Deleting field 'UserProfile.etsy_page'
        db.delete_column('debra_userprofile', 'etsy_page')

        # Deleting field 'UserProfile.web_page'
        db.delete_column('debra_userprofile', 'web_page')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 53, 46, 569642)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 53, 46, 569668)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 53, 46, 568550)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 53, 46, 574822)'}),
