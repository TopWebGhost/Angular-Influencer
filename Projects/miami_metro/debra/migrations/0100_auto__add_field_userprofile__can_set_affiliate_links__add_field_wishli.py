...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.img_url_shelf_view'
        db.add_column('debra_wishlistitem', 'img_url_shelf_view', self.gf('django.db.models.fields.URLField')(default='Nil', max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.img_url_panel_view'
        db.add_column('debra_wishlistitem', 'img_url_panel_view', self.gf('django.db.models.fields.URLField')(default='Nil', max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.img_url_feed_view'
        db.add_column('debra_wishlistitem', 'img_url_feed_view', self.gf('django.db.models.fields.URLField')(default='Nil', max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.affiliate_prod_link'
        db.add_column('debra_wishlistitem', 'affiliate_prod_link', self.gf('django.db.models.fields.URLField')(default='Nil', max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'WishlistItem.affiliate_source_wishlist_id'
        db.add_column('debra_wishlistitem', 'affiliate_source_wishlist_id', self.gf('django.db.models.fields.IntegerField')(default='-1', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WishlistItem.img_url_shelf_view'
        db.delete_column('debra_wishlistitem', 'img_url_shelf_view')

        # Deleting field 'WishlistItem.img_url_panel_view'
        db.delete_column('debra_wishlistitem', 'img_url_panel_view')

        # Deleting field 'WishlistItem.img_url_feed_view'
        db.delete_column('debra_wishlistitem', 'img_url_feed_view')

        # Deleting field 'WishlistItem.affiliate_prod_link'
        db.delete_column('debra_wishlistitem', 'affiliate_prod_link')

        # Deleting field 'WishlistItem.affiliate_source_wishlist_id'
        db.delete_column('debra_wishlistitem', 'affiliate_source_wishlist_id')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 18, 40, 56, 857852)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 18, 40, 56, 857896)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 18, 40, 56, 856095)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 6, 18, 40, 56, 867661)'}),
