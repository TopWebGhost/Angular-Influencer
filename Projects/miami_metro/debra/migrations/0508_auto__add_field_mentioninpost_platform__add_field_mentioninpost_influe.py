...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MentionInPost.platform'
        db.add_column('debra_mentioninpost', 'platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Platform'], null=True), keep_default=False)

        # Adding field 'MentionInPost.influencer'
        db.add_column('debra_mentioninpost', 'influencer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.Influencer'], null=True), keep_default=False)

        # Adding field 'MentionInPost.platform_name'
        db.add_column('debra_mentioninpost', 'platform_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MentionInPost.platform'
        db.delete_column('debra_mentioninpost', 'platform_id')

        # Deleting field 'MentionInPost.influencer'
        db.delete_column('debra_mentioninpost', 'influencer_id')

        # Deleting field 'MentionInPost.platform_name'
        db.delete_column('debra_mentioninpost', 'platform_name')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 7, 7, 21, 52, 824222)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 7, 7, 21, 52, 824107)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d144a479-3450-40ea-8f06-a88badeed3be'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '4344', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'10.0.2.113'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 7, 7, 21, 51, 658593)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 7, 7, 21, 51, 658623)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 7, 7, 21, 51, 657005)'}),
