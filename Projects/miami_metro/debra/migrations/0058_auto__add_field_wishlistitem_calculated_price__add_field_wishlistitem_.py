...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.calculated_price'
        db.add_column('debra_wishlistitem', 'calculated_price', self.gf('django.db.models.fields.FloatField')(default='-11.0', max_length=10), keep_default=False)

        # Adding field 'WishlistItem.item_out_of_stock'
        db.add_column('debra_wishlistitem', 'item_out_of_stock', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WishlistItem.calculated_price'
        db.delete_column('debra_wishlistitem', 'calculated_price')

        # Deleting field 'WishlistItem.item_out_of_stock'
        db.delete_column('debra_wishlistitem', 'item_out_of_stock')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 8, 13, 45, 13, 65219)'}),
