...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WishlistItem.task_id'
        db.delete_column('debra_wishlistitem', 'task_id')

        # Adding field 'WishlistItem.combination_id'
        db.add_column('debra_wishlistitem', 'combination_id', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WishlistItem.task_id'
        db.add_column('debra_wishlistitem', 'task_id', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)

        # Deleting field 'WishlistItem.combination_id'
        db.delete_column('debra_wishlistitem', 'combination_id')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 18, 11, 7, 6, 234502)'}),
