...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Influencer.fb_crawler_problem'
        db.add_column('debra_influencer', 'fb_crawler_problem', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.fb_couldnt_find'
        db.add_column('debra_influencer', 'fb_couldnt_find', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.fb_blogger_mistake'
        db.add_column('debra_influencer', 'fb_blogger_mistake', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.tw_crawler_problem'
        db.add_column('debra_influencer', 'tw_crawler_problem', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.tw_couldnt_find'
        db.add_column('debra_influencer', 'tw_couldnt_find', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.tw_blogger_mistake'
        db.add_column('debra_influencer', 'tw_blogger_mistake', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.in_crawler_problem'
        db.add_column('debra_influencer', 'in_crawler_problem', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.in_couldnt_find'
        db.add_column('debra_influencer', 'in_couldnt_find', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.in_blogger_mistake'
        db.add_column('debra_influencer', 'in_blogger_mistake', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.pn_crawler_problem'
        db.add_column('debra_influencer', 'pn_crawler_problem', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.pn_couldnt_find'
        db.add_column('debra_influencer', 'pn_couldnt_find', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Influencer.pn_blogger_mistake'
        db.add_column('debra_influencer', 'pn_blogger_mistake', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Influencer.fb_crawler_problem'
        db.delete_column('debra_influencer', 'fb_crawler_problem')

        # Deleting field 'Influencer.fb_couldnt_find'
        db.delete_column('debra_influencer', 'fb_couldnt_find')

        # Deleting field 'Influencer.fb_blogger_mistake'
        db.delete_column('debra_influencer', 'fb_blogger_mistake')

        # Deleting field 'Influencer.tw_crawler_problem'
        db.delete_column('debra_influencer', 'tw_crawler_problem')

        # Deleting field 'Influencer.tw_couldnt_find'
        db.delete_column('debra_influencer', 'tw_couldnt_find')

        # Deleting field 'Influencer.tw_blogger_mistake'
        db.delete_column('debra_influencer', 'tw_blogger_mistake')

        # Deleting field 'Influencer.in_crawler_problem'
        db.delete_column('debra_influencer', 'in_crawler_problem')

        # Deleting field 'Influencer.in_couldnt_find'
        db.delete_column('debra_influencer', 'in_couldnt_find')

        # Deleting field 'Influencer.in_blogger_mistake'
        db.delete_column('debra_influencer', 'in_blogger_mistake')

        # Deleting field 'Influencer.pn_crawler_problem'
        db.delete_column('debra_influencer', 'pn_crawler_problem')

        # Deleting field 'Influencer.pn_couldnt_find'
        db.delete_column('debra_influencer', 'pn_couldnt_find')

        # Deleting field 'Influencer.pn_blogger_mistake'
        db.delete_column('debra_influencer', 'pn_blogger_mistake')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 9, 23, 41, 55, 690029)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 9, 23, 41, 55, 689959)'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 9, 23, 41, 55, 286297)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 9, 23, 41, 55, 286318)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 9, 23, 41, 55, 285092)'}),
