...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskDailyStats.num_dups'
        db.add_column('debra_taskdailystats', 'num_dups', self.gf('django.db.models.fields.IntegerField')(default='0', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskDailyStats.num_dups'
        db.delete_column('debra_taskdailystats', 'num_dups')
    ...
    models = {
        ...
        'debra.productmodel': {
            ...
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'default': "'1'", 'to': "orm['debra.Brands']"}),
            'c_idx': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25', 'blank': 'True'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 19, 14, 19, 30, 500075)'}),
