...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AlexaRankingInfo.rank_by_country'
        db.delete_column('debra_alexarankinginfo', 'rank_by_country')

        # Deleting field 'AlexaRankingInfo.rank_by_city'
        db.delete_column('debra_alexarankinginfo', 'rank_by_city')

        # Deleting field 'AlexaRankingInfo.page_views'
        db.delete_column('debra_alexarankinginfo', 'page_views')

        # Adding field 'AlexaRankingInfo.page_views_per_1m'
        db.add_column('debra_alexarankinginfo', 'page_views_per_1m', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'AlexaRankingInfo.page_views_rank'
        db.add_column('debra_alexarankinginfo', 'page_views_rank', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'AlexaRankingInfo.page_views_per_user'
        db.add_column('debra_alexarankinginfo', 'page_views_per_user', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AlexaRankingInfo.rank_by_country'
        db.add_column('debra_alexarankinginfo', 'rank_by_country', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'AlexaRankingInfo.rank_by_city'
        db.add_column('debra_alexarankinginfo', 'rank_by_city', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'AlexaRankingInfo.page_views'
        db.add_column('debra_alexarankinginfo', 'page_views', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'AlexaRankingInfo.page_views_per_1m'
        db.delete_column('debra_alexarankinginfo', 'page_views_per_1m')

        # Deleting field 'AlexaRankingInfo.page_views_rank'
        db.delete_column('debra_alexarankinginfo', 'page_views_rank')

        # Deleting field 'AlexaRankingInfo.page_views_per_user'
        db.delete_column('debra_alexarankinginfo', 'page_views_per_user')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 9, 9, 27, 479911)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 9, 9, 27, 479874)'}),
        ...
        'debra.influencer': {
            ...
            'average_num_posts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'blog_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            ...
            'relevant_to_fashion': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'shelf_user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'show_on_search': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '13195', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 9, 9, 27, 240147)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 9, 9, 27, 240160)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 9, 9, 27, 239479)'}),
