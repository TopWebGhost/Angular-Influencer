...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LotteryTask.validation_required'
        db.add_column('debra_lotterytask', 'validation_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'LotteryEntryCompletedTask.entry_validation_url'
        db.add_column('debra_lotteryentrycompletedtask', 'entry_validation_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LotteryTask.validation_required'
        db.delete_column('debra_lotterytask', 'validation_required')

        # Deleting field 'LotteryEntryCompletedTask.entry_validation_url'
        db.delete_column('debra_lotteryentrycompletedtask', 'entry_validation_url')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 39, 158512)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 39, 158442)'}),
        ...
        'debra.lotterytask': {
            ...
            'task': ('django.db.models.fields.CharField', [], {'default': "{'meta': {'css_class': 'social_twitter', 'prompt': 'Twitter URL', 'instructions': 'To complete this entry, Follow ______ on Twitter', 'type': 'url', 'icon': 'icon-social_twitter'}, 'name': 'twitter_follow', 'value': 'Follow on Twitter'}", 'max_length': '200'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 38, 669692)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 38, 669716)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 38, 668523)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 10, 17, 17, 38, 674858)'}),
