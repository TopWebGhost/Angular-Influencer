...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AlexaMetricByCountry'
        db.create_table('debra_alexametricbycountry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alexa_ranking_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.AlexaRankingInfo'])),
            ('country_code', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('rank', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('contribution_page_views_pct', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('contribution_users_pct', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal('debra', ['AlexaMetricByCountry'])


    def backwards(self, orm):
        
        # Deleting model 'AlexaMetricByCountry'
        db.delete_table('debra_alexametricbycountry')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 10, 29, 28, 272035)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 10, 29, 28, 271994)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '23075', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 10, 29, 28, 49190)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 10, 29, 28, 49202)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 21, 10, 29, 28, 48512)'}),
