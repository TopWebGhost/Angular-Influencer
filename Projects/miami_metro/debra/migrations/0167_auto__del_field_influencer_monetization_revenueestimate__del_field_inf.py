...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('debra_influencer', 'blog_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'PostInteractions.comment_made'
        db.delete_column('debra_postinteractions', 'comment_made')

        # Adding field 'PostInteractions.content'
        db.add_column('debra_postinteractions', 'content', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'Platform.name'
        db.delete_column('debra_platform', 'name')

        # Adding field 'Platform.blogname'
        db.add_column('debra_platform', 'blogname', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.blogging_rate'
        db.add_column('debra_platform', 'blogging_rate', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.branding_matrix'
        db.add_column('debra_platform', 'branding_matrix', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
        ...
        db.add_column('debra_platform', 'monetization_percentsponsored', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.monetization_revenueestimate'
        db.add_column('debra_platform', 'monetization_revenueestimate', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.reference_score'
        db.add_column('debra_platform', 'reference_score', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.numposts'
        db.add_column('debra_platform', 'numposts', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('debra_influencer', 'monetization_revenueestimate', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.monetization_percentsponsored'
        db.add_column('debra_influencer', 'monetization_percentsponsored', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.monetization_numadunits'
        db.add_column('debra_influencer', 'monetization_numadunits', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.ranking_referencescore'
        db.add_column('debra_influencer', 'ranking_referencescore', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Influencer.ranking_bloggingrate'
        db.add_column('debra_influencer', 'ranking_bloggingrate', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'Influencer.blog_url'
        db.delete_column('debra_influencer', 'blog_url')

        # Adding field 'PostInteractions.comment_made'
        db.add_column('debra_postinteractions', 'comment_made', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'PostInteractions.content'
        db.delete_column('debra_postinteractions', 'content')

        # Adding field 'Platform.name'
        db.add_column('debra_platform', 'name', self.gf('django.db.models.fields.CharField')(default='name of entry on this platform', max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'Platform.blogname'
        db.delete_column('debra_platform', 'blogname')

        # Deleting field 'Platform.blogging_rate'
        db.delete_column('debra_platform', 'blogging_rate')

        # Deleting field 'Platform.branding_matrix'
        db.delete_column('debra_platform', 'branding_matrix')
        ...
        # Deleting field 'Platform.numposts'
        db.delete_column('debra_platform', 'numposts')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 23, 38, 680979)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 23, 38, 681010)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 23, 38, 679368)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 23, 38, 688525)'}),
