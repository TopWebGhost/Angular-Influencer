...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlatformDataOp'
        db.create_table('debra_platformdataop', (
            ...
            ('spec_custom', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, db_index=True)),
            ('operation', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('finished', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('error_msg', self.gf('django.db.models.fields.TextField')(null=True)),
            ('server_ip', self.gf('django.db.models.fields.CharField')(default='127.0.0.1', max_length=128)),
            ('process_pid', self.gf('django.db.models.fields.IntegerField')(default=14333, null=True)),
            ('data_json', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True)),
        ))
        db.send_create_signal('debra', ['PlatformDataOp'])


    def backwards(self, orm):
        
        # Deleting model 'PlatformDataOp'
        db.delete_table('debra_platformdataop')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 14, 8, 54, 38, 171953)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 14, 8, 54, 38, 171916)'}),
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '14333', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 14, 8, 54, 37, 943950)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 14, 8, 54, 37, 943962)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 14, 8, 54, 37, 943202)'}),
