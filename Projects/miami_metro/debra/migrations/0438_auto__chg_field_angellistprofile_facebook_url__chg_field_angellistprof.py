...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AngelListProfile.facebook_url'
        db.alter_column('debra_angellistprofile', 'facebook_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListProfile.site_url'
        db.alter_column('debra_angellistprofile', 'site_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListProfile.aboutme_url'
        db.alter_column('debra_angellistprofile', 'aboutme_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListProfile.blog_url'
        db.alter_column('debra_angellistprofile', 'blog_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListProfile.tw_url'
        db.alter_column('debra_angellistprofile', 'tw_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListCompanyUserRelationship.company_url'
        db.alter_column('debra_angellistcompanyuserrelationship', 'company_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'AngelListCompanyUserRelationship.angellist_url'
        db.alter_column('debra_angellistcompanyuserrelationship', 'angellist_url', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'AngelListProfile.facebook_url'
        db.alter_column('debra_angellistprofile', 'facebook_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListProfile.site_url'
        db.alter_column('debra_angellistprofile', 'site_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListProfile.aboutme_url'
        db.alter_column('debra_angellistprofile', 'aboutme_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListProfile.blog_url'
        db.alter_column('debra_angellistprofile', 'blog_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListProfile.tw_url'
        db.alter_column('debra_angellistprofile', 'tw_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListCompanyUserRelationship.company_url'
        db.alter_column('debra_angellistcompanyuserrelationship', 'company_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'AngelListCompanyUserRelationship.angellist_url'
        db.alter_column('debra_angellistcompanyuserrelationship', 'angellist_url', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 16, 44, 28, 234652)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 16, 44, 28, 234554)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15d83681-00ca-45b4-9d4e-8431ca8763e2'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '37884', 'null': 'True'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 16, 44, 27, 125778)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 16, 44, 27, 125806)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 16, 44, 27, 124249)'}),
