...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimilarWebVisits'
        db.create_table('debra_similarwebvisits', (
        ...
        db.send_create_signal('debra', ['SimilarWebVisits'])

        # Adding unique constraint on 'SimilarWebVisits', fields ['influencer', 'granularity', 'begins']
        db.create_unique('debra_similarwebvisits', ['influencer_id', 'granularity', 'begins'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SimilarWebVisits', fields ['influencer', 'granularity', 'begins']
        db.delete_unique('debra_similarwebvisits', ['influencer_id', 'granularity', 'begins'])

        # Deleting model 'SimilarWebVisits'
        db.delete_table('debra_similarwebvisits')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 14, 5, 10, 910873)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 15, 14, 5, 10, 910792)'}),
        ...
        'debra.influencervalidationqueue': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'27117f8a-9811-411d-93fc-449878d66566'", 'max_length': '64'})
        },
        ...
        'debra.platformdataop': {
            ...
            'process_pid': ('django.db.models.fields.IntegerField', [], {'default': '11546', 'null': 'True'}),
            'product_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['debra.ProductModel']", 'null': 'True'}),
            'server_ip': ('django.db.models.fields.CharField', [], {'default': "'172.31.24.160'", 'max_length': '128'}),
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 15, 14, 5, 9, 396742)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 15, 14, 5, 9, 396768)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 15, 14, 5, 9, 395396)'}),
