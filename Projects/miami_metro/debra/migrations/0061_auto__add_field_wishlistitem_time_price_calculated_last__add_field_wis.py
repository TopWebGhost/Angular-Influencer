...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.time_price_calculated_last'
        db.add_column('debra_wishlistitem', 'time_price_calculated_last', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'WishlistItem.time_notified_last'
        db.add_column('debra_wishlistitem', 'time_notified_last', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'WishlistItem.notify_lower_bound'
        db.add_column('debra_wishlistitem', 'notify_lower_bound', self.gf('django.db.models.fields.FloatField')(default='-1', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WishlistItem.time_price_calculated_last'
        db.delete_column('debra_wishlistitem', 'time_price_calculated_last')

        # Deleting field 'WishlistItem.time_notified_last'
        db.delete_column('debra_wishlistitem', 'time_notified_last')

        # Deleting field 'WishlistItem.notify_lower_bound'
        db.delete_column('debra_wishlistitem', 'notify_lower_bound')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 11, 13, 10, 45, 335889)'}),
