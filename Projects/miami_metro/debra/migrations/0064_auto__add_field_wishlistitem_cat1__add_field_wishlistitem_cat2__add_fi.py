...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WishlistItem.cat1'
        db.add_column('debra_wishlistitem', 'cat1', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=25), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WishlistItem.cat1'
        db.delete_column('debra_wishlistitem', 'cat1')
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 16, 9, 54, 14, 133690)'}),
