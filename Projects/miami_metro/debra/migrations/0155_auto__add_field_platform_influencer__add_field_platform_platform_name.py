...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Platform.influencer'
        db.add_column('debra_platform', 'influencer', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['debra.Influencer'], null=True, blank=True), keep_default=False)

        # Adding field 'Platform.platform_name'
        db.add_column('debra_platform', 'platform_name', self.gf('django.db.models.fields.CharField')(default='Platform name', max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Platform.influencer'
        db.delete_column('debra_platform', 'influencer_id')

        # Deleting field 'Platform.platform_name'
        db.delete_column('debra_platform', 'platform_name')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 48, 15, 162539)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 48, 15, 162560)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 48, 15, 161704)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 15, 48, 15, 167458)'}),
