...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brands.num_items_shelved'
        db.add_column('debra_brands', 'num_items_shelved', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Brands.num_items_have_price_alerts'
        db.add_column('debra_brands', 'num_items_have_price_alerts', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        ...
        # Adding field 'ShelfComments.profile_img_url'
        #db.add_column('debra_shelfcomments', 'profile_img_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=2000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brands.num_items_shelved'
        db.delete_column('debra_brands', 'num_items_shelved')

        # Deleting field 'Brands.num_items_have_price_alerts'
        db.delete_column('debra_brands', 'num_items_have_price_alerts')
        ...
        # Deleting field 'ShelfComments.profile_img_url'
        db.delete_column('debra_shelfcomments', 'profile_img_url')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 29, 21, 57, 2, 344137)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 29, 21, 57, 2, 344192)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 29, 21, 57, 2, 341846)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 29, 21, 57, 2, 355445)'}),
