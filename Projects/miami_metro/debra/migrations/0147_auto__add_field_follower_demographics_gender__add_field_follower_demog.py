...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Follower.demographics_gender'
        db.add_column('debra_follower', 'demographics_gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Follower.demographics_fbpic'
        db.add_column('debra_follower', 'demographics_fbpic', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Follower.is_blogger'
        db.add_column('debra_follower', 'is_blogger', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Follower.demographics_gender'
        db.delete_column('debra_follower', 'demographics_gender')

        # Deleting field 'Follower.demographics_fbpic'
        db.delete_column('debra_follower', 'demographics_fbpic')

        # Deleting field 'Follower.is_blogger'
        db.delete_column('debra_follower', 'is_blogger')
    ...
    models = {
        ...
        'debra.promodashboardunit': {
            ...
            'create_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 32, 13, 812054)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 32, 13, 812084)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'debra.promoinfo': {
            'Meta': {'object_name': 'Promoinfo'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'd': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 32, 13, 810741)'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 6, 22, 32, 13, 817258)'}),
