...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('debra_storepreferencesfromteaserpage', (
            ...
            ('extra', self.gf('django.db.models.fields.TextField')(default=None)),
        ))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 30, 13, 5, 14, 288535)'}),
        ...
        'debra.storepreferencesfromteaserpage': {
            ...
            'extra': ('django.db.models.fields.TextField', [], {'default': 'None'}),
