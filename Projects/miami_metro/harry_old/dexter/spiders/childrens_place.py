...
class CPSpider(CrawlSpider):
    ...
    base_link = "http://www.childrensplace.com"


    def __init__(self, *a, **kw):
        super(CPSpider, self).__init__(*a, **kw)
...
#        self.start_urls.append("http://www.childrensplace.com/webapp/wcs/stores/servlet/product_10001_10001_-1_941119_678404_25851_babygirl_25851|72470")
        self.start_urls.append("http://www.childrensplace.com/")
        self.new_arrivals = kw.get('new_arrivals')
    ...
    def add_primary_nav_links(self, response, new_urls):
        ...
        primary_navs_path = hxs.select('//div[@id="header"]/ul[@id="topnav"]/li/a/@href').extract()
...
#        pattern = 'product_\d+_\d+_[-\d]+_(.+?)\|'
        pattern = 'product_\d+_\d+_[-\d]+_([_\d]+)'
    ...
    def add_product_links(self, response, new_urls):
        ...
        product_path = hxs.select('//a[contains (@href,"product")]/@href').extract()
#
...
#        desc = hxs.select('//div[@id="tab-content"]/dl[@class="tabs"]/dd[0]/p[0]/text()').extract()
        desc = hxs.select('//div[@id="tab-content"]/dl[@class="tabs"]/dd/p/text()').extract()
...
#        logging.critical(promo_str)
    ...
    def _find_price(self, hxs, url):
        ...
        '''
        price_path = hxs.select('//div[@id="product_info"]/ul[@class="price_wrapper"]/li[@class="current_price"]/p//text()')
