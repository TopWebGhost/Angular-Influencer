...
PROJECTS_DIR=/home/ubuntu/Projects_platform-extractor
...
rm -fr /home/ubuntu/Projects_platform-extractor
su ubuntu -c 'ssh-agent sh -c "cd /tmp; ssh-add /home/ubuntu/sshkeys/githubkey; git clone git@github.com:atuls/Projects.git /home/ubuntu/Projects_platform-extractor"'
cd /home/ubuntu/Projects_platform-extractor
cd deployments/platform-extractor
