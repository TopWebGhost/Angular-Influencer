...
export ROLE=platform-data-postprocessing
...
# Adding a string to prevent password asking for SSH authorization
...
if [ ! -d "/home/$USER" ] ; then
    ...
    # creating .ssh folder and adding PUbLIC miami key
    mkdir -p /home/$USER/.ssh
    echo "ssh-rsa  miami" >> /home/$USER/.ssh/authorized_keys
...
sudo apt-get install -y libcurl4-openssl-dev psmisc git mc
